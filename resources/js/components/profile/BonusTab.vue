...
import { DollarSign, Gift, Handshake, Percent, Trophy, Users } from 'lucide-vue-next';
...
const grandTotal = computed(() =>
    totalSponsor.value + totalMatching.value + totalPairing.value + totalCashback.value + totalReward.value
);
        ...
        <Card>
            ...
            <CardContent class="p-2 sm:p-4 md:p-6 pt-0">
                <Tabs default-value="sponsor" class="w-full">
                    ...
                    >
                        <TabsList
                            class="flex w-max sm:grid sm:w-full sm:grid-cols-5 gap-0.5 sm:gap-1 h-7 sm:h-auto bg-muted/30"
                        >
                            <TabsTrigger
                                value="sponsor"
