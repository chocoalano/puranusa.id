    ...
    <div class="grid gap-4 md:grid-cols-4">
        ...
        <Card>
            ...
            <CardContent>
                ...
                <p class="text-xs text-muted-foreground">Withdrawal selesai</p>
            </CardContent>
        </Card>
        <Card>
            <CardHeader class="flex flex-row items-center justify-between space-y-0 pb-2">
            ...
            <CardContent>
                ...
                <p class="text-xs text-muted-foreground">Withdrawal gagal</p>
            </CardContent>
        </Card>
        <Card>
            <CardHeader class="flex flex-row items-center justify-between space-y-0 pb-2">
            ...
            <CardContent>
                ...
                <p class="text-xs text-muted-foreground">Total withdrawal berhasil</p>
            </CardContent>
        </Card>
    </div>
</template>
