...
import type { PaginatedData, ZennerFilters, Gallery } from '@/types/zenner';

interface Props {
    items: PaginatedData<Gallery>;
...
const fileType = ref((props.filters.file_type as string) || 'all');
        ...
        <div class="container mx-auto py-6 space-y-6">
            <div class="flex items-center justify-between">
                <div>
                    ...
                    <p class="text-muted-foreground">Kelola gallery Zenner Club</p>
                </div>
                <Button as-child>
                    <Link href="/admin/zenner/galleries/create">
                    ...
                    <div class="flex flex-col md:flex-row gap-4">
                        <div class="flex-1">
                            <div class="relative">
                                ...
                                <Input v-model="search" placeholder="Cari gallery..." class="pl-10" @keyup.enter="applyFilters" />
                            </div>
                        </div>
                        <div class="flex gap-2">
                            <Input v-model="category" placeholder="Kategori" class="w-[140px]" @keyup.enter="applyFilters" />
                            <Select v-model="fileType" @update:model-value="applyFilters">
                                ...
                                <TableCell class="text-right">
                                    <div class="flex justify-end gap-2">
                                        <Button as-child variant="ghost" size="icon">
                                            <Link :href="`/admin/zenner/galleries/${item.id}/edit`">
