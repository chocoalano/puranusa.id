...
const props = defineProps<{ item: ProductKnowledge }>();
        ...
        <Card>
            <CardHeader>
                <div class="flex items-center justify-between">
                    <h2 class="text-xl font-semibold">Edit Product Knowledge</h2>
                    <Button variant="outline" @click="router.visit('/admin/zenner/product-knowledges')">Kembali</Button>
                </div>
            </CardHeader>
            <CardContent>
