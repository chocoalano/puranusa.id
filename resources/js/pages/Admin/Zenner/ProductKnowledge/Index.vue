...
const props = defineProps<{
    items: { data: ProductKnowledge[]; links: any[]; current_page: number; last_page: number };
...
<template>
    <AppLayout>
        <Card>
            <CardHeader>
                <div class="flex items-center justify-between">
                    <h2 class="text-xl font-semibold">Product Knowledge</h2>
                    <Button @click="router.visit('/admin/zenner/product-knowledges/create')">
                    ...
                    <TableBody>
                        <TableRow v-for="item in items.data" :key="item.id">
                            ...
                            <TableCell class="text-right">
                                <Button variant="ghost" size="icon" @click="router.visit(`/admin/zenner/product-knowledges/${item.id}/edit`)">
        ...
        <AlertDialog :open="showDeleteDialog" @update:open="showDeleteDialog = $event">
            <AlertDialogContent>
                <AlertDialogHeader>
                    <AlertDialogTitle>Hapus Product Knowledge?</AlertDialogTitle>
