...
const deleteTarget = ref<ProcureProduct | null>(null);
...
const confirmDelete = (item: ProcureProduct) => {
...
<template>
    <AppLayout title="Procure Products">
        <Card>
            <CardHeader>
                <div class="flex items-center justify-between">
                    <h2 class="text-xl font-semibold">Procure Products</h2>
                    <Button @click="router.get('/admin/zenner/procure-products/create')">
                        ...
                        <TableRow v-for="item in items.data" :key="item.id">
                            ...
                            <TableCell class="text-right">
                                <div class="flex justify-end gap-2">
                                    <Button size="sm" variant="outline" @click="router.get(`/admin/zenner/procure-products/${item.id}/edit`)">
        ...
        <AlertDialog :open="deleteDialogOpen" @update:open="deleteDialogOpen = $event">
            <AlertDialogContent>
                <AlertDialogHeader>
                    <AlertDialogTitle>Hapus Procure Product</AlertDialogTitle>
