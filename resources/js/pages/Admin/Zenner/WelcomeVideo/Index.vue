...
import type { PaginatedData, ZennerFilters, WelcomeVideo } from '@/types/zenner';

interface Props {
    items: PaginatedData<WelcomeVideo>;
    ...
    <AppLayout>
        <div class="container mx-auto py-6 space-y-6">
            <div class="flex items-center justify-between">
                <div>
                    <h1 class="text-3xl font-bold tracking-tight">Welcome Video</h1>
                    <p class="text-muted-foreground">Kelola video selamat datang Zenner Club</p>
                </div>
                <Button as-child>
                    <Link href="/admin/zenner/welcome-videos/create">
                    ...
                    <div class="flex flex-col md:flex-row gap-4">
                        <div class="flex-1">
                            <div class="relative">
                                ...
                                <Input v-model="search" placeholder="Cari video..." class="pl-10" @keyup.enter="applyFilters" />
                            </div>
                        </div>
                    ...
                    <Table v-if="items.data.length > 0">
                        ...
                        <TableBody>
                            <TableRow v-for="item in items.data" :key="item.id">
                                ...
                                <TableCell>
                                    <p class="text-sm text-muted-foreground truncate max-w-[200px]">{{ item.video_url }}</p>
                                </TableCell>
                                <TableCell>
                                ...
                                <TableCell class="text-right">
                                    <div class="flex justify-end gap-2">
                                        <Button as-child variant="ghost" size="icon">
                                            <Link :href="`/admin/zenner/welcome-videos/${item.id}/edit`">
        ...
        <AlertDialog :open="itemToDelete !== null" @update:open="itemToDelete = null">
            <AlertDialogContent>
                <AlertDialogHeader>
                    <AlertDialogTitle>Hapus Welcome Video?</AlertDialogTitle>
