...
import type { MarketingKit } from '@/types/zenner';
...
<template>
    <AppLayout>
        <div class="container mx-auto py-6 space-y-6">
            <h1 class="text-3xl font-bold tracking-tight">Edit Marketing Kit</h1>
            <Card>
                <CardContent class="pt-6">
                    <form @submit.prevent="submit" class="space-y-4">
                        ...
                        <div class="flex gap-2">
                            ...
                            <Button variant="outline" as-child><Link href="/admin/zenner/marketing-kits">Batal</Link></Button>
                        </div>
                    </form>
                </CardContent>
            </Card>
