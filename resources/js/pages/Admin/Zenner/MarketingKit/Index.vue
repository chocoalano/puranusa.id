...
import type { PaginatedData, ZennerFilters, MarketingKit } from '@/types/zenner';

interface Props {
    items: PaginatedData<MarketingKit>;
    ...
    <AppLayout>
        <div class="container mx-auto py-6 space-y-6">
            <div class="flex items-center justify-between">
                <div>
                    <h1 class="text-3xl font-bold tracking-tight">Marketing Kit</h1>
                    <p class="text-muted-foreground">Kelola marketing kit Zenner Club</p>
                </div>
                <Button as-child>
                    <Link href="/admin/zenner/marketing-kits/create">
                    ...
                    <div class="flex flex-col md:flex-row gap-4">
                        <div class="flex-1">
                            <div class="relative">
                                ...
                                <Input v-model="search" placeholder="Cari marketing kit..." class="pl-10" @keyup.enter="applyFilters" />
                            </div>
                        </div>
                                ...
                                <TableCell class="text-right">
                                    <div class="flex justify-end gap-2">
                                        <Button as-child variant="ghost" size="icon">
                                            <Link :href="`/admin/zenner/marketing-kits/${item.id}/edit`">
        ...
        <AlertDialog :open="itemToDelete !== null" @update:open="itemToDelete = null">
            <AlertDialogContent>
                <AlertDialogHeader>
                    <AlertDialogTitle>Hapus Marketing Kit?</AlertDialogTitle>
