    ...
    <AppLayout>
        <div class="container mx-auto py-6 space-y-6">
            ...
            <Card>
                ...
                <CardContent>
                    <Table v-if="articles.data.length > 0">
                        <TableHeader>
                            <TableRow>
                            ...
                            <TableRow v-for="article in articles.data" :key="article.id">
                                <TableCell>
                                    <div>
                                        ...
                                        <p class="text-sm text-muted-foreground">{{ article.slug }}</p>
                                    </div>
                                </TableCell>
                                <TableCell>
                                    <Badge v-if="article.is_published" variant="default">
                                        Terbit
                                    </Badge>
                    ...
                    <div v-else class="py-12 text-center">
                        <p class="text-muted-foreground">Tidak ada artikel ditemukan</p>
                    </div>

                    <div v-if="articles.last_page > 1" class="mt-6 flex items-center justify-between">
        ...
        <AlertDialog :open="articleToDelete !== null" @update:open="articleToDelete = null">
            <AlertDialogContent>
                <AlertDialogHeader>
