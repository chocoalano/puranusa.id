...
<template>
    <AppLayout :breadcrumbs="breadcrumbItems">
        <Head title="Pesanan Pending" />

        <div class="rounded-xl p-4 space-y-6 py-6">
            <!-- Header -->
            <div class="flex items-center justify-between">
                <div>
                    <h1 class="text-3xl font-bold tracking-tight">Pesanan Pending</h1>
                    <p class="text-muted-foreground">Kelola pesanan yang menunggu pembayaran</p>
                </div>
            </div>
