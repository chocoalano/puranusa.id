...
const getRewardStatus = (reward: Reward) => {
    ...
    if (reward.status === 0) return { text: 'Inactive', variant: 'secondary' as const };
        ...
        <div class="flex h-full flex-1 flex-col gap-6 p-6">
            ...
            <div class="flex items-center justify-between">
                <div>
                    ...
                    <p class="text-muted-foreground mt-1">
                        Kelola reward dengan periode (ada tanggal mulai & berakhir)
                    </p>
                </div>
                <Link href="/admin/settings/promotions-rewards/create">
                    <Button>
            ...
            <div class="grid gap-4 md:grid-cols-4">
                ...
                <Card>
                    ...
                    <CardContent>
                        <div class="text-2xl font-bold text-blue-600">{{ statistics.total_scheduled }}</div>
                    </CardContent>
                </Card>
                <Card>
                    <CardHeader class="flex flex-row items-center justify-between space-y-0 pb-2">
                    ...
                    <CardContent>
                        <div class="text-2xl font-bold text-orange-600">{{ statistics.total_expired }}</div>
                    </CardContent>
                </Card>
                <Card>
                    <CardHeader class="flex flex-row items-center justify-between space-y-0 pb-2">
