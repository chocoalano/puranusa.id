...
import { index, create, show, destroy, release, massRelease } from '@/actions/App/Http/Controllers/BonusComission/BonusController';
...
<template>
    <AppLayout :breadcrumbs="breadcrumbItems">
        ...
        <ConfirmDialog
            ...
            title="Release Bonus?"
            :description="`Bonus sebesar ${releaseDialog.bonus ? formatCurrency(releaseDialog.bonus.tax_netto) : ''} akan ditransfer ke ewallet member. Lanjutkan?`"
        ...
        <ConfirmDialog
            ...
            :description="`Total ${formatCurrency(selectedPendingBonuses.reduce((sum, b) => sum + b.tax_netto, 0))} akan ditransfer ke ewallet member. Lanjutkan?`"
