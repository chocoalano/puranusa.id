...
import { index as cashbackIndex, destroy as cashbackDestroy, release as cashbackRelease, massRelease as cashbackMassRelease } from '@/actions/App/Http/Controllers/BonusComission/BonusCashbackController';
...
const breadcrumbItems: BreadcrumbItem[] = [
    { title: 'Bonus Cashback', href: cashbackIndex.url() },
];
...
const handleDelete = () => {
    ...
    router.delete(cashbackDestroy.url(deleteDialog.value.bonus.id), {
        preserveScroll: true,
...
const handleRelease = () => {
    ...
    releaseForm.post(cashbackRelease.url(releaseDialog.value.bonus.id), {
        preserveScroll: true,
...
const handleMassRelease = () => {
    ...
    massReleaseForm.post(cashbackMassRelease.url(), {
        preserveScroll: true,
...
<template>
    ...
    <AppLayout :breadcrumbs="breadcrumbItems">
        ...
        <div class="flex h-full flex-1 flex-col gap-6 p-6">
            ...
            <!-- Pagination -->
            <Pagination :data="bonuses" :url="cashbackIndex.url()" />
        </div>
