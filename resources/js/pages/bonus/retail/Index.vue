...
import { index as retailIndex, destroy as retailDestroy, release as retailRelease, massRelease as retailMassRelease } from '@/actions/App/Http/Controllers/BonusComission/BonusRetailController';
...
const breadcrumbItems: BreadcrumbItem[] = [
    { title: 'Bonus Retail', href: retailIndex.url() },
];
...
const handleDelete = () => {
    ...
    router.delete(retailDestroy.url(deleteDialog.value.bonus.id), {
        preserveScroll: true,
...
const handleRelease = () => {
    ...
    releaseForm.post(retailRelease.url(releaseDialog.value.bonus.id), {
        preserveScroll: true,
...
const handleMassRelease = () => {
    ...
    massReleaseForm.post(retailMassRelease.url(), {
        preserveScroll: true,
        ...
        <div class="flex h-full flex-1 flex-col gap-6 p-6">
            ...
            <div class="flex items-center justify-between">
                <div>
                    ...
                    <p class="text-muted-foreground">Kelola bonus retail dari penjualan member</p>
                </div>
                <Button @click="router.visit('/bonus/retail/create')" v-if="isSuperAdmin || isAdmin">
            ...
            <div class="flex flex-col gap-4 md:flex-row md:items-center md:justify-between">
                <div class="flex flex-1 items-center gap-4">
                    <div class="relative flex-1 md:max-w-sm">
                        ...
                        <Input v-model="search" placeholder="Cari member..." class="pl-9" />
                    </div>
            ...
            <!-- Pagination -->
            <Pagination :data="bonuses" :url="retailIndex.url()" />
        </div>
