    ...
    public function getNetworkStatistics(int $memberId): array
    {
        ...
        return [
            ...
            'binary_tree' => [
                ...
                'left_count' => (int) $customer->total_left,
                'right_count' => (int) $customer->total_right,
                'total_downlines' => (int) $customer->total_left + (int) $customer->total_right,
            ],
            'matrix' => [
                ...
                'total_downlines' => CustomerNetworkMatrix::where('sponsor_id', $customer->id)->count(),
            ],
            'bonuses' => [
