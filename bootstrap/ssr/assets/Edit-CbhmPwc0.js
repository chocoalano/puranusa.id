import { defineComponent, ref, computed, unref, withCtx, createVNode, createTextVNode, toDisplayString, createBlock, openBlock, Fragment, renderList, createCommentVNode, withModifiers, useSSRContext } from "vue";
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    const submit = () => {
      ...
      submitForm.transform(() => formData).post(
        `/admin/zenner-club/contents/${props.item.id}`,
        {
          preserveScroll: true,
          forceFormData: true,
          onSuccess: () => {
      ...
      _push(ssrRenderComponent(_sfc_main$1, null, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            ...
            _push2(`<div${_scopeId}><h1 class="text-3xl font-bold"${_scopeId}>Edit Konten</h1><p class="text-muted-foreground"${_scopeId}>Perbarui konten Zenner Club</p></div></div><form class="space-y-6"${_scopeId}>`);
                    ...
                    default: withCtx((_3, _push4, _parent4, _scopeId3) => {
                      if (_push4) {
                        ...
                        _push4(ssrRenderComponent(unref(_sfc_main$6), null, {
                          default: withCtx((_4, _push5, _parent5, _scopeId4) => {
                            if (_push5) {
                              _push5(`Perbarui data konten`);
                            } else {
                              return [
                                createTextVNode("Perbarui data konten")
                              ];
                            }
                          }),
                          _: 1
                    ...
                    default: withCtx((_3, _push4, _parent4, _scopeId3) => {
                      if (_push4) {
                        ...
                        if (existingFileUrl.value) {
                          _push4(`<p class="text-sm text-muted-foreground"${_scopeId3}> File saat ini: <a${ssrRenderAttr("href", existingFileUrl.value)} target="_blank" class="text-primary underline"${_scopeId3}> Lihat file </a></p>`);
                        } else {
                          _push4(`<!---->`);
                        }
                        ...
                        return [
                          ...
                          createVNode("div", { class: "grid gap-4 lg:grid-cols-2" }, [
                            createVNode("div", { class: "space-y-2" }, [
                              ...
                              existingFileUrl.value ? (openBlock(), createBlock("p", {
                                key: 0,
                                class: "text-sm text-muted-foreground"
                              }, [
                                createTextVNode(" File saat ini: "),
                                createVNode("a", {
                                  href: existingFileUrl.value,
                                  target: "_blank",
            ...
            _push2(ssrRenderComponent(unref(_sfc_main$2), {
              ...
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  ...
                  _push3(` ${ssrInterpolate(processing.value ? "Menyimpan..." : "Simpan Perubahan")}`);
                } else {
                  return [
              ...
              createVNode("div", { class: "container mx-auto py-6 space-y-6" }, [
                createVNode("div", { class: "flex items-center gap-4" }, [
                  ...
                  createVNode("div", null, [
                    createVNode("h1", { class: "text-3xl font-bold" }, "Edit Konten"),
                    createVNode("p", { class: "text-muted-foreground" }, "Perbarui konten Zenner Club")
                  ])
                ]),
                createVNode("form", {
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("resources/js/pages/Admin/ZennerClub/Contents/Edit.vue");
