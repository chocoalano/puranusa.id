    ...
    return (_ctx, _push, _parent, _attrs) => {
      _push(ssrRenderComponent(_sfc_main$1, mergeProps({ breadcrumbs: breadcrumbItems }, _attrs), {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(ssrRenderComponent(unref(Head), { title: "Edit Lifetime Cash Reward" }, null, _parent2, _scopeId));
            ...
            _push2(` Edit Lifetime Cash Reward </h1><p class="text-muted-foreground mt-1"${_scopeId}> Ubah detail lifetime cash reward </p></div>`);
                    ...
                    default: withCtx((_3, _push4, _parent4, _scopeId3) => {
                      if (_push4) {
                        ...
                        _push4(ssrRenderComponent(unref(_sfc_main$6), null, {
                          default: withCtx((_4, _push5, _parent5, _scopeId4) => {
                            if (_push5) {
                              _push5(`Ubah detail lifetime cash reward`);
                            } else {
                              return [
                                createTextVNode("Ubah detail lifetime cash reward")
                              ];
                            }
                          }),
                          _: 1
            ...
            return [
              createVNode(unref(Head), { title: "Edit Lifetime Cash Reward" }),
                ...
                createVNode("div", { class: "flex items-center justify-between" }, [
                  createVNode("div", null, [
                    createVNode("h1", { class: "text-3xl font-bold tracking-tight flex items-center gap-2" }, [
                      ...
                      createTextVNode(" Edit Lifetime Cash Reward ")
                    ]),
                    createVNode("p", { class: "text-muted-foreground mt-1" }, " Ubah detail lifetime cash reward ")
                  ]),
                  createVNode(unref(Link), { href: "/admin/settings/lifetime-cash-rewards" }, {
                    default: withCtx(() => [
                      createVNode(unref(_sfc_main$2), { variant: "outline" }, {
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("resources/js/pages/Admin/Rewards/Lifetime/Edit.vue");
