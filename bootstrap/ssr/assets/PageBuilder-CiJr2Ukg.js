import { defineComponent, ref, shallowRef, onMounted, watch, mergeProps, createVNode, resolveDynamicComponent, useSSRContext, unref, withCtx, createTextVNode, toDisplayString, createBlock, createCommentVNode, openBlock, Fragment, renderList } from "vue";
import { ssrRenderAttrs, ssrRenderStyle, ssrRenderVNode, ssrRenderComponent, ssrRenderList, ssrInterpolate, ssrRenderAttr, ssrRenderClass, ssrIncludeBooleanAttr } from "vue/server-renderer";
import { _ as _sfc_main$2, a as _sfc_main$3, b as _sfc_main$4, d as _sfc_main$5, c as _sfc_main$7 } from "./CardTitle-sqUG0LTw.js";
import { _ as _sfc_main$6 } from "./index-SN_CnQ_F.js";
import { _ as _sfc_main$k } from "./Input-BGi8wCMh.js";
import { _ as _sfc_main$e } from "./Label-16aMY2sx.js";
import { _ as _sfc_main$m } from "./Textarea-pcFPh_uS.js";
import { _ as _sfc_main$l } from "./TiptapEditor-DwYmVXGi.js";
import { _ as _sfc_main$f, a as _sfc_main$g, b as _sfc_main$h, c as _sfc_main$i, d as _sfc_main$j } from "./SelectValue-BUnv4mQg.js";
import { _ as _sfc_main$9, a as _sfc_main$a, b as _sfc_main$b, c as _sfc_main$c, d as _sfc_main$d, e as _sfc_main$n } from "./DialogTrigger-DpE8BjOt.js";
import { _ as _sfc_main$8 } from "./index-BpQimeTM.js";
import { Plus, GripVertical, ChevronUp, ChevronDown, Edit, Trash2, Image, Youtube, Type, AlignLeft, List, FileText, Code } from "lucide-vue-next";
  ...
  setup(__props, { emit: __emit }) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(ssrRenderComponent(unref(_sfc_main$2), null, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            ...
            _push2(ssrRenderComponent(unref(_sfc_main$7), { class: "space-y-4" }, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  ...
                  ssrRenderList(blocks.value, (block, index) => {
                    ...
                    _push3(ssrRenderComponent(unref(_sfc_main$8), { variant: "secondary" }, {
                      default: withCtx((_3, _push4, _parent4, _scopeId3) => {
                        if (_push4) {
      ...
      _push(ssrRenderComponent(unref(_sfc_main$9), {
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(ssrRenderComponent(unref(_sfc_main$a), { class: "max-w-7xl" }, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
            ...
            return [
              createVNode(unref(_sfc_main$a), { class: "max-w-7xl" }, {
                default: withCtx(() => [
                  createVNode(unref(_sfc_main$b), null, {
                    default: withCtx(() => [
                      createVNode(unref(_sfc_main$c), null, {
      ...
      _push(ssrRenderComponent(unref(_sfc_main$9), {
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(ssrRenderComponent(unref(_sfc_main$a), { class: "max-w-7xl max-h-[80vh] overflow-y-auto" }, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(ssrRenderComponent(unref(_sfc_main$b), null, {
                    default: withCtx((_3, _push4, _parent4, _scopeId3) => {
                    ...
                    if (editingBlock.value.block.type === "heading") {
                        ...
                        default: withCtx((_3, _push4, _parent4, _scopeId3) => {
                          if (_push4) {
                            _push4(ssrRenderComponent(unref(_sfc_main$g), null, {
                              default: withCtx((_4, _push5, _parent5, _scopeId4) => {
                                if (_push5) {
                                  _push5(ssrRenderComponent(unref(_sfc_main$h), { placeholder: "Pilih ukuran" }, null, _parent5, _scopeId4));
                                } else {
                                  return [
                                    createVNode(unref(_sfc_main$h), { placeholder: "Pilih ukuran" })
                                  ];
                                }
                              }),
                              _: 1
                            ...
                            _push4(ssrRenderComponent(unref(_sfc_main$i), null, {
                              default: withCtx((_4, _push5, _parent5, _scopeId4) => {
                                if (_push5) {
                                  _push5(ssrRenderComponent(unref(_sfc_main$j), { value: 1 }, {
                                  ...
                                  _push5(ssrRenderComponent(unref(_sfc_main$j), { value: 2 }, {
                                    default: withCtx((_5, _push6, _parent6, _scopeId5) => {
                                      if (_push6) {
                                        _push6(`H2 - Heading 2`);
                                      } else {
                                  ...
                                  _push5(ssrRenderComponent(unref(_sfc_main$j), { value: 3 }, {
                                    default: withCtx((_5, _push6, _parent6, _scopeId5) => {
                                      if (_push6) {
                                        _push6(`H3 - Heading 3`);
                                      } else {
                                  ...
                                  _push5(ssrRenderComponent(unref(_sfc_main$j), { value: 4 }, {
                                    default: withCtx((_5, _push6, _parent6, _scopeId5) => {
                                      if (_push6) {
                                        _push6(`H4 - Heading 4`);
                                      } else {
                                  ...
                                  _push5(ssrRenderComponent(unref(_sfc_main$j), { value: 5 }, {
                                    default: withCtx((_5, _push6, _parent6, _scopeId5) => {
                                      if (_push6) {
                                        _push6(`H5 - Heading 5`);
                                      } else {
                                  ...
                                  _push5(ssrRenderComponent(unref(_sfc_main$j), { value: 6 }, {
                                    default: withCtx((_5, _push6, _parent6, _scopeId5) => {
                                      if (_push6) {
                                        _push6(`H6 - Heading 6`);
                                      } else {
                                  ...
                                  return [
                                    createVNode(unref(_sfc_main$j), { value: 1 }, {
                                      default: withCtx(() => [
                                        createTextVNode("H1 - Heading 1")
                                      ]),
                                      _: 1
                                    }),
                                    createVNode(unref(_sfc_main$j), { value: 2 }, {
                                      default: withCtx(() => [
                                        createTextVNode("H2 - Heading 2")
                                      ]),
                                      _: 1
                                    }),
                                    createVNode(unref(_sfc_main$j), { value: 3 }, {
                                      default: withCtx(() => [
                                        createTextVNode("H3 - Heading 3")
                                      ]),
                                      _: 1
                                    }),
                                    createVNode(unref(_sfc_main$j), { value: 4 }, {
                                      default: withCtx(() => [
                                        createTextVNode("H4 - Heading 4")
                                      ]),
                                      _: 1
                                    }),
                                    createVNode(unref(_sfc_main$j), { value: 5 }, {
                                      default: withCtx(() => [
                                        createTextVNode("H5 - Heading 5")
                                      ]),
                                      _: 1
                                    }),
                                    createVNode(unref(_sfc_main$j), { value: 6 }, {
                                      default: withCtx(() => [
                                        createTextVNode("H6 - Heading 6")
                                      ]),
                                      _: 1
                      ...
                      if (imageInputMethod.value === "url") {
                        ...
                        if (editingBlock.value.block.content.url) {
                          ...
                          _push3(ssrRenderComponent(unref(_sfc_main$e), { class: "text-xs" }, {
                            default: withCtx((_3, _push4, _parent4, _scopeId3) => {
                              if (_push4) {
                                _push4(`Preview:`);
                              } else {
                        ...
                        default: withCtx((_3, _push4, _parent4, _scopeId3) => {
                          if (_push4) {
                            _push4(ssrRenderComponent(unref(_sfc_main$g), null, {
                              default: withCtx((_4, _push5, _parent5, _scopeId4) => {
                                if (_push5) {
                                  _push5(ssrRenderComponent(unref(_sfc_main$h), { placeholder: "Pilih bahasa" }, null, _parent5, _scopeId4));
                                } else {
                                  return [
                                    createVNode(unref(_sfc_main$h), { placeholder: "Pilih bahasa" })
                                  ];
                                }
                              }),
                              _: 1
                            ...
                            _push4(ssrRenderComponent(unref(_sfc_main$i), null, {
                              default: withCtx((_4, _push5, _parent5, _scopeId4) => {
                                if (_push5) {
                                  _push5(ssrRenderComponent(unref(_sfc_main$j), { value: "javascript" }, {
                                    default: withCtx((_5, _push6, _parent6, _scopeId5) => {
                                      if (_push6) {
                                        _push6(`JavaScript`);
                                      } else {
                                  ...
                                  _push5(ssrRenderComponent(unref(_sfc_main$j), { value: "typescript" }, {
                                    default: withCtx((_5, _push6, _parent6, _scopeId5) => {
                                      if (_push6) {
                                        _push6(`TypeScript`);
                                      } else {
                                  ...
                                  _push5(ssrRenderComponent(unref(_sfc_main$j), { value: "php" }, {
                                    default: withCtx((_5, _push6, _parent6, _scopeId5) => {
                                      if (_push6) {
                                        _push6(`PHP`);
                                      } else {
                                  ...
                                  _push5(ssrRenderComponent(unref(_sfc_main$j), { value: "python" }, {
                                    default: withCtx((_5, _push6, _parent6, _scopeId5) => {
                                      if (_push6) {
                                        _push6(`Python`);
                                      } else {
                                  ...
                                  _push5(ssrRenderComponent(unref(_sfc_main$j), { value: "html" }, {
                                    default: withCtx((_5, _push6, _parent6, _scopeId5) => {
                                      if (_push6) {
                                        _push6(`HTML`);
                                      } else {
                                  ...
                                  _push5(ssrRenderComponent(unref(_sfc_main$j), { value: "css" }, {
                                    default: withCtx((_5, _push6, _parent6, _scopeId5) => {
                                      if (_push6) {
                                        _push6(`CSS`);
                                      } else {
                                  ...
                                  _push5(ssrRenderComponent(unref(_sfc_main$j), { value: "sql" }, {
                                    default: withCtx((_5, _push6, _parent6, _scopeId5) => {
                                      if (_push6) {
                                        _push6(`SQL`);
                                      } else {
                                  ...
                                  _push5(ssrRenderComponent(unref(_sfc_main$j), { value: "bash" }, {
                                    default: withCtx((_5, _push6, _parent6, _scopeId5) => {
                                      if (_push6) {
                                        _push6(`Bash`);
                                      } else {
                                  ...
                                  _push5(ssrRenderComponent(unref(_sfc_main$j), { value: "json" }, {
                                    default: withCtx((_5, _push6, _parent6, _scopeId5) => {
                                      if (_push6) {
                                        _push6(`JSON`);
                                      } else {
                                  ...
                                  _push5(ssrRenderComponent(unref(_sfc_main$j), { value: "xml" }, {
                                    default: withCtx((_5, _push6, _parent6, _scopeId5) => {
                                      if (_push6) {
                                        _push6(`XML`);
                                      } else {
                                  ...
                                  _push5(ssrRenderComponent(unref(_sfc_main$j), { value: "markdown" }, {
                                    default: withCtx((_5, _push6, _parent6, _scopeId5) => {
                                      if (_push6) {
                                        _push6(`Markdown`);
                                      } else {
                                  ...
                                  return [
                                    createVNode(unref(_sfc_main$j), { value: "javascript" }, {
                                      default: withCtx(() => [
                                        createTextVNode("JavaScript")
                                      ]),
                                      _: 1
                                    }),
                                    createVNode(unref(_sfc_main$j), { value: "typescript" }, {
                                      default: withCtx(() => [
                                        createTextVNode("TypeScript")
                                      ]),
                                      _: 1
                                    }),
                                    createVNode(unref(_sfc_main$j), { value: "php" }, {
                                      default: withCtx(() => [
                                        createTextVNode("PHP")
                                      ]),
                                      _: 1
                                    }),
                                    createVNode(unref(_sfc_main$j), { value: "python" }, {
                                      default: withCtx(() => [
                                        createTextVNode("Python")
                                      ]),
                                      _: 1
                                    }),
                                    createVNode(unref(_sfc_main$j), { value: "html" }, {
                                      default: withCtx(() => [
                                        createTextVNode("HTML")
                                      ]),
                                      _: 1
                                    }),
                                    createVNode(unref(_sfc_main$j), { value: "css" }, {
                                      default: withCtx(() => [
                                        createTextVNode("CSS")
                                      ]),
                                      _: 1
                                    }),
                                    createVNode(unref(_sfc_main$j), { value: "sql" }, {
                                      default: withCtx(() => [
                                        createTextVNode("SQL")
                                      ]),
                                      _: 1
                                    }),
                                    createVNode(unref(_sfc_main$j), { value: "bash" }, {
                                      default: withCtx(() => [
                                        createTextVNode("Bash")
                                      ]),
                                      _: 1
                                    }),
                                    createVNode(unref(_sfc_main$j), { value: "json" }, {
                                      default: withCtx(() => [
                                        createTextVNode("JSON")
                                      ]),
                                      _: 1
                                    }),
                                    createVNode(unref(_sfc_main$j), { value: "xml" }, {
                                      default: withCtx(() => [
                                        createTextVNode("XML")
                                      ]),
                                      _: 1
                                    }),
                                    createVNode(unref(_sfc_main$j), { value: "markdown" }, {
                                      default: withCtx(() => [
                                        createTextVNode("Markdown")
                                      ]),
                                      _: 1
                  ...
                  _push3(ssrRenderComponent(unref(_sfc_main$n), null, {
                    default: withCtx((_3, _push4, _parent4, _scopeId3) => {
                      if (_push4) {
                        ...
                        _push4(ssrRenderComponent(unref(_sfc_main$6), { onClick: saveBlockEdit }, {
                          default: withCtx((_4, _push5, _parent5, _scopeId4) => {
                            if (_push5) {
                              _push5(`Simpan`);
                            } else {
                        ...
                        return [
                          ...
                          createVNode(unref(_sfc_main$6), { onClick: saveBlockEdit }, {
                            default: withCtx(() => [
                              createTextVNode("Simpan")
                            ]),
                            _: 1
                      ...
                      editingBlock.value.block.type === "heading" ? (openBlock(), createBlock("div", {
                        ...
                        imageInputMethod.value === "url" ? (openBlock(), createBlock("div", {
                          ...
                          editingBlock.value.block.content.url ? (openBlock(), createBlock("div", {
                            ...
                            createVNode(unref(_sfc_main$e), { class: "text-xs" }, {
                              default: withCtx(() => [
                                createTextVNode("Preview:")
                              ]),
                              _: 1
            ...
            return [
              createVNode(unref(_sfc_main$a), { class: "max-w-7xl max-h-[80vh] overflow-y-auto" }, {
                default: withCtx(() => [
                  createVNode(unref(_sfc_main$b), null, {
                    default: withCtx(() => [
                      createVNode(unref(_sfc_main$c), null, {
