...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    const submit = () => {
      form.post("/admin/zenner/testimonials", {
        onSuccess: () => toast.success("Testimonial berhasil dibuat")
      });
    };
    return (_ctx, _push, _parent, _attrs) => {
      _push(ssrRenderComponent(_sfc_main$1, mergeProps({ title: "Tambah Testimonial" }, _attrs), {
                ...
                if (_push3) {
                  _push3(ssrRenderComponent(unref(_sfc_main$3), null, {
                    default: withCtx((_3, _push4, _parent4, _scopeId3) => {
                      if (_push4) {
                        _push4(`<div class="flex items-center justify-between"${_scopeId3}><h2 class="text-xl font-semibold"${_scopeId3}>Tambah Testimonial</h2>`);
                        _push4(ssrRenderComponent(unref(_sfc_main$4), {
                          variant: "outline",
                          onClick: ($event) => unref(router).get("/admin/zenner/testimonials")
                        }, {
                        ...
                        return [
                          createVNode("div", { class: "flex items-center justify-between" }, [
                            createVNode("h2", { class: "text-xl font-semibold" }, "Tambah Testimonial"),
                  ...
                  _push3(ssrRenderComponent(unref(_sfc_main$5), null, {
                    default: withCtx((_3, _push4, _parent4, _scopeId3) => {
                      if (_push4) {
                        _push4(`<form class="space-y-4 max-w-2xl"${_scopeId3}><div${_scopeId3}><label class="block text-sm font-medium mb-1"${_scopeId3}>Nama Customer</label>`);
                        ...
                        if (unref(form).errors.customer_name) {
                          _push4(`<p class="text-sm text-destructive mt-1"${_scopeId3}>${ssrInterpolate(unref(form).errors.customer_name)}</p>`);
                        } else {
                          _push4(`<!---->`);
                        }
                        _push4(`</div><div${_scopeId3}><label class="block text-sm font-medium mb-1"${_scopeId3}>Content</label><textarea rows="4" class="flex w-full rounded-md border border-input bg-background px-3 py-2 text-sm ring-offset-background placeholder:text-muted-foreground focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring"${_scopeId3}>${ssrInterpolate(unref(form).content)}</textarea>`);
                        ...
                        _push4(`</div><div class="grid grid-cols-2 gap-4"${_scopeId3}><div${_scopeId3}><label class="block text-sm font-medium mb-1"${_scopeId3}>Rating (1-5)</label>`);
                        _push4(ssrRenderComponent(unref(_sfc_main$6), {
                        ...
                        if (unref(form).errors.rating) {
                          _push4(`<p class="text-sm text-destructive mt-1"${_scopeId3}>${ssrInterpolate(unref(form).errors.rating)}</p>`);
                        } else {
                          _push4(`<!---->`);
                        }
                        _push4(`</div><div${_scopeId3}><label class="block text-sm font-medium mb-1"${_scopeId3}>Nama Produk</label>`);
                        _push4(ssrRenderComponent(unref(_sfc_main$6), {
                        ...
                        if (unref(form).errors.product_name) {
                          _push4(`<p class="text-sm text-destructive mt-1"${_scopeId3}>${ssrInterpolate(unref(form).errors.product_name)}</p>`);
                        } else {
                          _push4(`<!---->`);
                        }
                        _push4(`</div></div><div${_scopeId3}><label class="block text-sm font-medium mb-1"${_scopeId3}>Sort Order</label>`);
                        _push4(ssrRenderComponent(unref(_sfc_main$6), {
                        ...
                        return [
                          createVNode("form", {
                            ...
                            createVNode("div", null, [
                              createVNode("label", { class: "block text-sm font-medium mb-1" }, "Nama Customer"),
                            ...
                            createVNode("div", null, [
                              createVNode("label", { class: "block text-sm font-medium mb-1" }, "Content"),
                            ...
                            createVNode("div", { class: "grid grid-cols-2 gap-4" }, [
                              createVNode("div", null, [
                                createVNode("label", { class: "block text-sm font-medium mb-1" }, "Rating (1-5)"),
                                createVNode(unref(_sfc_main$6), {
                                  modelValue: unref(form).rating,
                                  "onUpdate:modelValue": ($event) => unref(form).rating = $event,
                                  modelModifiers: { number: true },
                                ...
                                unref(form).errors.rating ? (openBlock(), createBlock("p", {
                                  key: 0,
                                  class: "text-sm text-destructive mt-1"
                                }, toDisplayString(unref(form).errors.rating), 1)) : createCommentVNode("", true)
                              ]),
                              createVNode("div", null, [
                                createVNode("label", { class: "block text-sm font-medium mb-1" }, "Nama Produk"),
                                createVNode(unref(_sfc_main$6), {
                                  modelValue: unref(form).product_name,
                                  "onUpdate:modelValue": ($event) => unref(form).product_name = $event
                                }, null, 8, ["modelValue", "onUpdate:modelValue"]),
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("resources/js/pages/Admin/Zenner/Testimonial/Create.vue");
