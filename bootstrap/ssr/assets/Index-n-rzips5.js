...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    const applyFilters = () => {
      router.get("/admin/zenner/welcome-videos", {
    ...
    const confirmDelete = () => {
      ...
      useForm({}).delete(`/admin/zenner/welcome-videos/${itemToDelete.value}`, {
        preserveScroll: true,
        onSuccess: () => {
          toast.success("Welcome Video berhasil dihapus");
    ...
    return (_ctx, _push, _parent, _attrs) => {
      _push(ssrRenderComponent(_sfc_main$1, _attrs, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<div class="container mx-auto py-6 space-y-6"${_scopeId}><div class="flex items-center justify-between"${_scopeId}><div${_scopeId}><h1 class="text-3xl font-bold tracking-tight"${_scopeId}>Welcome Video</h1><p class="text-muted-foreground"${_scopeId}>Kelola video selamat datang Zenner Club</p></div>`);
            _push2(ssrRenderComponent(unref(_sfc_main$2), { "as-child": "" }, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(ssrRenderComponent(unref(Link), { href: "/admin/zenner/welcome-videos/create" }, {
                  ...
                  return [
                    createVNode(unref(Link), { href: "/admin/zenner/welcome-videos/create" }, {
                      default: withCtx(() => [
                        createVNode(unref(Plus), { class: "mr-2 h-4 w-4" }),
                        createTextVNode(" Tambah Video ")
                      ]),
                                          ...
                                          default: withCtx((_6, _push7, _parent7, _scopeId6) => {
                                            if (_push7) {
                                              ...
                                              _push7(ssrRenderComponent(unref(_sfc_main$h), null, {
                                                default: withCtx((_7, _push8, _parent8, _scopeId7) => {
                                                  if (_push8) {
                                                    _push8(`<p class="text-sm text-muted-foreground truncate max-w-[200px]"${_scopeId7}>${ssrInterpolate(item.video_url)}</p>`);
                                                  } else {
                                                    return [
                                                      createVNode("p", { class: "text-sm text-muted-foreground truncate max-w-[200px]" }, toDisplayString(item.video_url), 1)
                                                    ];
                                                  }
                                                }),
                                                _: 2
                                                      ...
                                                      default: withCtx((_8, _push9, _parent9, _scopeId8) => {
                                                        if (_push9) {
                                                          _push9(ssrRenderComponent(unref(Link), {
                                                            href: `/admin/zenner/welcome-videos/${item.id}/edit`
                                                          }, {
                          ...
                          default: withCtx((_4, _push5, _parent5, _scopeId4) => {
                            if (_push5) {
                              _push5(ssrRenderComponent(unref(_sfc_main$m), null, {
                                default: withCtx((_5, _push6, _parent6, _scopeId5) => {
                                  if (_push6) {
                                    _push6(`Hapus Welcome Video?`);
                                  } else {
                                    return [
                                      createTextVNode("Hapus Welcome Video?")
                                    ];
                                  }
                                }),
                                _: 1
              ...
              createVNode("div", { class: "container mx-auto py-6 space-y-6" }, [
                createVNode("div", { class: "flex items-center justify-between" }, [
                  createVNode("div", null, [
                    createVNode("h1", { class: "text-3xl font-bold tracking-tight" }, "Welcome Video"),
                    createVNode("p", { class: "text-muted-foreground" }, "Kelola video selamat datang Zenner Club")
                  ]),
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("resources/js/pages/Admin/Zenner/WelcomeVideo/Index.vue");
