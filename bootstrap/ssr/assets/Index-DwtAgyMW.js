...
import { ac as index, _ as _sfc_main$8, ad as destroy, ae as release, af as massRelease } from "./AppLayout-1TXr_jx9.js";
...
import { MoreHorizontal, Wallet, Trash2, Gift, Plus, DollarSign, Receipt, Search, CheckCircle, XCircle, ArrowUpDown } from "lucide-vue-next";
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    const breadcrumbItems = [
      { title: "Bonus Reward", href: index.url() }
    ];
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(ssrRenderComponent(_sfc_main$8, { breadcrumbs: breadcrumbItems }, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(ssrRenderComponent(unref(Head), { title: "Bonus Reward" }, null, _parent2, _scopeId));
            ...
            _push2(` Bonus Reward </h1><p class="text-muted-foreground"${_scopeId}>Kelola bonus reward member</p></div>`);
            if (unref(isSuperAdmin) || unref(isAdmin)) {
              _push2(ssrRenderComponent(unref(_sfc_main$3), {
                onClick: ($event) => unref(router).visit("/bonus/reward/create")
              }, {
            ...
            _push2(ssrRenderComponent(unref(_sfc_main$d), {
              ...
              placeholder: "Cari member atau tipe reward...",
              class: "pl-9"
            ...
            return [
              createVNode(unref(Head), { title: "Bonus Reward" }),
                ...
                createVNode("div", { class: "flex items-center justify-between" }, [
                  createVNode("div", null, [
                    createVNode("h1", { class: "text-3xl font-bold tracking-tight flex items-center gap-2" }, [
                      ...
                      createTextVNode(" Bonus Reward ")
                    ]),
                    createVNode("p", { class: "text-muted-foreground" }, "Kelola bonus reward member")
                  ]),
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("resources/js/pages/bonus/reward/Index.vue");
