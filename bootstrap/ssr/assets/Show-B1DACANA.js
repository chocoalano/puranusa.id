...
import { _ as _sfc_main$1, i as index$2, e as edit, r as releaseBonuses, t as topUp, f as deduct, d as destroy } from "./AppLayout-DtCYuQDV.js";
...
import { _ as _sfc_main$g, a as _sfc_main$h, b as _sfc_main$i, c as _sfc_main$j, d as _sfc_main$k, e as _sfc_main$m } from "./DialogTrigger-DpE8BjOt.js";
import { ArrowLeft, Gift, Pencil, Trash2, Wallet, Users, TrendingUp, DollarSign } from "lucide-vue-next";
...
index$1.definition = {
  methods: ["get", "head"],
  url: "/manage/customers/{customer}/promotions-rewards"
};
index$1.url = (args, options) => {
  ...
  return index$1.definition.url.replace("{customer}", parsedArgs.customer.toString()).replace(/\/+$/, "") + queryParams(options);
};
...
const index = (args, options) => ({
  url: index.url(args, options),
  method: "get"
});
index.definition = {
  methods: ["get", "head"],
  url: "/manage/customers/{customer}/lifetime-rewards"
};
index.url = (args, options) => {
  ...
  return index.definition.url.replace("{customer}", parsedArgs.customer.toString()).replace(/\/+$/, "") + queryParams(options);
};
...
const claim = (args, options) => ({
  url: claim.url(args, options),
  method: "post"
});
claim.definition = {
  methods: ["post"],
  url: "/manage/customers/{customer}/lifetime-rewards/{reward}/claim"
};
claim.url = (args, options) => {
  if (Array.isArray(args)) {
    args = {
      customer: args[0],
      reward: args[1]
  ...
  return claim.definition.url.replace("{customer}", parsedArgs.customer.toString()).replace("{reward}", parsedArgs.reward.toString()).replace(/\/+$/, "") + queryParams(options);
};
claim.post = (args, options) => ({
  url: claim.url(args, options),
  method: "post"
});
const claimForm = (args, options) => ({
  action: claim.url(args, options),
  method: "post"
});
claimForm.post = (args, options) => ({
  action: claim.url(args, options),
  method: "post"
});
      ...
      _push(ssrRenderComponent(_sfc_main$1, null, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            ...
            _push2(ssrRenderComponent(unref(Link), {
              href: unref(index$1).url(__props.customer.id)
            }, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(ssrRenderComponent(unref(_sfc_main$2), { variant: "outline" }, {
                    default: withCtx((_3, _push4, _parent4, _scopeId3) => {
                      if (_push4) {
                        _push4(ssrRenderComponent(unref(Gift), { class: "mr-2 h-4 w-4" }, null, _parent4, _scopeId3));
                        _push4(` Promotions Rewards `);
                      } else {
                        return [
            ...
            _push2(ssrRenderComponent(unref(Link), {
              href: unref(index).url(__props.customer.id)
            }, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(ssrRenderComponent(unref(_sfc_main$2), { variant: "outline" }, {
                    default: withCtx((_3, _push4, _parent4, _scopeId3) => {
                      if (_push4) {
                        _push4(ssrRenderComponent(unref(Gift), { class: "mr-2 h-4 w-4" }, null, _parent4, _scopeId3));
                        _push4(` Lifetime Rewards `);
                      } else {
                        return [
                          createVNode(unref(Gift), { class: "mr-2 h-4 w-4" }),
                          createTextVNode(" Lifetime Rewards ")
                        ];
                      }
                    }),
                    _: 1
