import { defineComponent, ref, watch, withCtx, unref, createVNode, createTextVNode, createBlock, createCommentVNode, openBlock, toDisplayString, withKeys, Fragment, renderList, useSSRContext } from "vue";
                    ...
                    default: withCtx((_3, _push4, _parent4, _scopeId3) => {
                      if (_push4) {
                        ...
                        if (form.value.is_published) {
                          _push4(`<div class="space-y-2"${_scopeId3}>`);
                          _push4(ssrRenderComponent(unref(_sfc_main$8), { for: "published_at" }, {
                            default: withCtx((_4, _push5, _parent5, _scopeId4) => {
                              if (_push5) {
                        ...
                        return [
                          ...
                          form.value.is_published ? (openBlock(), createBlock("div", {
                            ...
                            createVNode(unref(_sfc_main$8), { for: "published_at" }, {
                              default: withCtx(() => [
                                createTextVNode("Tanggal Terbit")
                              ]),
                              _: 1
