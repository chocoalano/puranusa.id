...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    const applyFilters = () => {
      router.get("/admin/zenner/procure-products", {
    ...
    const handleDelete = () => {
      ...
      useForm({}).delete(`/admin/zenner/procure-products/${deleteTarget.value.id}`, {
        preserveScroll: true,
        onSuccess: () => {
          toast.success("Procure product berhasil dihapus");
          deleteDialogOpen.value = false;
          deleteTarget.value = null;
        },
        onError: () => {
          toast.error("Gagal menghapus procure product");
        }
      });
    };
    ...
    return (_ctx, _push, _parent, _attrs) => {
      _push(ssrRenderComponent(_sfc_main$1, mergeProps({ title: "Procure Products" }, _attrs), {
                ...
                if (_push3) {
                  _push3(ssrRenderComponent(unref(_sfc_main$3), null, {
                    default: withCtx((_3, _push4, _parent4, _scopeId3) => {
                      if (_push4) {
                        _push4(`<div class="flex items-center justify-between"${_scopeId3}><h2 class="text-xl font-semibold"${_scopeId3}>Procure Products</h2>`);
                        _push4(ssrRenderComponent(unref(_sfc_main$4), {
                          onClick: ($event) => unref(router).get("/admin/zenner/procure-products/create")
                        }, {
                        ...
                        return [
                          createVNode("div", { class: "flex items-center justify-between" }, [
                            createVNode("h2", { class: "text-xl font-semibold" }, "Procure Products"),
                                        ...
                                        default: withCtx((_6, _push7, _parent7, _scopeId6) => {
                                          if (_push7) {
                                            ...
                                            _push7(ssrRenderComponent(unref(_sfc_main$h), null, {
                                              default: withCtx((_7, _push8, _parent8, _scopeId7) => {
                                                if (_push8) {
                                                  _push8(`${ssrInterpolate(formatPrice(item.price))}`);
                                                } else {
                                                  return [
                                                    createTextVNode(toDisplayString(formatPrice(item.price)), 1)
                                                  ];
                                                }
                                              }),
                                              _: 2
                                            ...
                                            _push7(ssrRenderComponent(unref(_sfc_main$h), null, {
                                              default: withCtx((_7, _push8, _parent8, _scopeId7) => {
                                                if (_push8) {
                                                  _push8(`${ssrInterpolate(item.points)}`);
                                                } else {
                                                  return [
                                                    createTextVNode(toDisplayString(item.points), 1)
                                                  ];
                                                }
                                              }),
                                              _: 2
                                              ...
                                              default: withCtx((_7, _push8, _parent8, _scopeId7) => {
                                                if (_push8) {
                                                  ...
                                                  _push8(ssrRenderComponent(unref(_sfc_main$4), {
                                                    size: "sm",
                                                    variant: "outline",
                                                    onClick: ($event) => unref(router).get(`/admin/zenner/procure-products/${item.id}/edit`)
                                                  }, {
                                                    default: withCtx((_8, _push9, _parent9, _scopeId8) => {
                                                      if (_push9) {
                          ...
                          default: withCtx((_4, _push5, _parent5, _scopeId4) => {
                            if (_push5) {
                              _push5(ssrRenderComponent(unref(_sfc_main$m), null, {
                                default: withCtx((_5, _push6, _parent6, _scopeId5) => {
                                  if (_push6) {
                                    _push6(`Hapus Procure Product`);
                                  } else {
                                    return [
                                      createTextVNode("Hapus Procure Product")
                                    ];
                                  }
                                }),
                                _: 1
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("resources/js/pages/Admin/Zenner/ProcureProduct/Index.vue");
