...
import { _ as _sfc_main$f } from "./Checkbox-CIOQa2-J.js";
...
import { _ as _sfc_main$g } from "./ImageUploadZone-c8Ae7oqN.js";
import { _ as _sfc_main$e } from "./TiptapEditor-DwYmVXGi.js";
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    const submit = () => {
      ...
      submitFormHelper.transform(() => formData).post(`/admin/products/${props.product.id}`, {
        preserveScroll: true,
        forceFormData: true,
        onSuccess: () => {
                  ...
                  _push3(ssrRenderComponent(unref(_sfc_main$a), { class: "space-y-4" }, {
                    default: withCtx((_3, _push4, _parent4, _scopeId3) => {
                      if (_push4) {
                        ...
                        if (errors.value.b_retail) {
                          _push4(`<p class="text-sm font-medium text-destructive"${_scopeId3}>${ssrInterpolate(errors.value.b_retail)}</p>`);
                        } else {
                          _push4(`<!---->`);
                        }
                        _push4(`</div></div>`);
                        ...
                        return [
                          createVNode("div", { class: "grid grid-cols-2 gap-4" }, [
                            ...
                            createVNode("div", { class: "space-y-2" }, [
                              ...
                              errors.value.b_retail ? (openBlock(), createBlock("p", {
                                key: 0,
                                class: "text-sm font-medium text-destructive"
                              }, toDisplayString(errors.value.b_retail), 1)) : createCommentVNode("", true)
                            ])
                          ])
                        ];
                      }
