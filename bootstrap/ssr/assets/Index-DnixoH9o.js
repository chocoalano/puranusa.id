...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      _push(`<!--[-->`);
      _push(ssrRenderComponent(unref(Head), { title: "Hall of Fame" }, null, _parent));
      _push(ssrRenderComponent(_sfc_main$1, null, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<div class="rounded-xl p-4 space-y-6 py-6"${_scopeId}><div class="flex items-center justify-between"${_scopeId}><div${_scopeId}><h1 class="text-3xl font-bold"${_scopeId}>Hall of Fame</h1><p class="text-muted-foreground"${_scopeId}>Kelola Hall of Fame Zenner Club</p></div>`);
            _push2(ssrRenderComponent(unref(Link), { href: "/admin/zenner/hall-of-fames/create" }, {
                  ...
                  _push3(ssrRenderComponent(unref(_sfc_main$2), null, {
                    default: withCtx((_3, _push4, _parent4, _scopeId3) => {
                      if (_push4) {
                        ...
                        _push4(` Tambah Hall of Fame `);
                      } else {
                        return [
                          createVNode(unref(Plus), { class: "h-4 w-4 mr-2" }),
                          createTextVNode(" Tambah Hall of Fame ")
                        ];
                      }
                    }),
                    _: 1
                                        ...
                                        default: withCtx((_6, _push7, _parent7, _scopeId6) => {
                                          if (_push7) {
                                            ...
                                            _push7(ssrRenderComponent(unref(_sfc_main$c), null, {
                                              default: withCtx((_7, _push8, _parent8, _scopeId7) => {
                                                if (_push8) {
                                                  _push8(`${ssrInterpolate(entry.title)}`);
                                                } else {
                                                  return [
                                            ...
                                            _push7(ssrRenderComponent(unref(_sfc_main$c), null, {
                                              default: withCtx((_7, _push8, _parent8, _scopeId7) => {
                                                if (_push8) {
                                                  _push8(`${ssrInterpolate(entry.achievement)}`);
                                                } else {
                                                  return [
                                                    createTextVNode(toDisplayString(entry.achievement), 1)
                                                  ];
                                                }
                                              }),
                                              _: 2
                                                ...
                                                if (_push8) {
                                                  _push8(ssrRenderComponent(unref(_sfc_main$d), {
                                                    ...
                                                    default: withCtx((_8, _push9, _parent9, _scopeId8) => {
                                                      if (_push9) {
                                                        _push9(`${ssrInterpolate(entry.is_active ? "Aktif" : "Nonaktif")}`);
                                                      } else {
                                                        return [
                                                          createTextVNode(toDisplayString(entry.is_active ? "Aktif" : "Nonaktif"), 1)
                                                        ];
                                                      }
                                                    }),
                                                    _: 2
                                            ...
                                            _push7(ssrRenderComponent(unref(_sfc_main$c), null, {
                                              default: withCtx((_7, _push8, _parent8, _scopeId7) => {
                                                if (_push8) {
                                                  _push8(`${ssrInterpolate(entry.sort_order)}`);
                                                } else {
                                                  return [
                                                    createTextVNode(toDisplayString(entry.sort_order), 1)
                                                  ];
                                                }
                                              }),
                                              _: 2
                                              ...
                                              default: withCtx((_7, _push8, _parent8, _scopeId7) => {
                                                if (_push8) {
                                                  ...
                                                  _push8(ssrRenderComponent(unref(Link), {
                                                    href: `/admin/zenner/hall-of-fames/${entry.id}/edit`
                                                  }, {
                                                    default: withCtx((_8, _push9, _parent9, _scopeId8) => {
                                                      if (_push9) {
                          ...
                          default: withCtx((_4, _push5, _parent5, _scopeId4) => {
                            if (_push5) {
                              _push5(ssrRenderComponent(unref(_sfc_main$i), null, {
                                default: withCtx((_5, _push6, _parent6, _scopeId5) => {
                                  if (_push6) {
                                    _push6(`Hapus Hall of Fame`);
                                  } else {
                                    return [
                                      createTextVNode("Hapus Hall of Fame")
                                    ];
                                  }
                                }),
                                _: 1
                              ...
                              _push5(ssrRenderComponent(unref(_sfc_main$j), null, {
                                default: withCtx((_5, _push6, _parent6, _scopeId5) => {
                                  if (_push6) {
                                    _push6(` Apakah Anda yakin ingin menghapus entri ini? Tindakan ini tidak dapat dibatalkan. `);
                                  } else {
                                    return [
                                      createTextVNode(" Apakah Anda yakin ingin menghapus entri ini? Tindakan ini tidak dapat dibatalkan. ")
                                    ];
                                  }
                                }),
                                _: 1
              ...
              createVNode("div", { class: "rounded-xl p-4 space-y-6 py-6" }, [
                createVNode("div", { class: "flex items-center justify-between" }, [
                  createVNode("div", null, [
                    createVNode("h1", { class: "text-3xl font-bold" }, "Hall of Fame"),
                    createVNode("p", { class: "text-muted-foreground" }, "Kelola Hall of Fame Zenner Club")
                  ]),
                  createVNode(unref(Link), { href: "/admin/zenner/hall-of-fames/create" }, {
                    default: withCtx(() => [
                      createVNode(unref(_sfc_main$2), null, {
                        default: withCtx(() => [
                          createVNode(unref(Plus), { class: "h-4 w-4 mr-2" }),
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("resources/js/pages/Admin/Zenner/HallOfFame/Index.vue");
