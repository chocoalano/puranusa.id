    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(ssrRenderComponent(_sfc_main$1, null, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<div class="rounded-xl p-4 space-y-6 py-6"${_scopeId}><div${_scopeId}><h2 class="text-3xl font-bold tracking-tight"${_scopeId}>Kelola E-Wallet</h2><p class="text-muted-foreground"${_scopeId}>Monitoring saldo e-wallet seluruh customer</p></div><div class="grid gap-4 md:grid-cols-3"${_scopeId}>`);
            ...
            _push2(`</div><div class="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between"${_scopeId}><div class="relative flex-1 max-w-sm"${_scopeId}>`);
