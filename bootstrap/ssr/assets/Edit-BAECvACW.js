  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(ssrRenderComponent(unref(Head), {
        title: `Edit ${__props.certificate.title}`
      }, null, _parent));
      _push(ssrRenderComponent(_sfc_main$1, null, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            ...
            _push2(`<div${_scopeId}><h1 class="text-3xl font-bold"${_scopeId}>Edit Sertifikat</h1><p class="text-muted-foreground"${_scopeId}>Perbarui informasi sertifikat</p></div></div>`);
              ...
              createVNode("div", { class: "rounded-xl p-4 space-y-6 py-6" }, [
                createVNode("div", { class: "flex items-center gap-4" }, [
                  ...
                  createVNode("div", null, [
                    createVNode("h1", { class: "text-3xl font-bold" }, "Edit Sertifikat"),
                    createVNode("p", { class: "text-muted-foreground" }, "Perbarui informasi sertifikat")
                  ])
                ]),
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("resources/js/pages/Admin/Zenner/Certificate/Edit.vue");
