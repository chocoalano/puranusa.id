...
import { c as cn, _ as _sfc_main$e } from "./index-SN_CnQ_F.js";
import { _ as _sfc_main$f } from "./Input-BGi8wCMh.js";
...
import { h as _sfc_main$4, i as _sfc_main$5, j as _sfc_main$6, k as _sfc_main$7, l as _sfc_main$8, e as _sfc_main$c, n as _sfc_main$l, _ as _sfc_main$m, a as _sfc_main$n, b as _sfc_main$p, f as _sfc_main$q, g as _sfc_main$r, c as _sfc_main$t, o as _sfc_main$u } from "./DropdownMenuTrigger-B1v6pHML.js";
...
const _sfc_main$1 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props, { emit: __emit }) {
    ...
    const isActiveCustomer = computed(() => {
      return page.props.auth?.user?.status === 3;
    });
            ...
            _push2(ssrRenderComponent(unref(_sfc_main$5), {
              ...
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  ...
                  if (isActiveCustomer.value) {
                    _push3(`<div class="space-y-4"${_scopeId2}><div class="flex items-center gap-2 text-sm font-medium"${_scopeId2}>`);
                    _push3(ssrRenderComponent(unref(ClipboardList), { class: "h-4 w-4" }, null, _parent3, _scopeId2));
                    _push3(`<span${_scopeId2}>Jenis Transaksi</span></div>`);
                    _push3(ssrRenderComponent(unref(_sfc_main$3), {
                      modelValue: form.value.transaction_type,
                      "onUpdate:modelValue": ($event) => form.value.transaction_type = $event,
                      class: "space-y-3"
                    }, {
                      default: withCtx((_3, _push4, _parent4, _scopeId3) => {
                        if (_push4) {
                          _push4(`<div class="${ssrRenderClass([{
                            "border-primary bg-primary/10": form.value.transaction_type === "planA",
                            "hover:bg-muted": form.value.transaction_type !== "planA"
                          ...
                          _push4(`</div><div class="${ssrRenderClass([{
                            "border-primary bg-primary/10": form.value.transaction_type === "planB",
                            "hover:bg-muted": form.value.transaction_type !== "planB"
                          }, "flex cursor-pointer items-center space-x-3 rounded-lg border p-4 transition-colors"])}"${_scopeId3}>`);
                          _push4(ssrRenderComponent(unref(_sfc_main$2), {
                            value: "planB",
                            id: "transaction-planB"
                          }, null, _parent4, _scopeId3));
                          _push4(ssrRenderComponent(unref(_sfc_main$d), {
                            for: "transaction-planB",
                            class: "flex-1 cursor-pointer"
                          }, {
                            default: withCtx((_4, _push5, _parent5, _scopeId4) => {
                              if (_push5) {
                          ...
                          return [
                            createVNode("div", {
                              ...
                              onClick: ($event) => form.value.transaction_type = "planA"
                            }, [
                            ...
                            createVNode("div", {
                              ...
                              onClick: ($event) => form.value.transaction_type = "planB"
                            }, [
                              createVNode(unref(_sfc_main$2), {
                                value: "planB",
                                id: "transaction-planB"
                  ...
                  if (isPickUpSelected.value) {
                    _push3(`<div class="flex items-center justify-between text-xs text-muted-foreground"${_scopeId2}><span${_scopeId2}>Ingin kirim ke alamat?</span>`);
                    _push3(ssrRenderComponent(unref(_sfc_main$e), {
                      type: "button",
                      variant: "link",
                      size: "sm",
                      class: "h-auto p-0 text-xs",
                      onClick: clearPickUpSelection
                    }, {
                      default: withCtx((_3, _push4, _parent4, _scopeId3) => {
                        if (_push4) {
                          _push4(` Pilih kurir lain `);
                        } else {
                          return [
                            createTextVNode(" Pilih kurir lain ")
                          ];
                        }
                      }),
                      _: 1
                  ...
                  if (isPickUpSelected.value) {
                    ...
                    _push3(ssrRenderComponent(unref(_sfc_main$g), {
                      ...
                      default: withCtx((_3, _push4, _parent4, _scopeId3) => {
                        if (_push4) {
                          _push4(ssrRenderComponent(unref(_sfc_main$h), { id: "province" }, {
                            default: withCtx((_4, _push5, _parent5, _scopeId4) => {
                              if (_push5) {
                          ...
                          return [
                            createVNode(unref(_sfc_main$h), { id: "province" }, {
                              default: withCtx(() => [
                                createVNode(unref(_sfc_main$i), {
                                  placeholder: loadingProvinces.value ? "Memuat provinsi..." : "Pilih provinsi"
                                }, null, 8, ["placeholder"])
                    ...
                    _push3(ssrRenderComponent(unref(_sfc_main$g), {
                      ...
                      default: withCtx((_3, _push4, _parent4, _scopeId3) => {
                        if (_push4) {
                          _push4(ssrRenderComponent(unref(_sfc_main$h), { id: "city" }, {
                            default: withCtx((_4, _push5, _parent5, _scopeId4) => {
                              if (_push5) {
                                _push5(ssrRenderComponent(unref(_sfc_main$i), {
                          ...
                          return [
                            createVNode(unref(_sfc_main$h), { id: "city" }, {
                              default: withCtx(() => [
                                createVNode(unref(_sfc_main$i), {
                                  placeholder: loadingCities.value ? "Memuat kota..." : !form.value.province_id ? "Pilih provinsi terlebih dahulu" : "Pilih kota"
                                }, null, 8, ["placeholder"])
                  ...
                  return [
                    ...
                    createVNode("div", { class: "space-y-6 py-6" }, [
                      ...
                      isActiveCustomer.value ? (openBlock(), createBlock("div", {
                        key: 2,
                        class: "space-y-4"
                      }, [
                        createVNode("div", { class: "flex items-center gap-2 text-sm font-medium" }, [
                          createVNode(unref(ClipboardList), { class: "h-4 w-4" }),
                          createVNode("span", null, "Jenis Transaksi")
                        ]),
                      ...
                      createVNode("div", { class: "space-y-4" }, [
                        ...
                        isPickUpSelected.value ? (openBlock(), createBlock("div", {
                          ...
                          createVNode("span", null, "Ingin kirim ke alamat?"),
                          createVNode(unref(_sfc_main$e), {
                            type: "button",
                            variant: "link",
                            size: "sm",
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    const normalizeFooterTitle = (title) => title.trim().toLowerCase();
    ...
    return (_ctx, _push, _parent, _attrs) => {
                ...
                if (_push3) {
                  if (isAuthenticated.value) {
                    _push3(ssrRenderComponent(unref(_sfc_main$q), null, {
                      default: withCtx((_3, _push4, _parent4, _scopeId3) => {
                        if (_push4) {
                          _push4(`<div class="flex flex-col space-y-1"${_scopeId3}><p class="text-sm font-medium"${_scopeId3}>${ssrInterpolate(unref(page).props.auth?.user?.name || "Customer")}</p><p class="text-xs text-muted-foreground"${_scopeId3}>${ssrInterpolate(unref(page).props.auth?.user?.username)}</p></div>`);
                        } else {
                          return [
                            createVNode("div", { class: "flex flex-col space-y-1" }, [
                              ...
                              createVNode("p", { class: "text-xs text-muted-foreground" }, toDisplayString(unref(page).props.auth?.user?.username), 1)
                            ])
                          ];
                        }
                      }),
      ...
      _push(`<!--]--></div></div></div><div class="lg:col-span-8"><div class="grid grid-cols-2 gap-8 md:grid-cols-3"><!--[-->`);
      ssrRenderList(secondaryFooterMenus.value, (menu) => {
      ...
      _push(`<!--]--></div>`);
      if (publishedPageLinks.value.length > 0) {
        _push(`<div class="mt-10"><h4 class="mb-4 text-sm font-bold text-foreground"> Informasi </h4><div class="grid grid-cols-1 gap-3 text-sm sm:grid-cols-2 lg:grid-cols-3"><!--[-->`);
        ssrRenderList(publishedPageLinks.value, (link) => {
          _push(ssrRenderComponent(unref(Link), {
            key: `info-${link.href}`,
            href: link.href,
            class: "group inline-flex items-center text-muted-foreground transition-colors hover:text-primary"
