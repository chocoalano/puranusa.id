...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    const applyFilters = () => {
      router.get("/admin/zenner/galleries", {
        search: search.value || void 0,
        status: status.value !== "all" ? status.value : void 0,
        category: category.value || void 0,
        file_type: fileType.value !== "all" ? fileType.value : void 0,
    ...
    const confirmDelete = () => {
      ...
      useForm({}).delete(`/admin/zenner/galleries/${itemToDelete.value}`, {
        preserveScroll: true,
        onSuccess: () => {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      _push(ssrRenderComponent(_sfc_main$1, _attrs, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<div class="container mx-auto py-6 space-y-6"${_scopeId}><div class="flex items-center justify-between"${_scopeId}><div${_scopeId}><h1 class="text-3xl font-bold tracking-tight"${_scopeId}>Gallery</h1><p class="text-muted-foreground"${_scopeId}>Kelola gallery Zenner Club</p></div>`);
            _push2(ssrRenderComponent(unref(_sfc_main$2), { "as-child": "" }, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(ssrRenderComponent(unref(Link), { href: "/admin/zenner/galleries/create" }, {
                    default: withCtx((_3, _push4, _parent4, _scopeId3) => {
                      if (_push4) {
                        _push4(ssrRenderComponent(unref(Plus), { class: "mr-2 h-4 w-4" }, null, _parent4, _scopeId3));
                        _push4(` Tambah Gallery `);
                      } else {
                        return [
                          createVNode(unref(Plus), { class: "mr-2 h-4 w-4" }),
                          createTextVNode(" Tambah Gallery ")
                        ];
                      }
                    }),
                    _: 1
                  ...
                  return [
                    createVNode(unref(Link), { href: "/admin/zenner/galleries/create" }, {
                      default: withCtx(() => [
                        createVNode(unref(Plus), { class: "mr-2 h-4 w-4" }),
                        createTextVNode(" Tambah Gallery ")
                      ]),
                    ...
                    default: withCtx((_3, _push4, _parent4, _scopeId3) => {
                      if (_push4) {
                        ...
                        _push4(ssrRenderComponent(unref(_sfc_main$6), {
                          modelValue: fileType.value,
                          "onUpdate:modelValue": [($event) => fileType.value = $event, applyFilters]
                        }, {
                            ...
                            if (_push5) {
                              _push5(ssrRenderComponent(unref(_sfc_main$7), { class: "w-[140px]" }, {
                                default: withCtx((_5, _push6, _parent6, _scopeId5) => {
                                  if (_push6) {
                                    _push6(ssrRenderComponent(unref(_sfc_main$8), { placeholder: "Tipe File" }, null, _parent6, _scopeId5));
                                  } else {
                                    return [
                                      createVNode(unref(_sfc_main$8), { placeholder: "Tipe File" })
                                    ];
                                  }
                                }),
                                _: 1
                              ...
                              _push5(ssrRenderComponent(unref(_sfc_main$9), null, {
                                default: withCtx((_5, _push6, _parent6, _scopeId5) => {
                                  if (_push6) {
                                    ...
                                    _push6(ssrRenderComponent(unref(_sfc_main$a), { value: "image" }, {
                                      default: withCtx((_6, _push7, _parent7, _scopeId6) => {
                                        if (_push7) {
                                          _push7(`Image`);
                                        } else {
                                    ...
                                    _push6(ssrRenderComponent(unref(_sfc_main$a), { value: "video" }, {
                                      default: withCtx((_6, _push7, _parent7, _scopeId6) => {
                                        if (_push7) {
                                          _push7(`Video`);
                                        } else {
                                    ...
                                    return [
                                      ...
                                      createVNode(unref(_sfc_main$a), { value: "image" }, {
                                        default: withCtx(() => [
                                          createTextVNode("Image")
                                        ]),
                                        _: 1
                                      }),
                                      createVNode(unref(_sfc_main$a), { value: "video" }, {
                                        default: withCtx(() => [
                                          createTextVNode("Video")
                                        ]),
                                        _: 1
                                                  ...
                                                  if (_push8) {
                                                    _push8(ssrRenderComponent(unref(_sfc_main$i), { variant: "outline" }, {
                                                      default: withCtx((_8, _push9, _parent9, _scopeId8) => {
                                                        if (_push9) {
                                                          _push9(`${ssrInterpolate(item.file_type)}`);
                                                        } else {
                                                          return [
                                                            createTextVNode(toDisplayString(item.file_type), 1)
                                                          ];
                                                        }
                                                      }),
                                                      _: 2
                                                      ...
                                                      default: withCtx((_8, _push9, _parent9, _scopeId8) => {
                                                        if (_push9) {
                                                          _push9(ssrRenderComponent(unref(Link), {
                                                            href: `/admin/zenner/galleries/${item.id}/edit`
                                                          }, {
                          ...
                          default: withCtx((_4, _push5, _parent5, _scopeId4) => {
                            if (_push5) {
                              _push5(ssrRenderComponent(unref(_sfc_main$m), null, {
                                default: withCtx((_5, _push6, _parent6, _scopeId5) => {
                                  if (_push6) {
                                    _push6(`Hapus Gallery?`);
                                  } else {
                                    return [
                                      createTextVNode("Hapus Gallery?")
                                    ];
                                  }
                                }),
                                _: 1
              ...
              createVNode("div", { class: "container mx-auto py-6 space-y-6" }, [
                createVNode("div", { class: "flex items-center justify-between" }, [
                  createVNode("div", null, [
                    createVNode("h1", { class: "text-3xl font-bold tracking-tight" }, "Gallery"),
                    createVNode("p", { class: "text-muted-foreground" }, "Kelola gallery Zenner Club")
                  ]),
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("resources/js/pages/Admin/Zenner/Gallery/Index.vue");
