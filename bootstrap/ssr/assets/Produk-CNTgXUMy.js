import { defineComponent, ref, mergeProps, unref, withCtx, createVNode, createBlock, createCommentVNode, openBlock, toDisplayString, useSSRContext, createTextVNode, computed, Fragment, renderList, onMounted } from "vue";
...
import { a as _sfc_main$c, _ as _sfc_main$j } from "./Ecommerce-tntAMUbA.js";
...
import { ChevronLeft, ChevronRight, ZoomIn, Award, Package, Star, Truck, Minus, Plus, ShoppingCart, Heart, Share2, Info, Lightbulb, Ruler } from "lucide-vue-next";
...
const _sfc_main$3 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    const formatHtml = (html) => {
      if (!html) return "";
      return html.replace(/\s*\|\|\s*/g, '<div class="spacer-divider"></div>').replace(/<li>\s*<p>([\s\S]*?)<\/p>\s*<\/li>/gi, "<li>$1</li>").trim();
    };
    ...
    return (_ctx, _push, _parent, _attrs) => {
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "product-info-wrapper" }, _attrs))} data-v-fed2c830>`);
      if (renderedShort.value) {
        _push(`<section class="text-section" data-v-fed2c830><div class="minimal-label" data-v-fed2c830>`);
        _push(ssrRenderComponent(unref(Info), { class: "h-4 w-4" }, null, _parent));
        _push(`<span data-v-fed2c830>Ringkasan Produk</span></div><div class="tiptap-render" data-v-fed2c830>${renderedShort.value ?? ""}</div></section>`);
      } else {
        _push(`<!---->`);
      }
      if (renderedShort.value && renderedLong.value) {
        _push(ssrRenderComponent(unref(_sfc_main$a), { class: "my-8" }, null, _parent));
      } else {
        _push(`<!---->`);
      }
      if (renderedLong.value) {
        _push(`<section class="text-section" data-v-fed2c830><div class="minimal-label" data-v-fed2c830>`);
        _push(ssrRenderComponent(unref(Lightbulb), { class: "h-4 w-4" }, null, _parent));
        _push(`<span data-v-fed2c830>Deskripsi Lengkap</span></div><div class="tiptap-render" data-v-fed2c830>${renderedLong.value ?? ""}</div></section>`);
      } else {
        _push(`<!---->`);
      }
      _push(ssrRenderComponent(unref(_sfc_main$a), { class: "my-8" }, null, _parent));
      if (__props.weightGram || __props.dimensions) {
        _push(`<section data-v-fed2c830><h3 class="text-xs font-bold uppercase tracking-widest text-muted-foreground mb-4" data-v-fed2c830> Spesifikasi Fisik </h3><div class="grid grid-cols-1 md:grid-cols-2 gap-4" data-v-fed2c830>`);
        if (__props.weightGram) {
          _push(ssrRenderComponent(unref(_sfc_main$7), null, {
            default: withCtx((_, _push2, _parent2, _scopeId) => {
              if (_push2) {
                _push2(ssrRenderComponent(unref(_sfc_main$d), { class: "pb-2" }, {
                  default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                    if (_push3) {
                      _push3(ssrRenderComponent(unref(_sfc_main$e), { class: "text-sm font-medium flex items-center gap-2" }, {
                      ...
                      return [
                        createVNode(unref(_sfc_main$e), { class: "text-sm font-medium flex items-center gap-2" }, {
                          default: withCtx(() => [
                            createVNode(unref(Package), { class: "h-4 w-4 text-muted-foreground" }),
                            createTextVNode(" Berat ")
                          ]),
                ...
                _push2(ssrRenderComponent(unref(_sfc_main$f), null, {
                  default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                    if (_push3) {
                      _push3(`<div class="text-2xl font-bold" data-v-fed2c830${_scopeId2}>${ssrInterpolate(__props.weightGram)} <span class="text-sm font-normal text-muted-foreground" data-v-fed2c830${_scopeId2}>gr</span></div>`);
                    } else {
                      return [
                        createVNode("div", { class: "text-2xl font-bold" }, [
                          createTextVNode(toDisplayString(__props.weightGram) + " ", 1),
                          createVNode("span", { class: "text-sm font-normal text-muted-foreground" }, "gr")
                        ])
                      ];
                    }
                  }),
            ...
            default: withCtx((_, _push2, _parent2, _scopeId) => {
              if (_push2) {
                  ...
                  default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                    if (_push3) {
                      _push3(ssrRenderComponent(unref(_sfc_main$e), { class: "text-sm font-medium flex items-center gap-2" }, {
                        default: withCtx((_3, _push4, _parent4, _scopeId3) => {
                          if (_push4) {
                            _push4(ssrRenderComponent(unref(Ruler), { class: "h-4 w-4 text-muted-foreground" }, null, _parent4, _scopeId3));
                            _push4(` Dimensi `);
                          } else {
                            return [
                              createVNode(unref(Ruler), { class: "h-4 w-4 text-muted-foreground" }),
                ...
                _push2(ssrRenderComponent(unref(_sfc_main$f), null, {
                  default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                    if (_push3) {
                      _push3(`<div class="text-2xl font-bold" data-v-fed2c830${_scopeId2}>${ssrInterpolate(__props.dimensions.length)}×${ssrInterpolate(__props.dimensions.width)}×${ssrInterpolate(__props.dimensions.height)} <span class="text-sm font-normal text-muted-foreground ml-1" data-v-fed2c830${_scopeId2}>mm</span></div>`);
                    } else {
                      return [
                        createVNode("div", { class: "text-2xl font-bold" }, [
                          createTextVNode(toDisplayString(__props.dimensions.length) + "×" + toDisplayString(__props.dimensions.width) + "×" + toDisplayString(__props.dimensions.height) + " ", 1),
                          createVNode("span", { class: "text-sm font-normal text-muted-foreground ml-1" }, "mm")
                        ])
                      ];
                    }
                  }),
...
const ProductDescription = /* @__PURE__ */ _export_sfc(_sfc_main$3, [["__scopeId", "data-v-fed2c830"]]);
              ...
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  ...
                  _push3(ssrRenderComponent(unref(_sfc_main$t), {
                    ...
                    default: withCtx((_3, _push4, _parent4, _scopeId3) => {
                      if (_push4) {
                        _push4(ssrRenderComponent(ProductDescription, {
