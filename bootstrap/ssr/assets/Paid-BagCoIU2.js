import { defineComponent, mergeProps, unref, useSSRContext, ref, watch, withCtx, createTextVNode, toDisplayString, createVNode, createBlock, createCommentVNode, openBlock, Fragment, renderList, h } from "vue";
...
import { X, Printer, Download, Package, DollarSign, Search, ChevronDown, ArrowUpDown, FileText, Eye } from "lucide-vue-next";
...
import { _ as _sfc_main$9 } from "./AppLayout-BHxY2bcF.js";
    ...
    return (_ctx, _push, _parent, _attrs) => {
      _push(ssrRenderComponent(unref(_sfc_main$3), mergeProps({
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(ssrRenderComponent(unref(_sfc_main$4), { class: "max-w-4xl max-h-[90vh] overflow-y-auto print:max-w-full print:max-h-full print:overflow-visible" }, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  ...
                  if (loading.value) {
                    _push3(`<div class="flex items-center justify-center py-12" data-v-c9cd3b5c${_scopeId2}><div class="text-center" data-v-c9cd3b5c${_scopeId2}><div class="inline-block h-8 w-8 animate-spin rounded-full border-4 border-solid border-current border-r-transparent align-[-0.125em] motion-reduce:animate-[spin_1.5s_linear_infinite]" data-v-c9cd3b5c${_scopeId2}></div><p class="mt-4 text-muted-foreground" data-v-c9cd3b5c${_scopeId2}>Memuat invoice...</p></div></div>`);
                  } else if (order.value) {
                    _push3(`<div class="invoice-content" data-v-c9cd3b5c${_scopeId2}><div class="flex justify-end gap-2 mb-6 print:hidden" data-v-c9cd3b5c${_scopeId2}>`);
                    _push3(ssrRenderComponent(unref(_sfc_main$7), {
                      variant: "outline",
                      size: "sm",
                      onClick: handlePrint
                    ...
                    _push3(`</div><div class="mb-8" data-v-c9cd3b5c${_scopeId2}><div class="flex items-start justify-between" data-v-c9cd3b5c${_scopeId2}><div data-v-c9cd3b5c${_scopeId2}><div class="flex items-center gap-3 mb-2" data-v-c9cd3b5c${_scopeId2}><div class="w-12 h-12 bg-primary rounded-lg flex items-center justify-center" data-v-c9cd3b5c${_scopeId2}><span class="text-white font-bold text-xl" data-v-c9cd3b5c${_scopeId2}>P</span></div><div data-v-c9cd3b5c${_scopeId2}><h1 class="text-2xl font-bold" data-v-c9cd3b5c${_scopeId2}>PURANUSA</h1><p class="text-sm text-muted-foreground" data-v-c9cd3b5c${_scopeId2}>Natural Health &amp; Wellness</p></div></div><div class="text-sm text-muted-foreground mt-3" data-v-c9cd3b5c${_scopeId2}><p data-v-c9cd3b5c${_scopeId2}>Jl. Raya Puranusa No. 123</p><p data-v-c9cd3b5c${_scopeId2}>Jakarta Selatan, DKI Jakarta 12345</p><p data-v-c9cd3b5c${_scopeId2}>Email: info@puranusa.id</p><p data-v-c9cd3b5c${_scopeId2}>Telp: (021) 1234-5678</p></div></div><div class="text-right" data-v-c9cd3b5c${_scopeId2}><h2 class="text-3xl font-bold mb-2" data-v-c9cd3b5c${_scopeId2}>INVOICE</h2><div class="space-y-1" data-v-c9cd3b5c${_scopeId2}><p class="text-sm" data-v-c9cd3b5c${_scopeId2}><span class="font-semibold" data-v-c9cd3b5c${_scopeId2}>Invoice No:</span><span class="ml-2 font-mono" data-v-c9cd3b5c${_scopeId2}>${ssrInterpolate(order.value.order_no)}</span></p><p class="text-sm" data-v-c9cd3b5c${_scopeId2}><span class="font-semibold" data-v-c9cd3b5c${_scopeId2}>Tanggal:</span><span class="ml-2" data-v-c9cd3b5c${_scopeId2}>${ssrInterpolate(formatDate(order.value.created_at))}</span></p><p class="text-sm" data-v-c9cd3b5c${_scopeId2}><span class="font-semibold" data-v-c9cd3b5c${_scopeId2}>Status:</span><span class="${ssrRenderClass([{
                    ...
                    }, "ml-2 px-2 py-1 rounded text-xs font-medium"])}" data-v-c9cd3b5c${_scopeId2}>${ssrInterpolate(order.value.payment_status)}</span></p></div></div></div></div>`);
                    _push3(ssrRenderComponent(unref(_sfc_main$8), { class: "my-6" }, null, _parent3, _scopeId2));
                    _push3(`<div class="grid grid-cols-2 gap-8 mb-8" data-v-c9cd3b5c${_scopeId2}><div data-v-c9cd3b5c${_scopeId2}><h3 class="font-semibold text-sm mb-3 text-muted-foreground" data-v-c9cd3b5c${_scopeId2}>BILL TO:</h3><div class="space-y-1" data-v-c9cd3b5c${_scopeId2}><p class="font-semibold" data-v-c9cd3b5c${_scopeId2}>${ssrInterpolate(order.value.customer.name)}</p><p class="text-sm text-muted-foreground" data-v-c9cd3b5c${_scopeId2}>${ssrInterpolate(order.value.customer.email)}</p>`);
                    if (order.value.customer.phone) {
                      _push3(`<p class="text-sm text-muted-foreground" data-v-c9cd3b5c${_scopeId2}>${ssrInterpolate(order.value.customer.phone)}</p>`);
                    } else {
                      _push3(`<!---->`);
                    }
                    if (order.value.billingAddress) {
                      _push3(`<div class="text-sm text-muted-foreground mt-2" data-v-c9cd3b5c${_scopeId2}><p data-v-c9cd3b5c${_scopeId2}>${ssrInterpolate(order.value.billingAddress.address)}</p><p data-v-c9cd3b5c${_scopeId2}>${ssrInterpolate(order.value.billingAddress.city)}, ${ssrInterpolate(order.value.billingAddress.province)}</p><p data-v-c9cd3b5c${_scopeId2}>${ssrInterpolate(order.value.billingAddress.postal_code)}</p></div>`);
                    } else {
                      _push3(`<!---->`);
                    }
                    _push3(`</div></div>`);
                    if (order.value.shippingAddress) {
                      _push3(`<div data-v-c9cd3b5c${_scopeId2}><h3 class="font-semibold text-sm mb-3 text-muted-foreground" data-v-c9cd3b5c${_scopeId2}>SHIP TO:</h3><div class="space-y-1" data-v-c9cd3b5c${_scopeId2}><p class="font-semibold" data-v-c9cd3b5c${_scopeId2}>${ssrInterpolate(order.value.shippingAddress.full_name)}</p><p class="text-sm text-muted-foreground" data-v-c9cd3b5c${_scopeId2}>${ssrInterpolate(order.value.shippingAddress.phone)}</p><div class="text-sm text-muted-foreground mt-2" data-v-c9cd3b5c${_scopeId2}><p data-v-c9cd3b5c${_scopeId2}>${ssrInterpolate(order.value.shippingAddress.address)}</p><p data-v-c9cd3b5c${_scopeId2}>${ssrInterpolate(order.value.shippingAddress.city)}, ${ssrInterpolate(order.value.shippingAddress.province)}</p><p data-v-c9cd3b5c${_scopeId2}>${ssrInterpolate(order.value.shippingAddress.postal_code)}</p></div></div></div>`);
                    } else {
                      _push3(`<!---->`);
                    }
                    _push3(`</div><div class="mb-8" data-v-c9cd3b5c${_scopeId2}><table class="w-full" data-v-c9cd3b5c${_scopeId2}><thead data-v-c9cd3b5c${_scopeId2}><tr class="border-b-2 border-border" data-v-c9cd3b5c${_scopeId2}><th class="text-left py-3 px-2 text-sm font-semibold" data-v-c9cd3b5c${_scopeId2}>No</th><th class="text-left py-3 px-2 text-sm font-semibold" data-v-c9cd3b5c${_scopeId2}>Produk</th><th class="text-center py-3 px-2 text-sm font-semibold" data-v-c9cd3b5c${_scopeId2}>Qty</th><th class="text-right py-3 px-2 text-sm font-semibold" data-v-c9cd3b5c${_scopeId2}>Harga</th><th class="text-right py-3 px-2 text-sm font-semibold" data-v-c9cd3b5c${_scopeId2}>Subtotal</th></tr></thead><tbody data-v-c9cd3b5c${_scopeId2}><!--[-->`);
                    ssrRenderList(order.value.items, (item, index) => {
                      _push3(`<tr class="border-b border-border" data-v-c9cd3b5c${_scopeId2}><td class="py-3 px-2 text-sm" data-v-c9cd3b5c${_scopeId2}>${ssrInterpolate(index + 1)}</td><td class="py-3 px-2" data-v-c9cd3b5c${_scopeId2}><div data-v-c9cd3b5c${_scopeId2}><p class="font-medium" data-v-c9cd3b5c${_scopeId2}>${ssrInterpolate(item.product.name)}</p><p class="text-xs text-muted-foreground" data-v-c9cd3b5c${_scopeId2}>SKU: ${ssrInterpolate(item.product.sku)}</p></div></td><td class="py-3 px-2 text-center" data-v-c9cd3b5c${_scopeId2}>${ssrInterpolate(item.qty)}</td><td class="py-3 px-2 text-right" data-v-c9cd3b5c${_scopeId2}>${ssrInterpolate(formatCurrency(item.price))}</td><td class="py-3 px-2 text-right font-medium" data-v-c9cd3b5c${_scopeId2}>${ssrInterpolate(formatCurrency(item.total))}</td></tr>`);
                    });
                    _push3(`<!--]--></tbody></table></div><div class="flex justify-end mb-8" data-v-c9cd3b5c${_scopeId2}><div class="w-80 space-y-3" data-v-c9cd3b5c${_scopeId2}><div class="flex justify-between text-sm" data-v-c9cd3b5c${_scopeId2}><span class="text-muted-foreground" data-v-c9cd3b5c${_scopeId2}>Subtotal:</span><span class="font-medium" data-v-c9cd3b5c${_scopeId2}>${ssrInterpolate(formatCurrency(order.value.subtotal_amount))}</span></div>`);
                    if (order.value.discount_amount > 0) {
                      _push3(`<div class="flex justify-between text-sm" data-v-c9cd3b5c${_scopeId2}><span class="text-muted-foreground" data-v-c9cd3b5c${_scopeId2}>Diskon:</span><span class="font-medium text-red-600" data-v-c9cd3b5c${_scopeId2}>-${ssrInterpolate(formatCurrency(order.value.discount_amount))}</span></div>`);
                    } else {
                      _push3(`<!---->`);
                    }
                    _push3(`<div class="flex justify-between text-sm" data-v-c9cd3b5c${_scopeId2}><span class="text-muted-foreground" data-v-c9cd3b5c${_scopeId2}>Ongkir:</span><span class="font-medium" data-v-c9cd3b5c${_scopeId2}>${ssrInterpolate(formatCurrency(order.value.shipping_amount))}</span></div>`);
                    if (order.value.tax_amount > 0) {
                      _push3(`<div class="flex justify-between text-sm" data-v-c9cd3b5c${_scopeId2}><span class="text-muted-foreground" data-v-c9cd3b5c${_scopeId2}>Pajak:</span><span class="font-medium" data-v-c9cd3b5c${_scopeId2}>${ssrInterpolate(formatCurrency(order.value.tax_amount))}</span></div>`);
                    } else {
                      _push3(`<!---->`);
                    }
                    _push3(ssrRenderComponent(unref(_sfc_main$8), null, null, _parent3, _scopeId2));
                    _push3(`<div class="flex justify-between text-lg font-bold" data-v-c9cd3b5c${_scopeId2}><span data-v-c9cd3b5c${_scopeId2}>Total:</span><span class="text-primary" data-v-c9cd3b5c${_scopeId2}>${ssrInterpolate(formatCurrency(order.value.grand_total))}</span></div></div></div>`);
                    if (order.value.payments && order.value.payments.length > 0) {
                      _push3(`<div class="mb-8" data-v-c9cd3b5c${_scopeId2}><h3 class="font-semibold text-sm mb-3" data-v-c9cd3b5c${_scopeId2}>INFORMASI PEMBAYARAN:</h3><div class="bg-muted/50 rounded-lg p-4" data-v-c9cd3b5c${_scopeId2}><!--[-->`);
                      ssrRenderList(order.value.payments, (payment, index) => {
                        _push3(`<div class="${ssrRenderClass([{ "mt-4 pt-4 border-t": index > 0 }, "text-sm"])}" data-v-c9cd3b5c${_scopeId2}><div class="flex justify-between mb-1" data-v-c9cd3b5c${_scopeId2}><span data-v-c9cd3b5c${_scopeId2}>Metode Pembayaran:</span><span class="font-medium" data-v-c9cd3b5c${_scopeId2}>${ssrInterpolate(payment.method?.name || "N/A")}</span></div><div class="flex justify-between mb-1" data-v-c9cd3b5c${_scopeId2}><span data-v-c9cd3b5c${_scopeId2}>Kode:</span><span class="font-medium uppercase text-xs" data-v-c9cd3b5c${_scopeId2}>${ssrInterpolate(payment.method?.code || "N/A")}</span></div><div class="flex justify-between mb-1" data-v-c9cd3b5c${_scopeId2}><span data-v-c9cd3b5c${_scopeId2}>Jumlah:</span><span class="font-medium" data-v-c9cd3b5c${_scopeId2}>${ssrInterpolate(formatCurrency(payment.amount))}</span></div><div class="flex justify-between mb-1" data-v-c9cd3b5c${_scopeId2}><span data-v-c9cd3b5c${_scopeId2}>Tanggal:</span><span class="font-medium" data-v-c9cd3b5c${_scopeId2}>${ssrInterpolate(formatDateTime(payment.created_at))}</span></div><div class="flex justify-between" data-v-c9cd3b5c${_scopeId2}><span data-v-c9cd3b5c${_scopeId2}>Status:</span><span class="${ssrRenderClass([{
                        ...
                        }, "font-medium uppercase text-xs px-2 py-0.5 rounded"])}" data-v-c9cd3b5c${_scopeId2}>${ssrInterpolate(payment.status)}</span></div></div>`);
                      });
                      _push3(`<!--]--></div></div>`);
                    } else {
                      _push3(`<!---->`);
                    }
                    _push3(`<div class="border-t pt-6 mt-8" data-v-c9cd3b5c${_scopeId2}><p class="text-xs text-muted-foreground mb-2" data-v-c9cd3b5c${_scopeId2}>Catatan:</p><ul class="text-xs text-muted-foreground space-y-1" data-v-c9cd3b5c${_scopeId2}><li data-v-c9cd3b5c${_scopeId2}>• Invoice ini sah dan diproses oleh komputer</li><li data-v-c9cd3b5c${_scopeId2}>• Harap simpan invoice ini sebagai bukti pembelian yang sah</li><li data-v-c9cd3b5c${_scopeId2}>• Untuk pertanyaan lebih lanjut, hubungi customer service kami</li></ul></div><div class="text-center mt-8 pt-6 border-t" data-v-c9cd3b5c${_scopeId2}><p class="text-xs text-muted-foreground" data-v-c9cd3b5c${_scopeId2}> Terima kasih atas kepercayaan Anda berbelanja di Puranusa </p><p class="text-xs text-muted-foreground mt-1" data-v-c9cd3b5c${_scopeId2}> www.puranusa.id | CS: cs@puranusa.id | WA: +62 812-3456-7890 </p></div></div>`);
                  } else {
                    _push3(`<!---->`);
                  }
                } else {
                  return [
                    ...
                    loading.value ? (openBlock(), createBlock("div", {
                        ...
                        createVNode("div", { class: "flex items-start justify-between" }, [
                          createVNode("div", null, [
                            createVNode("div", { class: "flex items-center gap-3 mb-2" }, [
                              createVNode("div", { class: "w-12 h-12 bg-primary rounded-lg flex items-center justify-center" }, [
                                createVNode("span", { class: "text-white font-bold text-xl" }, "P")
                              ]),
                              createVNode("div", null, [
                            ...
                            createVNode("div", { class: "text-sm text-muted-foreground mt-3" }, [
                              createVNode("p", null, "Jl. Raya Puranusa No. 123"),
                              createVNode("p", null, "Jakarta Selatan, DKI Jakarta 12345"),
                              createVNode("p", null, "Email: info@puranusa.id"),
                              createVNode("p", null, "Telp: (021) 1234-5678")
                            ])
                          ]),
                      ...
                      createVNode("div", { class: "grid grid-cols-2 gap-8 mb-8" }, [
                        createVNode("div", null, [
                          createVNode("h3", { class: "font-semibold text-sm mb-3 text-muted-foreground" }, "BILL TO:"),
                          createVNode("div", { class: "space-y-1" }, [
                            createVNode("p", { class: "font-semibold" }, toDisplayString(order.value.customer.name), 1),
                            createVNode("p", { class: "text-sm text-muted-foreground" }, toDisplayString(order.value.customer.email), 1),
                            order.value.customer.phone ? (openBlock(), createBlock("p", {
                              key: 0,
                              class: "text-sm text-muted-foreground"
                            }, toDisplayString(order.value.customer.phone), 1)) : createCommentVNode("", true),
                            order.value.billingAddress ? (openBlock(), createBlock("div", {
                              key: 1,
                              class: "text-sm text-muted-foreground mt-2"
                            }, [
                              createVNode("p", null, toDisplayString(order.value.billingAddress.address), 1),
                              createVNode("p", null, toDisplayString(order.value.billingAddress.city) + ", " + toDisplayString(order.value.billingAddress.province), 1),
                              createVNode("p", null, toDisplayString(order.value.billingAddress.postal_code), 1)
                            ])) : createCommentVNode("", true)
                          ])
                        ]),
                        order.value.shippingAddress ? (openBlock(), createBlock("div", { key: 0 }, [
                          createVNode("h3", { class: "font-semibold text-sm mb-3 text-muted-foreground" }, "SHIP TO:"),
                          createVNode("div", { class: "space-y-1" }, [
                            createVNode("p", { class: "font-semibold" }, toDisplayString(order.value.shippingAddress.full_name), 1),
                            createVNode("p", { class: "text-sm text-muted-foreground" }, toDisplayString(order.value.shippingAddress.phone), 1),
                            createVNode("div", { class: "text-sm text-muted-foreground mt-2" }, [
                              createVNode("p", null, toDisplayString(order.value.shippingAddress.address), 1),
                              createVNode("p", null, toDisplayString(order.value.shippingAddress.city) + ", " + toDisplayString(order.value.shippingAddress.province), 1),
                              createVNode("p", null, toDisplayString(order.value.shippingAddress.postal_code), 1)
                            ])
                          ])
                        ])) : createCommentVNode("", true)
                      ]),
                          ...
                          createVNode("tbody", null, [
                            (openBlock(true), createBlock(Fragment, null, renderList(order.value.items, (item, index) => {
                              return openBlock(), createBlock("tr", {
                                ...
                                createVNode("td", { class: "py-3 px-2 text-right" }, toDisplayString(formatCurrency(item.price)), 1),
                                createVNode("td", { class: "py-3 px-2 text-right font-medium" }, toDisplayString(formatCurrency(item.total)), 1)
                              ]);
                            }), 128))
                          ])
                        ])
            ...
            return [
              createVNode(unref(_sfc_main$4), { class: "max-w-4xl max-h-[90vh] overflow-y-auto print:max-w-full print:max-h-full print:overflow-visible" }, {
                default: withCtx(() => [
                  createVNode(unref(_sfc_main$2), null, {
                    default: withCtx(() => [
                      createVNode(unref(_sfc_main$5), null, {
...
const InvoiceDialog = /* @__PURE__ */ _export_sfc(_sfc_main$1, [["__scopeId", "data-v-c9cd3b5c"]]);
