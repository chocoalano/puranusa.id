...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    const typeFilter = ref(props.filters.type?.toString() || "all");
    const perPage = ref(props.filters.per_page);
    const itemToDelete = ref(null);
    const isDeleting = ref(false);
    const applyFilters = () => {
      router.get("/admin/zenner/leaderboard-configs", {
    ...
    const confirmDelete = () => {
      ...
      useForm({}).delete(`/admin/zenner/leaderboard-configs/${itemToDelete.value}`, {
        preserveScroll: true,
        onSuccess: () => {
    ...
    const goToPage = (page) => {
      router.get("/admin/zenner/leaderboard-configs", { page, search: search.value || void 0, status: status.value !== "all" ? status.value : void 0, type: typeFilter.value !== "all" ? typeFilter.value : void 0, per_page: perPage.value }, { preserveState: true, preserveScroll: true });
    };
    return (_ctx, _push, _parent, _attrs) => {
      _push(ssrRenderComponent(_sfc_main$1, _attrs, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<div class="container mx-auto py-6 space-y-6"${_scopeId}><div class="flex items-center justify-between"${_scopeId}><div${_scopeId}><h1 class="text-3xl font-bold tracking-tight"${_scopeId}>Leaderboard Config</h1><p class="text-muted-foreground"${_scopeId}>Kelola konfigurasi leaderboard</p></div>`);
            _push2(ssrRenderComponent(unref(_sfc_main$2), { "as-child": "" }, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(ssrRenderComponent(unref(Link), { href: "/admin/zenner/leaderboard-configs/create" }, {
                    default: withCtx((_3, _push4, _parent4, _scopeId3) => {
                      if (_push4) {
                        _push4(ssrRenderComponent(unref(Plus), { class: "mr-2 h-4 w-4" }, null, _parent4, _scopeId3));
                        _push4(`Tambah Config`);
                      } else {
                        return [
                          createVNode(unref(Plus), { class: "mr-2 h-4 w-4" }),
                          createTextVNode("Tambah Config")
                        ];
                      }
                    }),
                    _: 1
                  ...
                  return [
                    createVNode(unref(Link), { href: "/admin/zenner/leaderboard-configs/create" }, {
                      default: withCtx(() => [
                        createVNode(unref(Plus), { class: "mr-2 h-4 w-4" }),
                        createTextVNode("Tambah Config")
                      ]),
                    ...
                    default: withCtx((_3, _push4, _parent4, _scopeId3) => {
                      if (_push4) {
                        ...
                        _push4(ssrRenderComponent(unref(_sfc_main$6), {
                          ...
                          "onUpdate:modelValue": [($event) => typeFilter.value = $event, applyFilters]
                        }, {
                            ...
                            if (_push5) {
                              _push5(ssrRenderComponent(unref(_sfc_main$7), { class: "w-[160px]" }, {
                                default: withCtx((_5, _push6, _parent6, _scopeId5) => {
                                  if (_push6) {
                                    _push6(ssrRenderComponent(unref(_sfc_main$8), { placeholder: "Tipe" }, null, _parent6, _scopeId5));
                                  } else {
                                    return [
                                      createVNode(unref(_sfc_main$8), { placeholder: "Tipe" })
                                    ];
                                  }
                                }),
                                _: 1
                              ...
                              _push5(ssrRenderComponent(unref(_sfc_main$9), null, {
                                default: withCtx((_5, _push6, _parent6, _scopeId5) => {
                                  if (_push6) {
                                    ...
                                    _push6(ssrRenderComponent(unref(_sfc_main$a), { value: "sales" }, {
                                      default: withCtx((_6, _push7, _parent7, _scopeId6) => {
                                        if (_push7) {
                                          _push7(`Sales`);
                                        } else {
                                    ...
                                    _push6(ssrRenderComponent(unref(_sfc_main$a), { value: "recruitment" }, {
                                      default: withCtx((_6, _push7, _parent7, _scopeId6) => {
                                        if (_push7) {
                                          _push7(`Recruitment`);
                                        } else {
                                    ...
                                    _push6(ssrRenderComponent(unref(_sfc_main$a), { value: "performance" }, {
                                      default: withCtx((_6, _push7, _parent7, _scopeId6) => {
                                        if (_push7) {
                                          _push7(`Performance`);
                                        } else {
                                    ...
                                    return [
                                      ...
                                      createVNode(unref(_sfc_main$a), { value: "sales" }, {
                                        default: withCtx(() => [
                                          createTextVNode("Sales")
                                        ]),
                                        _: 1
                                      }),
                                      createVNode(unref(_sfc_main$a), { value: "recruitment" }, {
                                        default: withCtx(() => [
                                          createTextVNode("Recruitment")
                                        ]),
                                        _: 1
                                      }),
                                      createVNode(unref(_sfc_main$a), { value: "performance" }, {
                                        default: withCtx(() => [
                                          createTextVNode("Performance")
                                        ]),
                                        _: 1
                                          ...
                                          default: withCtx((_6, _push7, _parent7, _scopeId6) => {
                                            if (_push7) {
                                                  ...
                                                  if (_push8) {
                                                    _push8(ssrRenderComponent(unref(_sfc_main$i), { variant: "outline" }, {
                                                      default: withCtx((_8, _push9, _parent9, _scopeId8) => {
                                                        if (_push9) {
                                                          _push9(`${ssrInterpolate(item.type)}`);
                                                        } else {
                                                          return [
                                              ...
                                              _push7(ssrRenderComponent(unref(_sfc_main$h), null, {
                                                default: withCtx((_7, _push8, _parent8, _scopeId7) => {
                                                  if (_push8) {
                                                    _push8(`${ssrInterpolate(item.period)}`);
                                                  } else {
                                                    return [
                                              ...
                                              _push7(ssrRenderComponent(unref(_sfc_main$h), null, {
                                                default: withCtx((_7, _push8, _parent8, _scopeId7) => {
                                                  if (_push8) {
                                                    _push8(`${ssrInterpolate(item.entries_count || 0)}`);
                                                  } else {
                                                    return [
                                                      createTextVNode(toDisplayString(item.entries_count || 0), 1)
                                                    ];
                                                  }
                                                }),
                                                _: 2
                                                  ...
                                                  if (_push8) {
                                                      ...
                                                      default: withCtx((_8, _push9, _parent9, _scopeId8) => {
                                                        if (_push9) {
                                                          _push9(ssrRenderComponent(unref(Link), {
                                                            href: `/admin/zenner/leaderboard-configs/${item.id}`
                                                          }, {
                                                    ...
                                                    _push8(ssrRenderComponent(unref(_sfc_main$2), {
                                                      ...
                                                      default: withCtx((_8, _push9, _parent9, _scopeId8) => {
                                                        if (_push9) {
                                                          _push9(ssrRenderComponent(unref(Link), {
                                                            href: `/admin/zenner/leaderboard-configs/${item.id}/edit`
                                                          }, {
                                                            default: withCtx((_9, _push10, _parent10, _scopeId9) => {
                                                              if (_push10) {
                          ...
                          default: withCtx((_4, _push5, _parent5, _scopeId4) => {
                            if (_push5) {
                              ...
                              _push5(ssrRenderComponent(unref(_sfc_main$n), null, {
                                default: withCtx((_5, _push6, _parent6, _scopeId5) => {
                                  if (_push6) {
                                    _push6(`Semua entries terkait juga akan dihapus. Lanjutkan?`);
                                  } else {
                                    return [
                                      createTextVNode("Semua entries terkait juga akan dihapus. Lanjutkan?")
                                    ];
                                  }
                                }),
                                _: 1
              ...
              createVNode("div", { class: "container mx-auto py-6 space-y-6" }, [
                createVNode("div", { class: "flex items-center justify-between" }, [
                  createVNode("div", null, [
                    createVNode("h1", { class: "text-3xl font-bold tracking-tight" }, "Leaderboard Config"),
                    createVNode("p", { class: "text-muted-foreground" }, "Kelola konfigurasi leaderboard")
                  ]),
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("resources/js/pages/Admin/Zenner/LeaderboardConfig/Index.vue");
