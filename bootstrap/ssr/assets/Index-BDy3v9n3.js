import { defineComponent, mergeProps, unref, withCtx, createVNode, createTextVNode, createBlock, createCommentVNode, openBlock, useSSRContext, toDisplayString, Fragment, renderList, ref } from "vue";
import { ssrRenderAttrs, ssrInterpolate, ssrRenderComponent, ssrRenderList, ssrRenderAttr } from "vue/server-renderer";
import { _ as _sfc_main$h } from "./AppLayout-DTAmF_5Z.js";
import { Link, Head, router } from "@inertiajs/vue3";
import { _ as _sfc_main$4 } from "./index-SN_CnQ_F.js";
import { Plus, Search, ImageIcon, MoreHorizontal } from "lucide-vue-next";
        ...
        _push(ssrRenderComponent(unref(Link), { href: "/admin/categories/create" }, {
          default: withCtx((_, _push2, _parent2, _scopeId) => {
            if (_push2) {
              ...
              return [
                unref(isSuperAdmin) || unref(isAdmin) ? (openBlock(), createBlock(unref(_sfc_main$4), { key: 0 }, {
                  default: withCtx(() => [
                    createVNode(unref(Plus), { class: "mr-2 h-4 w-4" }),
                    createTextVNode(" Tambah Kategori ")
                  ]),
                ...
                if (_push3) {
                  _push3(ssrRenderComponent(unref(_sfc_main$8), null, {
                    default: withCtx((_3, _push4, _parent4, _scopeId3) => {
                      if (_push4) {
                        _push4(ssrRenderComponent(unref(_sfc_main$9), { class: "w-[60px]" }, {
                        ...
                        return [
                          createVNode(unref(_sfc_main$9), { class: "w-[60px]" }, {
                            default: withCtx(() => [
                              createTextVNode("Gambar")
                            ]),
                            _: 1
                      ...
                      default: withCtx((_3, _push4, _parent4, _scopeId3) => {
                        if (_push4) {
                          _push4(ssrRenderComponent(unref(_sfc_main$b), null, {
                            default: withCtx((_4, _push5, _parent5, _scopeId4) => {
                              if (_push5) {
                                _push5(`<div class="w-10 h-10 rounded-md border overflow-hidden bg-muted flex items-center justify-center"${_scopeId4}>`);
                                if (category.image) {
                                  _push5(`<img${ssrRenderAttr("src", getImageUrl(category.image))}${ssrRenderAttr("alt", category.name)} class="w-full h-full object-cover"${_scopeId4}>`);
                                } else {
                                  _push5(ssrRenderComponent(unref(ImageIcon), { class: "w-5 h-5 text-muted-foreground" }, null, _parent5, _scopeId4));
                                }
                                _push5(`</div>`);
                              } else {
                                return [
                                  createVNode("div", { class: "w-10 h-10 rounded-md border overflow-hidden bg-muted flex items-center justify-center" }, [
                                        ...
                                        default: withCtx((_6, _push7, _parent7, _scopeId6) => {
                                          if (_push7) {
                                            ...
                                            return [
                                              ...
                                              unref(isSuperAdmin) || unref(isAdmin) ? (openBlock(), createBlock(unref(_sfc_main$g), {
                                                key: 1,
                                                onClick: ($event) => emit("delete", category.id),
                                                class: "text-destructive"
                                              }, {
