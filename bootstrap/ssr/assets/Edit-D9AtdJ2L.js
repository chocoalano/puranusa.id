...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    const submit = () => {
      form.put(`/admin/zenner/marketing-kits/${props.item.id}`, {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      _push(ssrRenderComponent(_sfc_main$1, _attrs, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<div class="container mx-auto py-6 space-y-6"${_scopeId}><h1 class="text-3xl font-bold tracking-tight"${_scopeId}>Edit Marketing Kit</h1>`);
                  ...
                  _push3(ssrRenderComponent(unref(_sfc_main$3), { class: "pt-6" }, {
                    default: withCtx((_3, _push4, _parent4, _scopeId3) => {
                      if (_push4) {
                        ...
                        _push4(`</div><div${_scopeId3}><label class="block text-sm font-medium mb-1"${_scopeId3}>File Path</label>`);
                        _push4(ssrRenderComponent(unref(_sfc_main$4), {
                          modelValue: unref(form).file_path,
                          "onUpdate:modelValue": ($event) => unref(form).file_path = $event
                        }, null, _parent4, _scopeId3));
                        if (unref(form).errors.file_path) {
                          _push4(`<p class="text-sm text-destructive mt-1"${_scopeId3}>${ssrInterpolate(unref(form).errors.file_path)}</p>`);
                        } else {
                          _push4(`<!---->`);
                        }
                        _push4(`</div><div${_scopeId3}><label class="block text-sm font-medium mb-1"${_scopeId3}>Tipe File</label>`);
                        _push4(ssrRenderComponent(unref(_sfc_main$5), {
                          modelValue: unref(form).file_type,
                          "onUpdate:modelValue": ($event) => unref(form).file_type = $event
                        }, {
                            ...
                            if (_push5) {
                              _push5(ssrRenderComponent(unref(_sfc_main$6), null, {
                                default: withCtx((_5, _push6, _parent6, _scopeId5) => {
                                  if (_push6) {
                                    _push6(ssrRenderComponent(unref(_sfc_main$7), { placeholder: "Pilih tipe file" }, null, _parent6, _scopeId5));
                                  } else {
                                    return [
                                      createVNode(unref(_sfc_main$7), { placeholder: "Pilih tipe file" })
                                    ];
                                  }
                                }),
                                _: 1
                              ...
                              _push5(ssrRenderComponent(unref(_sfc_main$8), null, {
                                default: withCtx((_5, _push6, _parent6, _scopeId5) => {
                                  if (_push6) {
                                    _push6(ssrRenderComponent(unref(_sfc_main$9), { value: "image" }, {
                                    ...
                                    _push6(ssrRenderComponent(unref(_sfc_main$9), { value: "video" }, {
                                      default: withCtx((_6, _push7, _parent7, _scopeId6) => {
                                        if (_push7) {
                                          _push7(`Video`);
                                        } else {
                                    ...
                                    _push6(ssrRenderComponent(unref(_sfc_main$9), { value: "pdf" }, {
                                      default: withCtx((_6, _push7, _parent7, _scopeId6) => {
                                        if (_push7) {
                                          _push7(`PDF`);
                                        } else {
                                    ...
                                    _push6(ssrRenderComponent(unref(_sfc_main$9), { value: "document" }, {
                                      default: withCtx((_6, _push7, _parent7, _scopeId6) => {
                                        if (_push7) {
                                          _push7(`Document`);
                                        } else {
                                    ...
                                    return [
                                      createVNode(unref(_sfc_main$9), { value: "image" }, {
                                        default: withCtx(() => [
                                          createTextVNode("Image")
                                        ]),
                                        _: 1
                                      }),
                                      createVNode(unref(_sfc_main$9), { value: "video" }, {
                                        default: withCtx(() => [
                                          createTextVNode("Video")
                                        ]),
                                        _: 1
                                      }),
                                      createVNode(unref(_sfc_main$9), { value: "pdf" }, {
                                        default: withCtx(() => [
                                          createTextVNode("PDF")
                                        ]),
                                        _: 1
                                      }),
                                      createVNode(unref(_sfc_main$9), { value: "document" }, {
                                        default: withCtx(() => [
                                          createTextVNode("Document")
                                        ]),
                                        _: 1
                        ...
                        if (unref(form).errors.file_type) {
                          _push4(`<p class="text-sm text-destructive mt-1"${_scopeId3}>${ssrInterpolate(unref(form).errors.file_type)}</p>`);
                        } else {
                          _push4(`<!---->`);
                        }
                        _push4(`</div><div${_scopeId3}><label class="block text-sm font-medium mb-1"${_scopeId3}>Thumbnail</label>`);
                        _push4(ssrRenderComponent(unref(_sfc_main$4), {
                        ...
                        _push4(ssrRenderComponent(unref(_sfc_main$a), {
                          ...
                          default: withCtx((_4, _push5, _parent5, _scopeId4) => {
                            if (_push5) {
                              _push5(ssrRenderComponent(unref(Link), { href: "/admin/zenner/marketing-kits" }, {
                                default: withCtx((_5, _push6, _parent6, _scopeId5) => {
                                  if (_push6) {
                                    _push6(`Batal`);
                                  } else {
                              ...
                              return [
                                createVNode(unref(Link), { href: "/admin/zenner/marketing-kits" }, {
                                  default: withCtx(() => [
                                    createTextVNode("Batal")
                                  ]),
                                  _: 1
                        ...
                        return [
                          createVNode("form", {
                            ...
                            createVNode("div", null, [
                              createVNode("label", { class: "block text-sm font-medium mb-1" }, "File Path"),
                              createVNode(unref(_sfc_main$4), {
                                modelValue: unref(form).file_path,
                                "onUpdate:modelValue": ($event) => unref(form).file_path = $event
                              }, null, 8, ["modelValue", "onUpdate:modelValue"]),
                              unref(form).errors.file_path ? (openBlock(), createBlock("p", {
                                key: 0,
                                class: "text-sm text-destructive mt-1"
                              }, toDisplayString(unref(form).errors.file_path), 1)) : createCommentVNode("", true)
                            ]),
                            createVNode("div", null, [
                              createVNode("label", { class: "block text-sm font-medium mb-1" }, "Tipe File"),
                              ...
                              unref(form).errors.file_type ? (openBlock(), createBlock("p", {
                                key: 0,
                                class: "text-sm text-destructive mt-1"
                              }, toDisplayString(unref(form).errors.file_type), 1)) : createCommentVNode("", true)
                            ]),
                            createVNode("div", null, [
                              createVNode("label", { class: "block text-sm font-medium mb-1" }, "Thumbnail"),
                              createVNode(unref(_sfc_main$4), {
                                modelValue: unref(form).thumbnail,
                                "onUpdate:modelValue": ($event) => unref(form).thumbnail = $event
                              }, null, 8, ["modelValue", "onUpdate:modelValue"]),
            ...
            return [
              createVNode("div", { class: "container mx-auto py-6 space-y-6" }, [
                createVNode("h1", { class: "text-3xl font-bold tracking-tight" }, "Edit Marketing Kit"),
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("resources/js/pages/Admin/Zenner/MarketingKit/Edit.vue");
