import { defineComponent, ref, watch, withCtx, unref, createVNode, createTextVNode, toDisplayString, createBlock, createCommentVNode, openBlock, withKeys, Fragment, renderList, useSSRContext } from "vue";
import { ssrRenderComponent, ssrInterpolate, ssrRenderList } from "vue/server-renderer";
import { router } from "@inertiajs/vue3";
import { _ as _sfc_main$1 } from "./AppLayout-Cw9UyDBf.js";
import { _ as _sfc_main$j } from "./PageBuilder-CivrpB3x.js";
import { _ as _sfc_main$c, a as _sfc_main$d, b as _sfc_main$e, d as _sfc_main$f, c as _sfc_main$g } from "./CardTitle-sqUG0LTw.js";
import { _ as _sfc_main$2 } from "./index-SN_CnQ_F.js";
import { _ as _sfc_main$i } from "./Input-BGi8wCMh.js";
import { _ as _sfc_main$h } from "./Label-16aMY2sx.js";
...
import { _ as _sfc_main$3, a as _sfc_main$4, b as _sfc_main$5, c as _sfc_main$6, d as _sfc_main$7, e as _sfc_main$8, f as _sfc_main$9, g as _sfc_main$a, h as _sfc_main$b } from "./AlertDialogTrigger-DIWb7xue.js";
...
import "./DialogTrigger-DV-5YM1v.js";
import "clsx";
            ...
            _push2(ssrRenderComponent(unref(_sfc_main$c), null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  ...
                  _push3(ssrRenderComponent(unref(_sfc_main$g), { class: "space-y-4" }, {
                    default: withCtx((_3, _push4, _parent4, _scopeId3) => {
                      if (_push4) {
                        _push4(`<div class="space-y-2"${_scopeId3}>`);
                        _push4(ssrRenderComponent(unref(_sfc_main$h), { for: "title" }, {
                          default: withCtx((_4, _push5, _parent5, _scopeId4) => {
                            if (_push5) {
                        ...
                        _push4(ssrRenderComponent(unref(_sfc_main$h), { for: "slug" }, {
                          default: withCtx((_4, _push5, _parent5, _scopeId4) => {
                            if (_push5) {
                              _push5(`Slug (URL)`);
                            } else {
                        ...
                        return [
                          createVNode("div", { class: "space-y-2" }, [
                            createVNode(unref(_sfc_main$h), { for: "title" }, {
                              default: withCtx(() => [
                                createTextVNode("Judul Artikel")
                              ]),
                              _: 1
                          ...
                          createVNode("div", { class: "space-y-2" }, [
                            createVNode(unref(_sfc_main$h), { for: "slug" }, {
                              default: withCtx(() => [
                                createTextVNode("Slug (URL)")
                              ]),
                              _: 1
                  ...
                  return [
                    ...
                    createVNode(unref(_sfc_main$g), { class: "space-y-4" }, {
                      default: withCtx(() => [
                        createVNode("div", { class: "space-y-2" }, [
                          createVNode(unref(_sfc_main$h), { for: "title" }, {
                            default: withCtx(() => [
                ...
                if (_push3) {
                  ...
                  _push3(ssrRenderComponent(unref(_sfc_main$g), { class: "space-y-4" }, {
                    default: withCtx((_3, _push4, _parent4, _scopeId3) => {
                      if (_push4) {
                        _push4(`<div class="space-y-2"${_scopeId3}>`);
                        _push4(ssrRenderComponent(unref(_sfc_main$h), { for: "seo_title" }, {
                          default: withCtx((_4, _push5, _parent5, _scopeId4) => {
                            if (_push5) {
                              _push5(`Judul SEO`);
                            } else {
                        ...
                        _push4(ssrRenderComponent(unref(_sfc_main$h), { for: "seo_description" }, {
                          default: withCtx((_4, _push5, _parent5, _scopeId4) => {
                            if (_push5) {
                        ...
                        return [
                          createVNode("div", { class: "space-y-2" }, [
                            createVNode(unref(_sfc_main$h), { for: "seo_title" }, {
                              default: withCtx(() => [
                                createTextVNode("Judul SEO")
                              ]),
                              _: 1
                          ...
                          createVNode("div", { class: "space-y-2" }, [
                            createVNode(unref(_sfc_main$h), { for: "seo_description" }, {
                              default: withCtx(() => [
                                createTextVNode("Deskripsi SEO")
                              ]),
                              _: 1
                  ...
                  _push3(ssrRenderComponent(unref(_sfc_main$g), { class: "space-y-4" }, {
                    default: withCtx((_3, _push4, _parent4, _scopeId3) => {
                      if (_push4) {
                        ...
                        if (form.value.is_published) {
                          _push4(`<div class="space-y-2"${_scopeId3}>`);
                          _push4(ssrRenderComponent(unref(_sfc_main$h), { for: "published_at" }, {
                            default: withCtx((_4, _push5, _parent5, _scopeId4) => {
                              if (_push5) {
                        ...
                        return [
                          ...
                          form.value.is_published ? (openBlock(), createBlock("div", {
                            ...
                            createVNode(unref(_sfc_main$h), { for: "published_at" }, {
                              default: withCtx(() => [
                                createTextVNode("Tanggal Terbit")
                              ]),
                              _: 1
              ...
              createVNode("div", { class: "container mx-auto py-6 space-y-6" }, [
                createVNode("div", { class: "flex items-center justify-between" }, [
                  ...
                  createVNode("div", { class: "flex gap-2" }, [
                    ...
                    form.value.is_published ? (openBlock(), createBlock(unref(_sfc_main$2), {
                      key: 0,
                      variant: "outline",
                      disabled: processing.value,
                      onClick: ($event) => submitForm(false)
