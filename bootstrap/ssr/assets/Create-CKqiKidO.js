import { defineComponent, ref, watch, computed, unref, withCtx, createVNode, createTextVNode, toDisplayString, createBlock, openBlock, Fragment, renderList, createCommentVNode, withModifiers, useSSRContext } from "vue";
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      _push(`<!--[-->`);
      _push(ssrRenderComponent(unref(Head), { title: "Tambah Kategori" }, null, _parent));
      _push(ssrRenderComponent(_sfc_main$1, null, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            ...
            _push2(`<div${_scopeId}><h1 class="text-3xl font-bold"${_scopeId}>Tambah Kategori</h1><p class="text-muted-foreground"${_scopeId}>Buat kategori baru untuk Zenner Club</p></div></div><form class="space-y-6"${_scopeId}>`);
                    ...
                    default: withCtx((_3, _push4, _parent4, _scopeId3) => {
                      if (_push4) {
                        ...
                        _push4(ssrRenderComponent(unref(_sfc_main$6), null, {
                          default: withCtx((_4, _push5, _parent5, _scopeId4) => {
                            if (_push5) {
                              _push5(`Lengkapi data kategori`);
                            } else {
                              return [
                                createTextVNode("Lengkapi data kategori")
                              ];
                            }
                          }),
                          _: 1
            ...
            _push2(ssrRenderComponent(unref(_sfc_main$2), {
              ...
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  ...
                  _push3(` ${ssrInterpolate(unref(form).processing ? "Menyimpan..." : "Simpan Kategori")}`);
                } else {
                  return [
                    createVNode(unref(Save), { class: "mr-2 h-4 w-4" }),
                    createTextVNode(" " + toDisplayString(unref(form).processing ? "Menyimpan..." : "Simpan Kategori"), 1)
                  ];
                }
              }),
              _: 1
              ...
              createVNode("div", { class: "container mx-auto py-6 space-y-6" }, [
                createVNode("div", { class: "flex items-center gap-4" }, [
                  ...
                  createVNode("div", null, [
                    createVNode("h1", { class: "text-3xl font-bold" }, "Tambah Kategori"),
                    createVNode("p", { class: "text-muted-foreground" }, "Buat kategori baru untuk Zenner Club")
                  ])
                ]),
                createVNode("form", {
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("resources/js/pages/Admin/ZennerClub/Categories/Create.vue");
