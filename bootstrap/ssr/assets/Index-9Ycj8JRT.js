...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    const applyFilters = () => {
      router.get("/admin/zenner/product-knowledges", {
    ...
    const handleDelete = () => {
      if (deleteId.value) {
        useForm({}).delete(`/admin/zenner/product-knowledges/${deleteId.value}`, {
          preserveScroll: true,
          onSuccess: () => toast.success("Product Knowledge berhasil dihapus")
        });
      }
                ...
                if (_push3) {
                  _push3(ssrRenderComponent(unref(_sfc_main$3), null, {
                    default: withCtx((_3, _push4, _parent4, _scopeId3) => {
                      if (_push4) {
                        _push4(`<div class="flex items-center justify-between"${_scopeId3}><h2 class="text-xl font-semibold"${_scopeId3}>Product Knowledge</h2>`);
                        _push4(ssrRenderComponent(unref(_sfc_main$4), {
                          onClick: ($event) => unref(router).visit("/admin/zenner/product-knowledges/create")
                        }, {
                        ...
                        return [
                          createVNode("div", { class: "flex items-center justify-between" }, [
                            createVNode("h2", { class: "text-xl font-semibold" }, "Product Knowledge"),
                                              ...
                                              default: withCtx((_7, _push8, _parent8, _scopeId7) => {
                                                if (_push8) {
                                                  _push8(ssrRenderComponent(unref(_sfc_main$4), {
                                                    variant: "ghost",
                                                    size: "icon",
                                                    onClick: ($event) => unref(router).visit(`/admin/zenner/product-knowledges/${item.id}/edit`)
                                                  }, {
                                                    default: withCtx((_8, _push9, _parent9, _scopeId8) => {
                                                      if (_push9) {
                          ...
                          default: withCtx((_4, _push5, _parent5, _scopeId4) => {
                            if (_push5) {
                              _push5(ssrRenderComponent(unref(_sfc_main$m), null, {
                                default: withCtx((_5, _push6, _parent6, _scopeId5) => {
                                  if (_push6) {
                                    _push6(`Hapus Product Knowledge?`);
                                  } else {
                                    return [
                                      createTextVNode("Hapus Product Knowledge?")
                                    ];
                                  }
                                }),
                                _: 1
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("resources/js/pages/Admin/Zenner/ProductKnowledge/Index.vue");
