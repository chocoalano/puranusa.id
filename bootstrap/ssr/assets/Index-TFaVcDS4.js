  ...
  setup(__props) {
    ...
    const applyFilters = () => {
      router.get("/admin/zenner/ads-guides", {
        ...
        platform: platform.value || void 0
                ...
                if (_push3) {
                  _push3(ssrRenderComponent(unref(_sfc_main$3), null, {
                    default: withCtx((_3, _push4, _parent4, _scopeId3) => {
                      if (_push4) {
                        _push4(`<div class="flex items-center justify-between"${_scopeId3}><h2 class="text-xl font-semibold"${_scopeId3}>Ads Guide</h2>`);
                        _push4(ssrRenderComponent(unref(_sfc_main$4), {
                          onClick: ($event) => unref(router).visit("/admin/zenner/ads-guides/create")
                        }, {
                        ...
                        return [
                          createVNode("div", { class: "flex items-center justify-between" }, [
                            createVNode("h2", { class: "text-xl font-semibold" }, "Ads Guide"),
                    ...
                    default: withCtx((_3, _push4, _parent4, _scopeId3) => {
                      if (_push4) {
                        ...
                        _push4(ssrRenderComponent(unref(_sfc_main$7), {
                          ...
                          "onUpdate:modelValue": [($event) => platform.value = $event, applyFilters]
                        }, {
                          default: withCtx((_4, _push5, _parent5, _scopeId4) => {
                            if (_push5) {
                              _push5(ssrRenderComponent(unref(_sfc_main$8), { class: "w-48" }, {
                                default: withCtx((_5, _push6, _parent6, _scopeId5) => {
                                  if (_push6) {
                                    _push6(ssrRenderComponent(unref(_sfc_main$9), { placeholder: "Semua Platform" }, null, _parent6, _scopeId5));
                                  } else {
                                    return [
                                      createVNode(unref(_sfc_main$9), { placeholder: "Semua Platform" })
                                    ];
                                  }
                                }),
                                _: 1
                                  ...
                                  if (_push6) {
                                    _push6(ssrRenderComponent(unref(_sfc_main$b), { value: "" }, {
                                      default: withCtx((_6, _push7, _parent7, _scopeId6) => {
                                        if (_push7) {
                                          _push7(`Semua Platform`);
                                        } else {
                                          return [
                                            createTextVNode("Semua Platform")
                                          ];
                                        }
                                      }),
                                      _: 1
                                    ...
                                    _push6(`<!--[-->`);
                                    ssrRenderList(__props.platforms, (p) => {
                                    ...
                                    return [
                                      ...
                                      (openBlock(true), createBlock(Fragment, null, renderList(__props.platforms, (p) => {
                                        ...
                                        default: withCtx((_6, _push7, _parent7, _scopeId6) => {
                                          if (_push7) {
                                            ...
                                            _push7(ssrRenderComponent(unref(_sfc_main$h), null, {
                                              default: withCtx((_7, _push8, _parent8, _scopeId7) => {
                                                if (_push8) {
                                                  _push8(`${ssrInterpolate(item.platform)}`);
                                                } else {
                                                  return [
                                                    createTextVNode(toDisplayString(item.platform), 1)
                                                  ];
                                                }
                                              }),
                                              _: 2
                                            ...
                                            _push7(ssrRenderComponent(unref(_sfc_main$h), null, {
                                              default: withCtx((_7, _push8, _parent8, _scopeId7) => {
                                                if (_push8) {
                                                  _push8(`${ssrInterpolate(item.budget_range)}`);
                                                } else {
                                                  return [
                                                    createTextVNode(toDisplayString(item.budget_range), 1)
                                                  ];
                                                }
                                              }),
                                              _: 2
                                              ...
                                              default: withCtx((_7, _push8, _parent8, _scopeId7) => {
                                                if (_push8) {
                                                  _push8(ssrRenderComponent(unref(_sfc_main$4), {
                                                    variant: "ghost",
                                                    size: "icon",
                                                    onClick: ($event) => unref(router).visit(`/admin/zenner/ads-guides/${item.id}/edit`)
                                                  }, {
                                                    default: withCtx((_8, _push9, _parent9, _scopeId8) => {
                                                      if (_push9) {
                          ...
                          default: withCtx((_4, _push5, _parent5, _scopeId4) => {
                            if (_push5) {
                              _push5(ssrRenderComponent(unref(_sfc_main$m), null, {
                                default: withCtx((_5, _push6, _parent6, _scopeId5) => {
                                  if (_push6) {
                                    _push6(`Hapus Ads Guide?`);
                                  } else {
                                    return [
                                      createTextVNode("Hapus Ads Guide?")
                                    ];
                                  }
                                }),
                                _: 1
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("resources/js/pages/Admin/Zenner/AdsGuide/Index.vue");
