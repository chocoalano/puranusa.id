...
import { ag as index, aj as show, _ as _sfc_main$8, ah as create, ak as destroy, al as release, am as massRelease } from "./AppLayout-B9pGpPI9.js";
      ...
      _push(ssrRenderComponent(_sfc_main$8, { breadcrumbs: breadcrumbItems }, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            ...
            _push2(`</div>`);
            if (selectedPendingBonuses.value.length > 0 && (unref(isSuperAdmin) || unref(isAdmin))) {
            ...
            return [
              ...
              createVNode("div", { class: "rounded-xl p-4 space-y-6 py-6" }, [
                ...
                selectedPendingBonuses.value.length > 0 && (unref(isSuperAdmin) || unref(isAdmin)) ? (openBlock(), createBlock("div", {
                  key: 0,
