...
import { a8 as index, _ as _sfc_main$8, a9 as destroy, aa as release, ab as massRelease } from "./AppLayout-DTAmF_5Z.js";
...
import { MoreHorizontal, Wallet, Trash2, ShoppingCart, Plus, DollarSign, Receipt, Search, CheckCircle, XCircle, ArrowUpDown } from "lucide-vue-next";
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    const breadcrumbItems = [
      { title: "Bonus Retail", href: index.url() }
    ];
    ...
    const columns = [
      ...
      },
      {
        ...
        cell: ({ row }) => h("div", [
          ...
          h("div", { class: "text-xs text-muted-foreground" }, row.original.from_member_ewallet_id)
        ])
      },
      {
        accessorKey: "retail_value",
        header: () => h("div", { class: "text-right" }, "Nilai Retail"),
        cell: ({ row }) => h("div", { class: "text-right text-muted-foreground" }, formatCurrency(row.original.retail_value))
      },
      {
        accessorKey: "amount",
    ...
    return (_ctx, _push, _parent, _attrs) => {
                    ...
                    default: withCtx((_2, _push4, _parent4, _scopeId3) => {
                      if (_push4) {
                        ...
                        return [
                          ...
                          createVNode(unref(_sfc_main$6)),
                          unref(isSuperAdmin) || unref(isAdmin) ? (openBlock(), createBlock(unref(_sfc_main$7), {
                            key: 1,
                            class: "text-destructive",
                            onClick: onDelete
                          }, {
      ...
      _push(ssrRenderComponent(_sfc_main$8, { breadcrumbs: breadcrumbItems }, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(ssrRenderComponent(unref(Head), { title: "Bonus Retail" }, null, _parent2, _scopeId));
            ...
            _push2(ssrRenderComponent(unref(ShoppingCart), { class: "h-8 w-8" }, null, _parent2, _scopeId));
            _push2(` Bonus Retail </h1><p class="text-muted-foreground"${_scopeId}>Kelola bonus retail dari penjualan member</p></div>`);
            if (unref(isSuperAdmin) || unref(isAdmin)) {
              _push2(ssrRenderComponent(unref(_sfc_main$3), {
                onClick: ($event) => unref(router).visit("/bonus/retail/create")
              }, {
            ...
            return [
              createVNode(unref(Head), { title: "Bonus Retail" }),
                ...
                createVNode("div", { class: "flex items-center justify-between" }, [
                  createVNode("div", null, [
                    createVNode("h1", { class: "text-3xl font-bold tracking-tight flex items-center gap-2" }, [
                      createVNode(unref(ShoppingCart), { class: "h-8 w-8" }),
                      createTextVNode(" Bonus Retail ")
                    ]),
                    createVNode("p", { class: "text-muted-foreground" }, "Kelola bonus retail dari penjualan member")
                  ]),
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("resources/js/pages/bonus/retail/Index.vue");
