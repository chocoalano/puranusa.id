...
import { Package, DollarSign, Search, ChevronDown, ArrowUpDown, Eye } from "lucide-vue-next";
    ...
    return (_ctx, _push, _parent, _attrs) => {
      _push(ssrRenderComponent(_sfc_main$1, mergeProps({ breadcrumbs: breadcrumbItems }, _attrs), {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(ssrRenderComponent(unref(Head), { title: "Pesanan Pending" }, null, _parent2, _scopeId));
            _push2(`<div class="rounded-xl p-4 space-y-6 py-6"${_scopeId}><div class="flex items-center justify-between"${_scopeId}><div${_scopeId}><h1 class="text-3xl font-bold tracking-tight"${_scopeId}>Pesanan Pending</h1><p class="text-muted-foreground"${_scopeId}>Kelola pesanan yang menunggu pembayaran</p></div></div><div class="grid gap-4 md:grid-cols-2"${_scopeId}>`);
              ...
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  ...
                  _push3(ssrRenderComponent(unref(_sfc_main$5), null, {
                    default: withCtx((_3, _push4, _parent4, _scopeId3) => {
                      if (_push4) {
                        _push4(`<div class="text-2xl font-bold"${_scopeId3}>${ssrInterpolate(__props.statistics.total_pending)}</div><p class="text-xs text-muted-foreground"${_scopeId3}>Pesanan menunggu pembayaran</p>`);
                      } else {
                        return [
                          createVNode("div", { class: "text-2xl font-bold" }, toDisplayString(__props.statistics.total_pending), 1),
                          createVNode("p", { class: "text-xs text-muted-foreground" }, "Pesanan menunggu pembayaran")
                        ];
                      }
                    }),
                    _: 1
              ...
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  ...
                  _push3(ssrRenderComponent(unref(_sfc_main$5), null, {
                    default: withCtx((_3, _push4, _parent4, _scopeId3) => {
                      if (_push4) {
                        _push4(`<div class="text-2xl font-bold"${_scopeId3}>${ssrInterpolate(formatCurrency(__props.statistics.total_amount))}</div><p class="text-xs text-muted-foreground"${_scopeId3}>Total nilai pending</p>`);
                      } else {
                        return [
                          createVNode("div", { class: "text-2xl font-bold" }, toDisplayString(formatCurrency(__props.statistics.total_amount)), 1),
                          createVNode("p", { class: "text-xs text-muted-foreground" }, "Total nilai pending")
                        ];
                      }
                    }),
                    _: 1
            ...
            return [
              createVNode(unref(Head), { title: "Pesanan Pending" }),
              createVNode("div", { class: "rounded-xl p-4 space-y-6 py-6" }, [
                createVNode("div", { class: "flex items-center justify-between" }, [
                  createVNode("div", null, [
                    createVNode("h1", { class: "text-3xl font-bold tracking-tight" }, "Pesanan Pending"),
                    createVNode("p", { class: "text-muted-foreground" }, "Kelola pesanan yang menunggu pembayaran")
                  ])
                ]),
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("resources/js/pages/Admin/Orders/Pending.vue");
