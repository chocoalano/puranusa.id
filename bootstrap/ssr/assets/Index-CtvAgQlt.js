...
import { i as index, _ as _sfc_main$1, c as create, t as topUp, b as show, e as edit, d as destroy, l as loginAsCustomer } from "./AppLayout-BwB3YbyA.js";
    ...
    const columns = [
      ...
      },
      {
        ...
        cell: ({ row }) => {
          ...
          const variant = level === 4 ? "default" : level === 3 ? "secondary" : level === 2 ? "outline" : "outline";
          return h(_sfc_main$o, { variant }, () => label);
        }
      },
      {
        accessorKey: "phone",
