import { defineComponent, computed, mergeProps, withCtx, unref, createVNode, createTextVNode, toDisplayString, createBlock, createCommentVNode, openBlock, Fragment, renderList, useSSRContext } from "vue";
                                            ...
                                            _push7(ssrRenderComponent(unref(_sfc_main$c), { class: "text-right" }, {
                                              default: withCtx((_7, _push8, _parent8, _scopeId7) => {
                                                if (_push8) {
                                                  ...
                                                  return [
                                                    unref(isSuperAdmin) || unref(isAdmin) ? (openBlock(), createBlock(unref(_sfc_main$e), {
                                                      key: 0,
                                                      variant: method.is_active ? "outline" : "default",
                                                      size: "sm",
                                                      onClick: ($event) => toggleActive(method)
