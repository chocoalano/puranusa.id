...
import { U as UserController, _ as _sfc_main$1 } from "./AppLayout-Dj5p5Ehf.js";
      ...
      _push(ssrRenderComponent(_sfc_main$1, mergeProps({ breadcrumbs: breadcrumbItems }, _attrs), {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            ...
            _push2(`</div><div class="mx-auto max-w-2xl space-y-6"${_scopeId}><div class="rounded-lg border bg-card p-6"${_scopeId}><h2 class="mb-4 text-lg font-semibold"${_scopeId}>User Information</h2><div class="space-y-4"${_scopeId}><div class="flex items-start gap-3"${_scopeId}>`);
