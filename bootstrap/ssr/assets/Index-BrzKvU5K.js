...
import { i as index, _ as _sfc_main$1, c as create, t as topUp, b as show, e as edit, d as destroy, l as loginAsCustomer } from "./AppLayout-DTAmF_5Z.js";
    ...
    const columns = [
      ...
      },
      {
        ...
        cell: ({ row }) => {
          ...
          const variant = level === "Director" ? "default" : level === "Executive" ? "secondary" : level === "Senior Associate" ? "outline" : "outline";
          return h(_sfc_main$o, { variant }, () => level);
        }
      },
      {
        accessorKey: "phone",
