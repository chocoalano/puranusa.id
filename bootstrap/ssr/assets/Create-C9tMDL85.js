import { defineComponent, computed, ref, unref, withCtx, createVNode, createTextVNode, createBlock, createCommentVNode, openBlock, toDisplayString, withDirectives, vModelText, Fragment, renderList, withModifiers, useSSRContext } from "vue";
import { ssrRenderComponent, ssrInterpolate, ssrRenderList } from "vue/server-renderer";
import { useForm, Head, Link } from "@inertiajs/vue3";
import { _ as _sfc_main$1, i as index, s as store } from "./AppLayout-DTAmF_5Z.js";
                  ...
                  _push3(ssrRenderComponent(unref(_sfc_main$7), { class: "space-y-4" }, {
                    default: withCtx((_3, _push4, _parent4, _scopeId3) => {
                      if (_push4) {
                            ...
                            if (_push5) {
                              _push5(ssrRenderComponent(unref(_sfc_main$b), {
                                ...
                                default: withCtx((_5, _push6, _parent6, _scopeId5) => {
                                  if (_push6) {
                                    _push6(ssrRenderComponent(unref(_sfc_main$c), { placeholder: "Pilih status" }, {
                                      default: withCtx((_6, _push7, _parent7, _scopeId6) => {
                                        if (_push7) {
                                          _push7(`${ssrInterpolate(getStatusText.value)}`);
                                        } else {
                                          return [
                                            createTextVNode(toDisplayString(getStatusText.value), 1)
                                          ];
                                        }
                                      }),
                                      _: 1
                        ...
                        _push4(`<p class="text-xs text-muted-foreground"${_scopeId3}><strong${_scopeId3}>Prospek:</strong> Calon member, belum masuk jaringan MLM<br${_scopeId3}><strong${_scopeId3}>Pasif:</strong> Sudah terdaftar tapi belum aktif bertransaksi<br${_scopeId3}><strong${_scopeId3}>Aktif:</strong> Member aktif dengan paket dan peringkat </p>`);
                        ...
                        _push4(`</div></div>`);
                        if (isAktif.value) {
                          _push4(`<div class="grid gap-4 md:grid-cols-2 mt-4 p-4 border rounded-lg bg-green-50 dark:bg-green-900/20"${_scopeId3}><div class="md:col-span-2"${_scopeId3}><p class="text-sm font-medium text-green-800 dark:text-green-200 mb-3"${_scopeId3}>Member Aktif - Pilih Paket dan Peringkat</p></div><div class="space-y-2"${_scopeId3}>`);
                          _push4(ssrRenderComponent(unref(_sfc_main$8), { for: "package_id" }, {
                            default: withCtx((_4, _push5, _parent5, _scopeId4) => {
                              if (_push5) {
                                _push5(`Paket *`);
                              } else {
                            ...
                            default: withCtx((_4, _push5, _parent5, _scopeId4) => {
                              if (_push5) {
                                _push5(ssrRenderComponent(unref(_sfc_main$b), {
                                  ...
                                  default: withCtx((_5, _push6, _parent6, _scopeId5) => {
                                    if (_push6) {
                                      _push6(ssrRenderComponent(unref(_sfc_main$c), { placeholder: "Pilih paket" }, {
                                        default: withCtx((_6, _push7, _parent7, _scopeId6) => {
                                          if (_push7) {
                                      ...
                                      return [
                                        createVNode(unref(_sfc_main$c), { placeholder: "Pilih paket" }, {
                                          default: withCtx(() => [
                                            createTextVNode(toDisplayString(selectedPackageName.value || "Pilih paket"), 1)
                                          ]),
                                          _: 1
                          ...
                          _push4(`<p class="text-xs text-muted-foreground"${_scopeId3}> Pilih paket: ZENNER Plus, ZENNER Prime, atau ZENNER Ultra </p>`);
                          ...
                          _push4(`</div><div class="space-y-2"${_scopeId3}>`);
                          _push4(ssrRenderComponent(unref(_sfc_main$8), { for: "level" }, {
                            default: withCtx((_4, _push5, _parent5, _scopeId4) => {
                              if (_push5) {
                                _push5(`Peringkat`);
                              } else {
                                return [
                                  createTextVNode("Peringkat")
                                ];
                              }
                            }),
                            _: 1
                            ...
                            default: withCtx((_4, _push5, _parent5, _scopeId4) => {
                              if (_push5) {
                                _push5(ssrRenderComponent(unref(_sfc_main$b), {
                                  ...
                                  default: withCtx((_5, _push6, _parent6, _scopeId5) => {
                                    if (_push6) {
                                      _push6(ssrRenderComponent(unref(_sfc_main$c), { placeholder: "Pilih peringkat" }, {
                                        default: withCtx((_6, _push7, _parent7, _scopeId6) => {
                                          if (_push7) {
                                      ...
                                      return [
                                        createVNode(unref(_sfc_main$c), { placeholder: "Pilih peringkat" }, {
                                          default: withCtx(() => [
                                            createTextVNode(toDisplayString(selectedLevelName.value || "Pilih peringkat"), 1)
                                          ]),
                                          _: 1
                          ...
                          _push4(`<p class="text-xs text-muted-foreground"${_scopeId3}> Pilih peringkat: Associate, Senior Associate, Executive, atau Director </p>`);
                        ...
                        return [
                          createVNode("div", { class: "grid gap-4 md:grid-cols-2" }, [
                            ...
                            createVNode("div", { class: "space-y-2" }, [
                              ...
                              createVNode("p", { class: "text-xs text-muted-foreground" }, [
                                ...
                                createTextVNode(" Member aktif dengan paket dan peringkat ")
                              ]),
                          ...
                          isAktif.value ? (openBlock(), createBlock("div", {
                            key: 0,
                            class: "grid gap-4 md:grid-cols-2 mt-4 p-4 border rounded-lg bg-green-50 dark:bg-green-900/20"
                          }, [
                            createVNode("div", { class: "md:col-span-2" }, [
                              createVNode("p", { class: "text-sm font-medium text-green-800 dark:text-green-200 mb-3" }, "Member Aktif - Pilih Paket dan Peringkat")
                            ]),
                            createVNode("div", { class: "space-y-2" }, [
                              createVNode(unref(_sfc_main$8), { for: "package_id" }, {
                                default: withCtx(() => [
                                  createTextVNode("Paket *")
                                ]),
                                _: 1
                              ...
                              createVNode("p", { class: "text-xs text-muted-foreground" }, " Pilih paket: ZENNER Plus, ZENNER Prime, atau ZENNER Ultra "),
                            ...
                            createVNode("div", { class: "space-y-2" }, [
                              createVNode(unref(_sfc_main$8), { for: "level" }, {
                                default: withCtx(() => [
                                  createTextVNode("Peringkat")
                                ]),
                                _: 1
                              ...
                              createVNode("p", { class: "text-xs text-muted-foreground" }, " Pilih peringkat: Associate, Senior Associate, Executive, atau Director "),
