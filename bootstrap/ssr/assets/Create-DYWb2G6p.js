...
import { u as useCustomerForm, a as useShippingLocation, _ as _sfc_main$3 } from "./useShippingLocation-DOYvWAWR.js";
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(ssrRenderComponent(_sfc_main$1, null, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<div class="space-y-6 rounded-xl p-4 py-6"${_scopeId}><div class="flex items-center justify-between"${_scopeId}><div${_scopeId}><h1 class="text-3xl font-bold"${_scopeId}>Tambah Pelanggan</h1><p class="mt-2 text-muted-foreground"${_scopeId}> Form registrasi pelanggan dengan data identitas, alamat, dan rekening yang lengkap. </p></div>`);
              ...
              actions: withCtx(({ processing }, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  ...
                  _push3(ssrRenderComponent(unref(_sfc_main$2), {
                    ...
                    default: withCtx((_2, _push4, _parent4, _scopeId3) => {
                      if (_push4) {
                        _push4(`${ssrInterpolate(processing ? "Menyimpan..." : "Simpan Pelanggan")}`);
                      } else {
                        return [
                          createTextVNode(toDisplayString(processing ? "Menyimpan..." : "Simpan Pelanggan"), 1)
                        ];
                      }
                    }),
                    _: 2
              ...
              createVNode("div", { class: "space-y-6 rounded-xl p-4 py-6" }, [
                createVNode("div", { class: "flex items-center justify-between" }, [
                  createVNode("div", null, [
                    ...
                    createVNode("p", { class: "mt-2 text-muted-foreground" }, " Form registrasi pelanggan dengan data identitas, alamat, dan rekening yang lengkap. ")
                  ]),
                  createVNode(unref(Link), {
                    href: unref(index).url()
                  }, {
                ...
                createVNode(_sfc_main$3, {
                  ...
                  _: 1
                }, 8, ["form", "onUpdate:form", "provinces", "cities", "loading-provinces", "loading-cities"])
              ])
            ];
          }
        }),
