...
import { _ as _sfc_main$6, I as approve, J as reject } from "./AppLayout-1TXr_jx9.js";
                  ...
                  _push3(ssrRenderComponent(unref(_sfc_main$b), null, {
                    default: withCtx((_3, _push4, _parent4, _scopeId3) => {
                      if (_push4) {
                        ...
                        _push4(ssrRenderComponent(unref(_sfc_main$c), { value: "failed" }, {
                          default: withCtx((_4, _push5, _parent5, _scopeId4) => {
                            if (_push5) {
                              _push5(`Failed`);
                            } else {
                        ...
                        return [
                          ...
                          createVNode(unref(_sfc_main$c), { value: "failed" }, {
                            default: withCtx(() => [
                              createTextVNode("Failed")
                            ]),
                            _: 1
