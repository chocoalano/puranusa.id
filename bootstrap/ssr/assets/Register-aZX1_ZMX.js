...
import { ShoppingBag, CheckCircle2, User, AtSign, Phone, IdCard, Users, Lock, Eye, EyeOff } from "lucide-vue-next";
            ...
            _push2(ssrRenderComponent(unref(_sfc_main$5), null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  ...
                  _push3(`<div class="relative"${_scopeId2}>`);
                  _push3(ssrRenderComponent(unref(AtSign), { class: "absolute top-3 left-3 h-4 w-4 text-muted-foreground" }, null, _parent3, _scopeId2));
                  _push3(ssrRenderComponent(unref(_sfc_main$a), {
                    id: "username",
                  ...
                  if (unref(form).errors.username) {
                    ...
                    _push3(`<p class="text-xs text-muted-foreground"${_scopeId2}> Gunakan huruf/angka/underscore/dash (tanpa spasi). </p>`);
                  }
                  _push3(`</div><div class="space-y-2"${_scopeId2}>`);
                  ...
                  _push3(`<div class="relative"${_scopeId2}>`);
                  _push3(ssrRenderComponent(unref(IdCard), { class: "absolute top-3 left-3 h-4 w-4 text-muted-foreground" }, null, _parent3, _scopeId2));
                  _push3(ssrRenderComponent(unref(_sfc_main$a), {
                    id: "nik",
                    ...
                    default: withCtx((_3, _push4, _parent4, _scopeId3) => {
                      if (_push4) {
                        ...
                        _push4(ssrRenderComponent(unref(_sfc_main$e), null, {
                          default: withCtx((_4, _push5, _parent5, _scopeId4) => {
                            if (_push5) {
                              _push5(ssrRenderComponent(unref(_sfc_main$f), { value: "male" }, {
                              ...
                              _push5(ssrRenderComponent(unref(_sfc_main$f), { value: "female" }, {
                                default: withCtx((_5, _push6, _parent6, _scopeId5) => {
                                  if (_push6) {
                                    _push6(`Female`);
                                  } else {
                              ...
                              return [
                                createVNode(unref(_sfc_main$f), { value: "male" }, {
                                  default: withCtx(() => [
                                    createTextVNode("Male")
                                  ]),
                                  _: 1
                                }),
                                createVNode(unref(_sfc_main$f), { value: "female" }, {
                                  default: withCtx(() => [
                                    createTextVNode("Female")
                                  ]),
                                  _: 1
                  ...
                  if (unref(form).errors.ref_code) {
                    ...
                    _push3(`<p class="text-xs text-muted-foreground"${_scopeId2}> Masukkan kode referral sponsor (jika ada). </p>`);
                  }
                  _push3(`</div><div class="space-y-2"${_scopeId2}>`);
                  ...
                  return [
                    createVNode("form", {
                      ...
                      createVNode("div", { class: "space-y-2" }, [
                        ...
                        createVNode("div", { class: "relative" }, [
                          createVNode(unref(AtSign), { class: "absolute top-3 left-3 h-4 w-4 text-muted-foreground" }),
                          createVNode(unref(_sfc_main$a), {
                            id: "username",
                            modelValue: unref(form).username,
                            "onUpdate:modelValue": ($event) => unref(form).username = $event,
                      ...
                      createVNode("div", { class: "space-y-2" }, [
                        ...
                        createVNode("div", { class: "relative" }, [
                          createVNode(unref(IdCard), { class: "absolute top-3 left-3 h-4 w-4 text-muted-foreground" }),
                          createVNode(unref(_sfc_main$a), {
                            id: "nik",
                            modelValue: unref(form).nik,
                            "onUpdate:modelValue": ($event) => unref(form).nik = $event,
