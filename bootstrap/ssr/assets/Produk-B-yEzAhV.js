...
import { a as _sfc_main$c, _ as _sfc_main$j } from "./Ecommerce-D_5G5ayz.js";
  ...
  setup(__props) {
    return (_ctx, _push, _parent, _attrs) => {
      ...
      if (__props.longDescription) {
        _push(`<div><h3 class="text-lg font-semibold mb-3">Deskripsi Lengkap</h3><div class="rounded-lg border bg-card p-4 md:p-6"><div class="prose prose-sm md:prose-base max-w-none dark:prose-invert /* wrapping &amp; whitespace */ whitespace-normal break-words [overflow-wrap:anywhere] [word-break:break-word] /* spacing lebih konsisten */ prose-headings:scroll-mt-24 prose-h1:mt-0 prose-h2:mt-6 prose-h3:mt-5 prose-h4:mt-4 prose-p:my-3 prose-p:leading-relaxed prose-ul:my-3 prose-ol:my-3 prose-li:my-1 /* link */ prose-a:text-primary prose-a:underline prose-a:underline-offset-4 /* image responsive */ prose-img:my-4 prose-img:rounded-lg prose-img:border [&amp;_img]:max-w-full [&amp;_img]:h-auto /* blockquote */ prose-blockquote:my-4 prose-blockquote:border-l-4 prose-blockquote:border-l-primary prose-blockquote:pl-4 prose-blockquote:text-muted-foreground /* hr */ prose-hr:my-6 /* table: jangan merusak layout */ [&amp;_table]:w-full [&amp;_table]:border-collapse [&amp;_table]:block [&amp;_table]:overflow-x-auto [&amp;_table]:whitespace-nowrap [&amp;_th]:border [&amp;_th]:bg-muted [&amp;_th]:px-3 [&amp;_th]:py-2 [&amp;_th]:text-left [&amp;_td]:border [&amp;_td]:px-3 [&amp;_td]:py-2 /* kalau ada &lt;br&gt; kebanyakan, tetap enak */ [&amp;_br]:content-[&#39;&#39;] /* rapihin strong &amp; list item paragraph */ [&amp;_p&gt;strong]:font-semibold [&amp;_ol&gt;li&gt;p]:my-1 [&amp;_ul&gt;li&gt;p]:my-1 /* hilangkan margin elemen pertama/terakhir biar gak “meledak” */ [&amp;_:first-child]:mt-0 [&amp;_:last-child]:mb-0">${__props.longDescription ?? ""}</div></div></div>`);
      } else {
        _push(`<!---->`);
      }
      _push(ssrRenderComponent(unref(_sfc_main$a), null, null, _parent));
