...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    const submit = () => {
      submitForm.transform(() => form.value).post("/admin/promotions", {
        preserveScroll: true,
        onSuccess: () => {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      _push(`<!--[-->`);
      _push(ssrRenderComponent(unref(Head), { title: "Tambah Promosi" }, null, _parent));
      _push(ssrRenderComponent(_sfc_main$1, null, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            ...
            _push2(`<div${_scopeId}><h1 class="text-3xl font-bold"${_scopeId}>Tambah Promosi</h1><p class="text-muted-foreground"${_scopeId}>Buat promosi atau diskon baru</p></div></div><div class="max-w-4xl"${_scopeId}>`);
              ...
              actions: withCtx(({ processing: processing2 }, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  ...
                  _push3(ssrRenderComponent(unref(_sfc_main$2), {
                    ...
                    default: withCtx((_2, _push4, _parent4, _scopeId3) => {
                      if (_push4) {
                        _push4(`${ssrInterpolate(processing2 ? "Menyimpan..." : "Simpan Promosi")}`);
                      } else {
                        return [
                          createTextVNode(toDisplayString(processing2 ? "Menyimpan..." : "Simpan Promosi"), 1)
                        ];
                      }
                    }),
                    _: 2
              ...
              createVNode("div", { class: "rounded-xl p-4 space-y-6 py-6" }, [
                createVNode("div", { class: "flex items-center gap-4" }, [
                  ...
                  createVNode("div", null, [
                    createVNode("h1", { class: "text-3xl font-bold" }, "Tambah Promosi"),
                    createVNode("p", { class: "text-muted-foreground" }, "Buat promosi atau diskon baru")
                  ])
                ]),
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("resources/js/pages/Admin/Promotions/Create.vue");
