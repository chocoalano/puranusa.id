                    ...
                    default: withCtx((_3, _push4, _parent4, _scopeId3) => {
                      if (_push4) {
                        ...
                        _push4(ssrRenderComponent(unref(_sfc_main$e), null, {
                          default: withCtx((_4, _push5, _parent5, _scopeId4) => {
                            if (_push5) {
                              _push5(ssrRenderComponent(unref(_sfc_main$f), { value: "laki-laki" }, {
                              ...
                              _push5(ssrRenderComponent(unref(_sfc_main$f), { value: "perempuan" }, {
                                default: withCtx((_5, _push6, _parent6, _scopeId5) => {
                                  if (_push6) {
                                    _push6(`Perempuan`);
                                  } else {
                              ...
                              return [
                                createVNode(unref(_sfc_main$f), { value: "laki-laki" }, {
                                  default: withCtx(() => [
                                    createTextVNode("Laki-laki")
                                  ]),
                                  _: 1
                                }),
                                createVNode(unref(_sfc_main$f), { value: "perempuan" }, {
                                  default: withCtx(() => [
                                    createTextVNode("Perempuan")
                                  ]),
                                  _: 1
