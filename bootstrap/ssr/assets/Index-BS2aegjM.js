import { defineComponent, ref, computed, unref, withCtx, createTextVNode, toDisplayString, createVNode, createBlock, openBlock, useSSRContext, watch, resolveDynamicComponent, Fragment, renderList, createCommentVNode, withModifiers, mergeProps, onMounted, resolveComponent, onUnmounted } from "vue";
...
import { _ as _sfc_main$_ } from "./Ecommerce-YIz8cvmW.js";
import { router, useForm, Link, usePage, Head } from "@inertiajs/vue3";
import { CheckCircle, AlertCircle, Check, Copy, Share2, MapPin, Plus, Pencil, Trash2, Home, Building2, Trophy, Calendar, UserCircle, User, CreditCard, Mail, Phone, Loader2, Package, Truck, CheckCircle2, Star, RefreshCw, PackageCheck, ArrowDownLeft, ArrowUpRight, Wallet, Lock, Eye, EyeOff, ShieldCheck, Clock, UserPlus, GitBranch, Users, TrendingUp, ZoomOut, ZoomIn, RotateCcw, Move, Handshake, DollarSign, Percent, ShoppingCart, Gift, Network } from "lucide-vue-next";
...
const _sfc_main$4 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props, { emit: __emit }) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div${ssrRenderAttrs(_attrs)}><div class="flex justify-center mb-3 sm:mb-6">`);
      if (__props.node.name) {
        _push(`<div class="${ssrRenderClass([
          ...
          __props.isRoot ? "px-2 py-2 sm:px-6 sm:py-4" : "px-1.5 py-1.5 sm:px-3 sm:py-2",
          getNodeColor(__props.node.level, __props.node.status)
        ])}"><div class="${ssrRenderClass(["flex items-center gap-1.5 sm:gap-2", __props.isRoot && "sm:gap-3"])}"><div class="${ssrRenderClass([
          "flex items-center justify-center rounded-full text-primary-foreground flex-shrink-0",
          __props.isRoot ? "h-7 w-7 sm:h-12 sm:w-12 bg-primary" : "h-5 w-5 sm:h-8 sm:w-8 bg-blue-100 dark:bg-blue-900"
        ])}">`);
        _push(ssrRenderComponent(unref(User), {
          class: __props.isRoot ? "h-4 w-4 sm:h-6 sm:w-6" : "h-3 w-3 sm:h-4 sm:w-4 text-blue-600 dark:text-blue-400"
        }, null, _parent));
        _push(`</div><div class="flex-1 min-w-0"><div class="${ssrRenderClass(["font-medium truncate", __props.isRoot ? "text-xs sm:text-base font-semibold" : "text-[10px] sm:text-xs"])}"><span class="sm:hidden">${ssrInterpolate(truncateName(__props.node.name, 10))}</span><span class="hidden sm:inline">${ssrInterpolate(__props.node.name)}</span></div><div class="${ssrRenderClass(["text-muted-foreground truncate", __props.isRoot ? "text-[10px] sm:text-xs" : "text-[8px] sm:text-[10px]"])}"><span class="sm:hidden">${ssrInterpolate(truncateEmail(__props.node.email, 12))}</span><span class="hidden sm:inline">${ssrInterpolate(__props.node.email)}</span></div>`);
        if (__props.node.package_name) {
          _push(`<div class="${ssrRenderClass(["font-medium truncate", __props.isRoot ? "text-[9px] sm:text-xs text-primary" : "text-[7px] sm:text-[10px] text-primary"])}"><span class="sm:hidden">${ssrInterpolate(truncateName(__props.node.package_name, 8))}</span><span class="hidden sm:inline">${ssrInterpolate(__props.node.package_name)}</span></div>`);
        } else {
          _push(`<!---->`);
        }
        if (__props.node.total_left !== void 0 && __props.node.total_left > 0 || __props.node.total_right !== void 0 && __props.node.total_right > 0) {
          _push(`<div class="${ssrRenderClass(["flex items-center gap-1 text-muted-foreground", __props.isRoot ? "text-[9px] sm:text-xs" : "text-[7px] sm:text-[10px]"])}"><span class="text-blue-600 dark:text-blue-400">L:${ssrInterpolate(__props.node.total_left ?? 0)}</span><span class="text-muted-foreground">|</span><span class="text-green-600 dark:text-green-400">R:${ssrInterpolate(__props.node.total_right ?? 0)}</span></div>`);
        } else {
          _push(`<!---->`);
        }
        _push(`<div class="flex items-center gap-0.5 sm:gap-1 mt-0.5 sm:mt-1 flex-wrap">`);
        if (__props.node.position === "left") {
          _push(ssrRenderComponent(unref(_sfc_main$t), {
            variant: "secondary",
            class: __props.isRoot ? "text-[8px] sm:text-xs px-1 py-0" : "text-[7px] sm:text-[10px] px-0.5 py-0"
          }, {
            default: withCtx((_, _push2, _parent2, _scopeId) => {
              if (_push2) {
                _push2(`<span class="sm:hidden"${_scopeId}>L</span><span class="hidden sm:inline"${_scopeId}>Kiri</span>`);
              } else {
                return [
                  createVNode("span", { class: "sm:hidden" }, "L"),
                  createVNode("span", { class: "hidden sm:inline" }, "Kiri")
                ];
              }
            }),
            _: 1
          ...
          _push(ssrRenderComponent(unref(_sfc_main$t), {
            ...
            default: withCtx((_, _push2, _parent2, _scopeId) => {
              if (_push2) {
                _push2(`<span class="sm:hidden"${_scopeId}>R</span><span class="hidden sm:inline"${_scopeId}>Kanan</span>`);
              } else {
                return [
                  createVNode("span", { class: "sm:hidden" }, "R"),
                  createVNode("span", { class: "hidden sm:inline" }, "Kanan")
                ];
              }
            }),
            _: 1
        ...
        _push(`<div class="${ssrRenderClass([
          ...
          __props.isRoot ? "px-2 py-2 sm:px-6 sm:py-4" : "px-1.5 py-1 sm:px-3 sm:py-2"
        ])}"><div class="text-center">`);
        _push(ssrRenderComponent(unref(UserPlus), {
          class: [
            "mx-auto mb-0.5 sm:mb-1 text-muted-foreground group-hover:text-primary",
            __props.isRoot ? "w-4 h-4 sm:w-6 sm:h-6" : "w-3 h-3 sm:w-4 sm:h-4"
          ]
        }, null, _parent));
        _push(`<div class="${ssrRenderClass(["text-muted-foreground group-hover:text-primary", __props.isRoot ? "text-[10px] sm:text-sm" : "text-[8px] sm:text-[10px]"])}"><span class="sm:hidden">+</span><span class="hidden sm:inline">${ssrInterpolate(__props.isRoot ? "Tempatkan Member" : "Tambah")}</span></div></div></div>`);
      } else {
        _push(`<div class="${ssrRenderClass([
          "rounded-lg border-2 border-dashed bg-muted/30",
          __props.isRoot ? "px-2 py-2 sm:px-6 sm:py-4" : "px-1.5 py-1 sm:px-3 sm:py-2"
        ])}"><div class="${ssrRenderClass(["text-center text-muted-foreground", __props.isRoot ? "text-[10px] sm:text-sm" : "text-[8px] sm:text-[10px]"])}"> - </div></div>`);
      }
      _push(`</div>`);
      if (__props.node.name && shouldShowChildren) {
        _push(`<div class="${ssrRenderClass(["flex justify-center gap-1 sm:gap-4 mb-2 sm:mb-4", __props.isRoot && "gap-2 sm:gap-16 sm:mb-6"])}"><div class="${ssrRenderClass(__props.isRoot ? "w-[130px] sm:w-64" : "w-[65px] sm:w-36")}">`);
        if (__props.node.left) {
          ...
          _push(`<div class="flex justify-center mb-3 sm:mb-6"><div class="${ssrRenderClass([
            "rounded-lg border-2 border-dashed bg-muted/50 hover:bg-muted hover:border-primary/50 transition-all cursor-pointer group",
            __props.isRoot ? "px-2 py-2 sm:px-6 sm:py-4" : "px-1.5 py-1 sm:px-3 sm:py-2"
          ])}"><div class="text-center">`);
          _push(ssrRenderComponent(unref(UserPlus), {
          ...
          _push(`<div class="${ssrRenderClass(["text-muted-foreground group-hover:text-primary", __props.isRoot ? "text-[10px] sm:text-sm" : "text-[8px] sm:text-[10px]"])}"><span class="sm:hidden">+</span><span class="hidden sm:inline">Tambah</span></div></div></div></div>`);
        }
        _push(`</div><div class="${ssrRenderClass(__props.isRoot ? "w-[130px] sm:w-64" : "w-[65px] sm:w-36")}">`);
              ...
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  ...
                  _push3(ssrRenderComponent(unref(_sfc_main$u), {
                    ...
                    onClick: zoomOut,
                    disabled: treeScale.value <= minScale
                  }, {
                    default: withCtx((_3, _push4, _parent4, _scopeId3) => {
                      if (_push4) {
                  ...
                  _push3(ssrRenderComponent(unref(_sfc_main$u), {
                    ...
                    default: withCtx((_3, _push4, _parent4, _scopeId3) => {
                      if (_push4) {
                        _push4(`${ssrInterpolate(zoomPercentage.value)}% `);
                      } else {
                        return [
                          createTextVNode(toDisplayString(zoomPercentage.value) + "% ", 1)
                        ];
                      }
                    }),
                    _: 1
                  ...
                  _push3(ssrRenderComponent(unref(_sfc_main$u), {
                    ...
                    class: "h-7 w-7 sm:h-8 sm:w-8",
                    onClick: zoomIn,
                    disabled: treeScale.value >= maxScale
                  }, {
                    default: withCtx((_3, _push4, _parent4, _scopeId3) => {
                      if (_push4) {
              ...
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<div class="${ssrRenderClass([{
                    "cursor-grab": !isPanning.value && treeScale.value !== 1,
                    "cursor-grabbing": isPanning.value
                  }, "overflow-auto pb-4 -mx-2 px-2 max-h-[60vh] sm:max-h-[70vh] select-none"])}"${_scopeId2}><div class="min-w-[280px] sm:min-w-max transition-transform duration-200 origin-top-left inline-block" style="${ssrRenderStyle({
                  ...
                  _push3(ssrRenderComponent(_sfc_main$4, {
                    ...
                    "is-root": true,
                    "max-level": maxVisibleLevels.value,
                    onOpenPlacement: openPlacementDialog
                  }, null, _parent3, _scopeId2));
                  _push3(`</div></div><div class="mt-4 sm:mt-6 p-2 sm:p-4 rounded-lg bg-muted/50"${_scopeId2}><div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-2 text-center sm:text-left"${_scopeId2}><p class="text-[10px] sm:text-sm text-muted-foreground"${_scopeId2}> 💡 <span class="hidden sm:inline"${_scopeId2}>Tree menampilkan maksimal ${ssrInterpolate(maxVisibleLevels.value)} level untuk performa optimal</span><span class="sm:hidden"${_scopeId2}>Max ${ssrInterpolate(maxVisibleLevels.value)} level</span></p><p class="text-[10px] sm:text-sm text-muted-foreground"${_scopeId2}>`);
                  _push3(ssrRenderComponent(unref(Move), { class: "inline-block h-3 w-3 sm:h-4 sm:w-4 mr-1" }, null, _parent3, _scopeId2));
                  _push3(`<span class="hidden sm:inline"${_scopeId2}>Drag untuk menggeser, gunakan tombol zoom untuk resize</span><span class="sm:hidden"${_scopeId2}>Geser &amp; Zoom: ${ssrInterpolate(zoomPercentage.value)}%</span></p></div></div>`);
                } else {
                  return [
                    createVNode("div", {
                    ...
                    createVNode("div", { class: "mt-4 sm:mt-6 p-2 sm:p-4 rounded-lg bg-muted/50" }, [
                      createVNode("div", { class: "flex flex-col sm:flex-row sm:items-center sm:justify-between gap-2 text-center sm:text-left" }, [
                        createVNode("p", { class: "text-[10px] sm:text-sm text-muted-foreground" }, [
                          createTextVNode(" 💡 "),
                          createVNode("span", { class: "hidden sm:inline" }, "Tree menampilkan maksimal " + toDisplayString(maxVisibleLevels.value) + " level untuk performa optimal", 1),
                          createVNode("span", { class: "sm:hidden" }, "Max " + toDisplayString(maxVisibleLevels.value) + " level", 1)
                        ]),
                        createVNode("p", { class: "text-[10px] sm:text-sm text-muted-foreground" }, [
                          createVNode(unref(Move), { class: "inline-block h-3 w-3 sm:h-4 sm:w-4 mr-1" }),
                          createVNode("span", { class: "hidden sm:inline" }, "Drag untuk menggeser, gunakan tombol zoom untuk resize"),
                          createVNode("span", { class: "sm:hidden" }, "Geser & Zoom: " + toDisplayString(zoomPercentage.value) + "%", 1)
                        ])
                      ])
                    ])
                  ];
