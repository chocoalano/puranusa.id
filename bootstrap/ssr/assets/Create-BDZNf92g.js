...
import { _ as _sfc_main$1, i as index, s as store } from "./AppLayout-Dj5p5Ehf.js";
                  ...
                  _push3(ssrRenderComponent(unref(_sfc_main$7), { class: "space-y-4" }, {
                    default: withCtx((_3, _push4, _parent4, _scopeId3) => {
                      if (_push4) {
                        ...
                        _push4(`<p class="text-xs text-muted-foreground"${_scopeId3}> Prospek: belum terdaftar di jaringan, Pasif: terdaftar tapi belum aktif, Aktif: terdaftar dan aktif </p>`);
                        ...
                        return [
                          createVNode("div", { class: "grid gap-4 md:grid-cols-2" }, [
                            ...
                            createVNode("div", { class: "space-y-2" }, [
                              ...
                              createVNode("p", { class: "text-xs text-muted-foreground" }, " Prospek: belum terdaftar di jaringan, Pasif: terdaftar tapi belum aktif, Aktif: terdaftar dan aktif "),
