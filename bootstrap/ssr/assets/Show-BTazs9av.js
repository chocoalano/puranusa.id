...
import { _ as _sfc_main$1 } from "./Ecommerce-tntAMUbA.js";
import { _ as _sfc_main$4 } from "./ArticleContent-BYZJF0Pu.js";
import { _ as _sfc_main$5, c as _sfc_main$6 } from "./CardTitle-sqUG0LTw.js";
      ...
      _push(ssrRenderComponent(_sfc_main$1, null, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            ...
            _push2(`</div></div><article class="container mx-auto px-4 py-8 md:py-12"${_scopeId}><div class="max-w-4xl mx-auto space-y-10"${_scopeId}><header class="rounded-2xl border bg-white dark:bg-gray-900 p-6 md:p-8 shadow-sm space-y-6"${_scopeId}><div class="flex flex-col gap-4 sm:flex-row sm:items-start sm:justify-between"${_scopeId}><div class="space-y-3"${_scopeId}><h1 class="text-3xl md:text-4xl lg:text-5xl font-bold leading-tight"${_scopeId}>${ssrInterpolate(__props.article.title)}</h1><div class="flex flex-wrap items-center gap-4 text-sm text-muted-foreground"${_scopeId}><div class="flex items-center gap-2"${_scopeId}>`);
            ...
            _push2(`<span${_scopeId}>${ssrInterpolate(__props.article.reading_time)} menit baca</span></div></div></div>`);
            _push2(ssrRenderComponent(unref(_sfc_main$2), {
              variant: "outline",
              size: "sm",
            ...
            _push2(`</header><div class="rounded-2xl border bg-white dark:bg-gray-900 p-6 md:p-8 shadow-sm"${_scopeId}>`);
            ...
            _push2(`</div><footer class="flex flex-wrap items-center justify-between gap-3"${_scopeId}><div class="flex flex-wrap gap-2"${_scopeId}><span class="text-sm text-muted-foreground"${_scopeId}>Bagikan:</span>`);
            _push2(ssrRenderComponent(unref(_sfc_main$2), {
              variant: "outline",
              size: "sm",
              onClick: shareArticle
                ...
                _push2(ssrRenderComponent(unref(_sfc_main$5), {
                  ...
                  default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                    if (_push3) {
                      ...
                      _push3(ssrRenderComponent(unref(_sfc_main$6), { class: "p-4" }, {
                      ...
                      return [
                        ...
                        createVNode(unref(_sfc_main$6), { class: "p-4" }, {
                          default: withCtx(() => [
                            createVNode("div", { class: "text-xs text-muted-foreground mb-2" }, toDisplayString(related.published_at), 1),
                            createVNode("h3", { class: "font-semibold mb-2 line-clamp-2 group-hover:text-primary transition-colors" }, toDisplayString(related.title), 1),
                            createVNode("p", { class: "text-sm text-muted-foreground line-clamp-2" }, toDisplayString(related.seo_description), 1)
              ...
              createVNode("div", { class: "min-h-screen bg-gray-50 dark:bg-gray-950" }, [
                ...
                createVNode("article", { class: "container mx-auto px-4 py-8 md:py-12" }, [
                  createVNode("div", { class: "max-w-4xl mx-auto space-y-10" }, [
                    createVNode("header", { class: "rounded-2xl border bg-white dark:bg-gray-900 p-6 md:p-8 shadow-sm space-y-6" }, [
                      createVNode("div", { class: "flex flex-col gap-4 sm:flex-row sm:items-start sm:justify-between" }, [
                        createVNode("div", { class: "space-y-3" }, [
                          createVNode("h1", { class: "text-3xl md:text-4xl lg:text-5xl font-bold leading-tight" }, toDisplayString(__props.article.title), 1),
                    ...
                    createVNode("div", { class: "rounded-2xl border bg-white dark:bg-gray-900 p-6 md:p-8 shadow-sm" }, [
                      __props.article.blocks && __props.article.blocks.length > 0 ? (openBlock(), createBlock(_sfc_main$4, {
                        key: 0,
                        blocks: __props.article.blocks
                    ...
                    createVNode("footer", { class: "flex flex-wrap items-center justify-between gap-3" }, [
