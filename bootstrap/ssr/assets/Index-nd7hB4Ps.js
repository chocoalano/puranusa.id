...
import { _ as _sfc_main$i, v as approve, w as reject, x as destroy } from "./AppLayout-BHxY2bcF.js";
              ...
              _push2(ssrRenderComponent(unref(_sfc_main$c), { class: "space-y-4" }, {
                default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                  if (_push3) {
                    ...
                    if (!review.is_approved && (unref(isSuperAdmin) || unref(isAdmin))) {
                    ...
                    return [
                      ...
                      createVNode("div", { class: "flex gap-2 pt-2 border-t" }, [
                        !review.is_approved && (unref(isSuperAdmin) || unref(isAdmin)) ? (openBlock(), createBlock(unref(_sfc_main$g), {
                          key: 0,
                          size: "sm",
                          onClick: ($event) => emit("approve", review.id)
                        }, {
