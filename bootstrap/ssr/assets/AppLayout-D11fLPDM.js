...
import { PanelLeft, ChevronRight, Settings, LogOut, ChevronsUpDown, FileText, FolderTree, BookOpen, LayoutGrid, Users, Users2Icon, Store, Package, FileEdit, ShoppingCart, Heart, Star, BadgePercent, CreditCard, Truck, ArrowLeftRight, Wallet, WalletCards, Wallet2Icon, WalletIcon, Gift, TrendingUp, Infinity, Wallet2, Grid3x3, ChartBar, BookCheck, BookDashed, MessageSquare, SendHorizontal, MapPin } from "lucide-vue-next";
...
import { l as logout, d as dashboard } from "./index-Bfu0FVt6.js";
...
index$r.url = (options) => {
  return index$r.definition.url + queryParams(options);
};
index$r.get = (options) => ({
  url: index$r.url(options),
  method: "get"
});
index$r.head = (options) => ({
  url: index$r.url(options),
  method: "head"
});
const indexForm$r = (options) => ({
  action: index$r.url(options),
  method: "get"
});
indexForm$r.get = (options) => ({
  action: index$r.url(options),
  method: "get"
});
indexForm$r.head = (options) => ({
  action: index$r.url({
...
index$r.form = indexForm$r;
const create$f = (options) => ({
  url: create$f.url(options),
  method: "get"
});
create$f.definition = {
  methods: ["get", "head"],
...
create$f.url = (options) => {
  return create$f.definition.url + queryParams(options);
};
create$f.get = (options) => ({
  url: create$f.url(options),
  method: "get"
});
create$f.head = (options) => ({
  url: create$f.url(options),
  method: "head"
});
const createForm$f = (options) => ({
  action: create$f.url(options),
  method: "get"
});
createForm$f.get = (options) => ({
  action: create$f.url(options),
  method: "get"
});
createForm$f.head = (options) => ({
  action: create$f.url({
    [options?.mergeQuery ? "mergeQuery" : "query"]: {
      _method: "HEAD",
      ...options?.query ?? options?.mergeQuery ?? {}
...
create$f.form = createForm$f;
const store$f = (options) => ({
  url: store$f.url(options),
  method: "post"
});
store$f.definition = {
  methods: ["post"],
...
store$f.url = (options) => {
  return store$f.definition.url + queryParams(options);
};
store$f.post = (options) => ({
  url: store$f.url(options),
  method: "post"
});
const storeForm$f = (options) => ({
  action: store$f.url(options),
  method: "post"
});
storeForm$f.post = (options) => ({
  action: store$f.url(options),
  method: "post"
});
store$f.form = storeForm$f;
...
const edit$g = (args, options) => ({
  url: edit$g.url(args, options),
  method: "get"
});
edit$g.definition = {
  methods: ["get", "head"],
...
edit$g.url = (args, options) => {
  ...
  return edit$g.definition.url.replace("{customerBonusSponsor}", parsedArgs.customerBonusSponsor.toString()).replace(/\/+$/, "") + queryParams(options);
};
edit$g.get = (args, options) => ({
  url: edit$g.url(args, options),
  method: "get"
});
edit$g.head = (args, options) => ({
  url: edit$g.url(args, options),
  method: "head"
});
const editForm$g = (args, options) => ({
  action: edit$g.url(args, options),
  method: "get"
});
editForm$g.get = (args, options) => ({
  action: edit$g.url(args, options),
  method: "get"
});
editForm$g.head = (args, options) => ({
  action: edit$g.url(args, {
    [options?.mergeQuery ? "mergeQuery" : "query"]: {
      _method: "HEAD",
      ...options?.query ?? options?.mergeQuery ?? {}
    }
...
edit$g.form = editForm$g;
const update$j = (args, options) => ({
  url: update$j.url(args, options),
  method: "put"
});
update$j.definition = {
  methods: ["put", "patch"],
...
update$j.url = (args, options) => {
  ...
  return update$j.definition.url.replace("{customerBonusSponsor}", parsedArgs.customerBonusSponsor.toString()).replace(/\/+$/, "") + queryParams(options);
};
update$j.put = (args, options) => ({
  url: update$j.url(args, options),
  method: "put"
});
update$j.patch = (args, options) => ({
  url: update$j.url(args, options),
  method: "patch"
});
const updateForm$j = (args, options) => ({
  action: update$j.url(args, {
    [options?.mergeQuery ? "mergeQuery" : "query"]: {
      _method: "PUT",
      ...options?.query ?? options?.mergeQuery ?? {}
    }
...
updateForm$j.patch = (args, options) => ({
  action: update$j.url(args, {
    [options?.mergeQuery ? "mergeQuery" : "query"]: {
      _method: "PATCH",
      ...options?.query ?? options?.mergeQuery ?? {}
...
update$j.form = updateForm$j;
const destroy$i = (args, options) => ({
  url: destroy$i.url(args, options),
  method: "delete"
});
destroy$i.definition = {
  methods: ["delete"],
  url: "/bonus/sponsor/{customerBonusSponsor}"
};
destroy$i.url = (args, options) => {
  if (typeof args === "string" || typeof args === "number") {
    args = { customerBonusSponsor: args };
  }
  if (typeof args === "object" && !Array.isArray(args) && "id" in args) {
  ...
  return destroy$i.definition.url.replace("{customerBonusSponsor}", parsedArgs.customerBonusSponsor.toString()).replace(/\/+$/, "") + queryParams(options);
};
destroy$i.delete = (args, options) => ({
  url: destroy$i.url(args, options),
  method: "delete"
});
const destroyForm$i = (args, options) => ({
  action: destroy$i.url(args, {
    [options?.mergeQuery ? "mergeQuery" : "query"]: {
      _method: "DELETE",
      ...options?.query ?? options?.mergeQuery ?? {}
    }
...
destroyForm$i.delete = (args, options) => ({
  action: destroy$i.url(args, {
    [options?.mergeQuery ? "mergeQuery" : "query"]: {
      _method: "DELETE",
      ...options?.query ?? options?.mergeQuery ?? {}
...
edit$f.url = (args, options) => {
  ...
  return edit$f.definition.url.replace("{customerBonusMatching}", parsedArgs.customerBonusMatching.toString()).replace(/\/+$/, "") + queryParams(options);
};
...
update$i.url = (args, options) => {
  ...
  return update$i.definition.url.replace("{customerBonusMatching}", parsedArgs.customerBonusMatching.toString()).replace(/\/+$/, "") + queryParams(options);
};
...
destroy$h.url = (args, options) => {
  ...
  return destroy$h.definition.url.replace("{customerBonusMatching}", parsedArgs.customerBonusMatching.toString()).replace(/\/+$/, "") + queryParams(options);
};
...
edit$e.url = (args, options) => {
  ...
  return edit$e.definition.url.replace("{customerBonusPairing}", parsedArgs.customerBonusPairing.toString()).replace(/\/+$/, "") + queryParams(options);
};
...
update$h.url = (args, options) => {
  ...
  return update$h.definition.url.replace("{customerBonusPairing}", parsedArgs.customerBonusPairing.toString()).replace(/\/+$/, "") + queryParams(options);
};
...
destroy$g.url = (args, options) => {
  ...
  return destroy$g.definition.url.replace("{customerBonusPairing}", parsedArgs.customerBonusPairing.toString()).replace(/\/+$/, "") + queryParams(options);
};
...
edit$d.url = (args, options) => {
  ...
  return edit$d.definition.url.replace("{customerBonusCashback}", parsedArgs.customerBonusCashback.toString()).replace(/\/+$/, "") + queryParams(options);
};
...
update$g.url = (args, options) => {
  ...
  return update$g.definition.url.replace("{customerBonusCashback}", parsedArgs.customerBonusCashback.toString()).replace(/\/+$/, "") + queryParams(options);
};
...
destroy$f.url = (args, options) => {
  ...
  return destroy$f.definition.url.replace("{customerBonusCashback}", parsedArgs.customerBonusCashback.toString()).replace(/\/+$/, "") + queryParams(options);
};
...
edit$c.url = (args, options) => {
  ...
  return edit$c.definition.url.replace("{customerBonusReward}", parsedArgs.customerBonusReward.toString()).replace(/\/+$/, "") + queryParams(options);
};
...
update$f.url = (args, options) => {
  ...
  return update$f.definition.url.replace("{customerBonusReward}", parsedArgs.customerBonusReward.toString()).replace(/\/+$/, "") + queryParams(options);
};
...
destroy$e.url = (args, options) => {
  ...
  return destroy$e.definition.url.replace("{customerBonusReward}", parsedArgs.customerBonusReward.toString()).replace(/\/+$/, "") + queryParams(options);
};
...
edit$b.url = (args, options) => {
  ...
  return edit$b.definition.url.replace("{customerBonusRetail}", parsedArgs.customerBonusRetail.toString()).replace(/\/+$/, "") + queryParams(options);
};
...
update$e.url = (args, options) => {
  ...
  return update$e.definition.url.replace("{customerBonusRetail}", parsedArgs.customerBonusRetail.toString()).replace(/\/+$/, "") + queryParams(options);
};
...
destroy$d.url = (args, options) => {
  ...
  return destroy$d.definition.url.replace("{customerBonusRetail}", parsedArgs.customerBonusRetail.toString()).replace(/\/+$/, "") + queryParams(options);
};
...
edit$a.url = (args, options) => {
  ...
  return edit$a.definition.url.replace("{customerBonusLifetimeCashReward}", parsedArgs.customerBonusLifetimeCashReward.toString()).replace(/\/+$/, "") + queryParams(options);
};
...
update$d.url = (args, options) => {
  ...
  return update$d.definition.url.replace("{customerBonusLifetimeCashReward}", parsedArgs.customerBonusLifetimeCashReward.toString()).replace(/\/+$/, "") + queryParams(options);
};
...
destroy$c.url = (args, options) => {
  ...
  return destroy$c.definition.url.replace("{customerBonusLifetimeCashReward}", parsedArgs.customerBonusLifetimeCashReward.toString()).replace(/\/+$/, "") + queryParams(options);
};
...
edit$9.url = (args, options) => {
  ...
  return edit$9.definition.url.replace("{user}", parsedArgs.user.toString()).replace(/\/+$/, "") + queryParams(options);
};
...
update$c.url = (args, options) => {
  ...
  return update$c.definition.url.replace("{user}", parsedArgs.user.toString()).replace(/\/+$/, "") + queryParams(options);
};
...
destroy$b.url = (args, options) => {
  ...
  return destroy$b.definition.url.replace("{user}", parsedArgs.user.toString()).replace(/\/+$/, "") + queryParams(options);
};
...
const UserController = { index: index$k, create: create$8, store: store$8, show: show$6, edit: edit$9, update: update$c, destroy: destroy$b };
...
edit$8.url = (args, options) => {
  ...
  return edit$8.definition.url.replace("{customer}", parsedArgs.customer.toString()).replace(/\/+$/, "") + queryParams(options);
};
...
update$b.url = (args, options) => {
  ...
  return update$b.definition.url.replace("{customer}", parsedArgs.customer.toString()).replace(/\/+$/, "") + queryParams(options);
};
...
destroy$a.url = (args, options) => {
  ...
  return destroy$a.definition.url.replace("{customer}", parsedArgs.customer.toString()).replace(/\/+$/, "") + queryParams(options);
};
...
edit$7.url = (args, options) => {
  ...
  return edit$7.definition.url.replace("{stockist}", parsedArgs.stockist.toString()).replace(/\/+$/, "") + queryParams(options);
};
...
update$a.url = (args, options) => {
  ...
  return update$a.definition.url.replace("{stockist}", parsedArgs.stockist.toString()).replace(/\/+$/, "") + queryParams(options);
};
...
destroy$9.url = (args, options) => {
  ...
  return destroy$9.definition.url.replace("{stockist}", parsedArgs.stockist.toString()).replace(/\/+$/, "") + queryParams(options);
};
...
edit$6.url = (args, options) => {
  ...
  return edit$6.definition.url.replace("{product}", parsedArgs.product.toString()).replace(/\/+$/, "") + queryParams(options);
};
...
update$9.url = (args, options) => {
  ...
  return update$9.definition.url.replace("{product}", parsedArgs.product.toString()).replace(/\/+$/, "") + queryParams(options);
};
...
destroy$8.url = (args, options) => {
  ...
  return destroy$8.definition.url.replace("{product}", parsedArgs.product.toString()).replace(/\/+$/, "") + queryParams(options);
};
...
edit$5.url = (args, options) => {
  ...
  return edit$5.definition.url.replace("{category}", parsedArgs.category.toString()).replace(/\/+$/, "") + queryParams(options);
};
...
update$8.url = (args, options) => {
  ...
  return update$8.definition.url.replace("{category}", parsedArgs.category.toString()).replace(/\/+$/, "") + queryParams(options);
};
...
edit$4.url = (args, options) => {
  ...
  return edit$4.definition.url.replace("{article}", parsedArgs.article.toString()).replace(/\/+$/, "") + queryParams(options);
};
...
update$7.url = (args, options) => {
  ...
  return update$7.definition.url.replace("{article}", parsedArgs.article.toString()).replace(/\/+$/, "") + queryParams(options);
};
...
destroy$6.url = (args, options) => {
  ...
  return destroy$6.definition.url.replace("{article}", parsedArgs.article.toString()).replace(/\/+$/, "") + queryParams(options);
};
...
edit$3.url = (args, options) => {
  ...
  return edit$3.definition.url.replace("{page}", parsedArgs.page.toString()).replace(/\/+$/, "") + queryParams(options);
};
...
update$6.url = (args, options) => {
  ...
  return update$6.definition.url.replace("{page}", parsedArgs.page.toString()).replace(/\/+$/, "") + queryParams(options);
};
...
destroy$5.url = (args, options) => {
  ...
  return destroy$5.definition.url.replace("{page}", parsedArgs.page.toString()).replace(/\/+$/, "") + queryParams(options);
};
...
destroy$4.url = (args, options) => {
  ...
  return destroy$4.definition.url.replace("{review}", parsedArgs.review.toString()).replace(/\/+$/, "") + queryParams(options);
};
...
edit$2.url = (args, options) => {
  ...
  return edit$2.definition.url.replace("{promotion}", parsedArgs.promotion.toString()).replace(/\/+$/, "") + queryParams(options);
};
...
update$5.url = (args, options) => {
  ...
  return update$5.definition.url.replace("{promotion}", parsedArgs.promotion.toString()).replace(/\/+$/, "") + queryParams(options);
};
...
destroy$3.url = (args, options) => {
  ...
  return destroy$3.definition.url.replace("{promotion}", parsedArgs.promotion.toString()).replace(/\/+$/, "") + queryParams(options);
};
...
update$4.url = (args, options) => {
  ...
  return update$4.definition.url.replace("{shipment}", parsedArgs.shipment.toString()).replace(/\/+$/, "") + queryParams(options);
};
...
const analytic = (options) => ({
  url: analytic.url(options),
  method: "get"
});
analytic.definition = {
  methods: ["get", "head"],
  url: "/admin/report/analytic"
};
analytic.url = (options) => {
  return analytic.definition.url + queryParams(options);
};
analytic.get = (options) => ({
  url: analytic.url(options),
  method: "get"
});
analytic.head = (options) => ({
  url: analytic.url(options),
  method: "head"
});
const analyticForm = (options) => ({
  action: analytic.url(options),
  method: "get"
});
analyticForm.get = (options) => ({
  action: analytic.url(options),
  method: "get"
});
analyticForm.head = (options) => ({
  action: analytic.url({
    [options?.mergeQuery ? "mergeQuery" : "query"]: {
      _method: "HEAD",
      ...options?.query ?? options?.mergeQuery ?? {}
...
analytic.form = analyticForm;
const analytic_export = (options) => ({
  url: analytic_export.url(options),
  method: "post"
});
analytic_export.definition = {
  methods: ["post"],
  url: "/admin/report/analytic"
};
analytic_export.url = (options) => {
  return analytic_export.definition.url + queryParams(options);
};
analytic_export.post = (options) => ({
  url: analytic_export.url(options),
  method: "post"
});
const analytic_exportForm = (options) => ({
  action: analytic_export.url(options),
  method: "post"
});
analytic_exportForm.post = (options) => ({
  action: analytic_export.url(options),
  method: "post"
});
analytic_export.form = analytic_exportForm;
const tax_daily_report = (options) => ({
  url: tax_daily_report.url(options),
  method: "get"
});
tax_daily_report.definition = {
  methods: ["get", "head"],
  url: "/admin/report/tax-daily"
};
tax_daily_report.url = (options) => {
  return tax_daily_report.definition.url + queryParams(options);
};
tax_daily_report.get = (options) => ({
  url: tax_daily_report.url(options),
  method: "get"
});
tax_daily_report.head = (options) => ({
  url: tax_daily_report.url(options),
  method: "head"
});
const tax_daily_reportForm = (options) => ({
  action: tax_daily_report.url(options),
  method: "get"
});
tax_daily_reportForm.get = (options) => ({
  action: tax_daily_report.url(options),
  method: "get"
});
tax_daily_reportForm.head = (options) => ({
  action: tax_daily_report.url({
    [options?.mergeQuery ? "mergeQuery" : "query"]: {
      _method: "HEAD",
      ...options?.query ?? options?.mergeQuery ?? {}
    }
...
tax_daily_report.form = tax_daily_reportForm;
const tax_daily_report_export = (options) => ({
  url: tax_daily_report_export.url(options),
  method: "get"
});
tax_daily_report_export.definition = {
  methods: ["get", "head"],
  url: "/admin/report/tax-daily/export"
};
tax_daily_report_export.url = (options) => {
  return tax_daily_report_export.definition.url + queryParams(options);
};
tax_daily_report_export.get = (options) => ({
  url: tax_daily_report_export.url(options),
  method: "get"
});
tax_daily_report_export.head = (options) => ({
  url: tax_daily_report_export.url(options),
  method: "head"
});
const tax_daily_report_exportForm = (options) => ({
  action: tax_daily_report_export.url(options),
  method: "get"
});
tax_daily_report_exportForm.get = (options) => ({
  action: tax_daily_report_export.url(options),
  method: "get"
});
tax_daily_report_exportForm.head = (options) => ({
  action: tax_daily_report_export.url({
    [options?.mergeQuery ? "mergeQuery" : "query"]: {
      _method: "HEAD",
      ...options?.query ?? options?.mergeQuery ?? {}
    }
...
tax_daily_report_export.form = tax_daily_report_exportForm;
const tax_summary_report = (options) => ({
  url: tax_summary_report.url(options),
  method: "get"
});
tax_summary_report.definition = {
  methods: ["get", "head"],
  url: "/admin/report/tax-summary"
};
tax_summary_report.url = (options) => {
  return tax_summary_report.definition.url + queryParams(options);
};
tax_summary_report.get = (options) => ({
  url: tax_summary_report.url(options),
  method: "get"
});
tax_summary_report.head = (options) => ({
  url: tax_summary_report.url(options),
  method: "head"
});
const tax_summary_reportForm = (options) => ({
  action: tax_summary_report.url(options),
  method: "get"
});
tax_summary_reportForm.get = (options) => ({
  action: tax_summary_report.url(options),
  method: "get"
});
tax_summary_reportForm.head = (options) => ({
  action: tax_summary_report.url({
    [options?.mergeQuery ? "mergeQuery" : "query"]: {
      _method: "HEAD",
      ...options?.query ?? options?.mergeQuery ?? {}
    }
...
tax_summary_report.form = tax_summary_reportForm;
const tax_summary_report_export = (options) => ({
  url: tax_summary_report_export.url(options),
  method: "get"
});
tax_summary_report_export.definition = {
  methods: ["get", "head"],
  url: "/admin/report/tax-summary/export"
};
tax_summary_report_export.url = (options) => {
  return tax_summary_report_export.definition.url + queryParams(options);
};
tax_summary_report_export.get = (options) => ({
  url: tax_summary_report_export.url(options),
  method: "get"
});
tax_summary_report_export.head = (options) => ({
  url: tax_summary_report_export.url(options),
  method: "head"
});
const tax_summary_report_exportForm = (options) => ({
  action: tax_summary_report_export.url(options),
  method: "get"
});
tax_summary_report_exportForm.get = (options) => ({
  action: tax_summary_report_export.url(options),
  method: "get"
});
tax_summary_report_exportForm.head = (options) => ({
  action: tax_summary_report_export.url({
    [options?.mergeQuery ? "mergeQuery" : "query"]: {
      _method: "HEAD",
      ...options?.query ?? options?.mergeQuery ?? {}
    }
...
tax_summary_report_export.form = tax_summary_report_exportForm;
...
destroy$2.url = (args, options) => {
  ...
  return destroy$2.definition.url.replace("{address}", parsedArgs.address.toString()).replace(/\/+$/, "") + queryParams(options);
};
...
update$3.url = (args, options) => {
  ...
  return update$3.definition.url.replace("{paymentMethod}", parsedArgs.paymentMethod.toString()).replace(/\/+$/, "") + queryParams(options);
};
...
update$2.post = (options) => ({
  url: update$2.url(options),
  method: "post"
});
const updateForm$2 = (options) => ({
  action: update$2.url(options),
  method: "post"
});
updateForm$2.post = (options) => ({
  action: update$2.url(options),
  method: "post"
});
...
const send = (args, options) => ({
  url: send.url(args, options),
  method: "post"
});
send.definition = {
  methods: ["post"],
  url: "/admin/whatsapp-broadcasts/{whatsappBroadcast}/send"
};
send.url = (args, options) => {
  if (typeof args === "string" || typeof args === "number") {
    args = { whatsappBroadcast: args };
  }
  if (typeof args === "object" && !Array.isArray(args) && "id" in args) {
    args = { whatsappBroadcast: args.id };
  }
  if (Array.isArray(args)) {
    args = {
      whatsappBroadcast: args[0]
    };
  }
  args = applyUrlDefaults(args);
  const parsedArgs = {
    whatsappBroadcast: typeof args.whatsappBroadcast === "object" ? args.whatsappBroadcast.id : args.whatsappBroadcast
  };
  return send.definition.url.replace("{whatsappBroadcast}", parsedArgs.whatsappBroadcast.toString()).replace(/\/+$/, "") + queryParams(options);
};
send.post = (args, options) => ({
  url: send.url(args, options),
  method: "post"
});
const sendForm = (args, options) => ({
  action: send.url(args, options),
  method: "post"
});
sendForm.post = (args, options) => ({
  action: send.url(args, options),
  method: "post"
});
send.form = sendForm;
const testSend = (args, options) => ({
  url: testSend.url(args, options),
  method: "post"
});
testSend.definition = {
  methods: ["post"],
  url: "/admin/whatsapp-broadcasts/{whatsappBroadcast}/test-send"
};
testSend.url = (args, options) => {
  if (typeof args === "string" || typeof args === "number") {
    args = { whatsappBroadcast: args };
  }
  if (typeof args === "object" && !Array.isArray(args) && "id" in args) {
  ...
  return testSend.definition.url.replace("{whatsappBroadcast}", parsedArgs.whatsappBroadcast.toString()).replace(/\/+$/, "") + queryParams(options);
};
testSend.post = (args, options) => ({
  url: testSend.url(args, options),
  method: "post"
});
const testSendForm = (args, options) => ({
  action: testSend.url(args, options),
  method: "post"
});
testSendForm.post = (args, options) => ({
  action: testSend.url(args, options),
  method: "post"
});
testSend.form = testSendForm;
const testSendMultiple = (args, options) => ({
  url: testSendMultiple.url(args, options),
  method: "post"
});
testSendMultiple.definition = {
  methods: ["post"],
  url: "/admin/whatsapp-broadcasts/{whatsappBroadcast}/test-send-multiple"
};
testSendMultiple.url = (args, options) => {
  if (typeof args === "string" || typeof args === "number") {
    args = { whatsappBroadcast: args };
  }
  if (typeof args === "object" && !Array.isArray(args) && "id" in args) {
  ...
  return testSendMultiple.definition.url.replace("{whatsappBroadcast}", parsedArgs.whatsappBroadcast.toString()).replace(/\/+$/, "") + queryParams(options);
};
testSendMultiple.post = (args, options) => ({
  url: testSendMultiple.url(args, options),
  method: "post"
});
const testSendMultipleForm = (args, options) => ({
  action: testSendMultiple.url(args, options),
  method: "post"
});
testSendMultipleForm.post = (args, options) => ({
  action: testSendMultiple.url(args, options),
  method: "post"
});
testSendMultiple.form = testSendMultipleForm;
...
create.definition = {
  methods: ["get", "head"],
  url: "/admin/whatsapp-broadcasts/create"
};
create.url = (options) => {
...
edit$1.definition = {
  methods: ["get", "head"],
  url: "/admin/whatsapp-broadcasts/{whatsappBroadcast}/edit"
};
edit$1.url = (args, options) => {
  ...
  return edit$1.definition.url.replace("{whatsappBroadcast}", parsedArgs.whatsappBroadcast.toString()).replace(/\/+$/, "") + queryParams(options);
};
...
update$1.definition = {
  methods: ["put", "patch"],
  url: "/admin/whatsapp-broadcasts/{whatsappBroadcast}"
};
update$1.url = (args, options) => {
  ...
  return update$1.definition.url.replace("{whatsappBroadcast}", parsedArgs.whatsappBroadcast.toString()).replace(/\/+$/, "") + queryParams(options);
};
...
destroy$1.url = (args, options) => {
  ...
  return destroy$1.definition.url.replace("{whatsappBroadcast}", parsedArgs.whatsappBroadcast.toString()).replace(/\/+$/, "") + queryParams(options);
};
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            ...
            _push2(ssrRenderComponent(unref(_sfc_main$H), null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(ssrRenderComponent(_sfc_main$9, { items: mainNavItems.value }, null, _parent3, _scopeId2));
                } else {
                  return [
                    createVNode(_sfc_main$9, { items: mainNavItems.value }, null, 8, ["items"])
                  ];
                }
              }),
              _: 1
