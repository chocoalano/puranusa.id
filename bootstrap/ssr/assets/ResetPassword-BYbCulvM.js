...
import { ShoppingBag, Mail, Lock, Eye, EyeOff } from "lucide-vue-next";
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      _push(`<!--[-->`);
      _push(ssrRenderComponent(unref(Head), { title: "Reset Password - Puranusa" }, null, _parent));
                ...
                if (_push3) {
                  _push3(ssrRenderComponent(unref(_sfc_main$3), { class: "text-2xl font-bold" }, {
                    default: withCtx((_3, _push4, _parent4, _scopeId3) => {
                      if (_push4) {
                        _push4(`Buat Password Baru`);
                      } else {
                        return [
                          createTextVNode("Buat Password Baru")
                        ];
                      }
                    }),
                    _: 1
                  ...
                  _push3(ssrRenderComponent(unref(_sfc_main$4), null, {
                    default: withCtx((_3, _push4, _parent4, _scopeId3) => {
                      if (_push4) {
                        _push4(` Masukkan password baru untuk akun Anda `);
                      } else {
                        return [
                          createTextVNode(" Masukkan password baru untuk akun Anda ")
                        ];
                      }
                    }),
                    _: 1
                ...
                if (_push3) {
                    ...
                    default: withCtx((_3, _push4, _parent4, _scopeId3) => {
                      if (_push4) {
                        if (unref(form).processing) {
                          ...
                          _push4(`<span${_scopeId3}>Reset Password</span>`);
                        }
                      } else {
                        return [
                          unref(form).processing ? (openBlock(), createBlock("span", { key: 0 }, "Memproses...")) : (openBlock(), createBlock("span", { key: 1 }, "Reset Password"))
                        ];
                      }
                    }),
                    _: 1
                  }, _parent3, _scopeId2));
                  _push3(`</form><div class="relative my-6"${_scopeId2}><div class="absolute inset-0 flex items-center"${_scopeId2}><span class="w-full border-t"${_scopeId2}></span></div><div class="relative flex justify-center text-xs uppercase"${_scopeId2}><span class="bg-background px-2 text-muted-foreground"${_scopeId2}> Atau </span></div></div><div class="text-center text-sm"${_scopeId2}><span class="text-muted-foreground"${_scopeId2}>Ingat password Anda? </span>`);
                  ...
                  return [
                    ...
                    createVNode("div", { class: "text-center text-sm" }, [
                      createVNode("span", { class: "text-muted-foreground" }, "Ingat password Anda? "),
      ...
      _push(ssrRenderComponent(unref(Lock), { class: "h-10 w-10 text-primary" }, null, _parent));
      _push(`</div><h1 class="text-4xl font-bold tracking-tight"> Keamanan Akun Terjamin </h1><p class="text-lg text-muted-foreground"> Buat password yang kuat untuk melindungi akun Anda. Password minimal 8 karakter. </p><div class="pt-8 space-y-3 text-left bg-background/50 rounded-lg p-6"><p class="text-sm font-semibold mb-3">Tips Password Kuat:</p><div class="flex items-start gap-2 text-sm text-muted-foreground"><span class="text-primary">✓</span><span>Minimal 8 karakter</span></div><div class="flex items-start gap-2 text-sm text-muted-foreground"><span class="text-primary">✓</span><span>Kombinasi huruf besar &amp; kecil</span></div><div class="flex items-start gap-2 text-sm text-muted-foreground"><span class="text-primary">✓</span><span>Gunakan angka dan simbol</span></div><div class="flex items-start gap-2 text-sm text-muted-foreground"><span class="text-primary">✓</span><span>Hindari informasi pribadi</span></div></div></div></div><div class="absolute inset-0 bg-grid-white/10 bg-[size:20px_20px]"></div></div></div><!--]-->`);
    };
  }
});
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("resources/js/pages/ecommerce/auth/ResetPassword.vue");
