import { defineComponent, defineAsyncComponent, ref, computed, watch, withCtx, unref, createVNode, createTextVNode, toDisplayString, createBlock, createCommentVNode, openBlock, withKeys, Fragment, renderList, useSSRContext } from "vue";
import { ssrRenderComponent, ssrInterpolate, ssrRenderList } from "vue/server-renderer";
import { useForm, router } from "@inertiajs/vue3";
import { a as _sfc_main$1, _ as _sfc_main$2 } from "./AppLayout-DI-Jpkmn.js";
import { _ as _sfc_main$d, a as _sfc_main$e, b as _sfc_main$f, d as _sfc_main$g, c as _sfc_main$h } from "./CardTitle-sqUG0LTw.js";
import { _ as _sfc_main$3 } from "./index-SN_CnQ_F.js";
import { _ as _sfc_main$j } from "./Input-BGi8wCMh.js";
import { _ as _sfc_main$i } from "./Label-16aMY2sx.js";
import { _ as _sfc_main$k } from "./Textarea-pcFPh_uS.js";
import { _ as _sfc_main$l } from "./Checkbox-CIOQa2-J.js";
import { _ as _sfc_main$m } from "./index-BpQimeTM.js";
import { _ as _sfc_main$4, a as _sfc_main$5, b as _sfc_main$6, c as _sfc_main$7, d as _sfc_main$8, e as _sfc_main$9, f as _sfc_main$a, g as _sfc_main$b, h as _sfc_main$c } from "./AlertDialogTrigger-DIWb7xue.js";
import { ArrowLeft, Trash2, Save, Send, X } from "lucide-vue-next";
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    const PageBuilder = defineAsyncComponent({
      loader: () => import("./PageBuilder-5wAptNo1.js"),
      loadingComponent: {
    ...
    const submitForm = (publish = null) => {
      ...
      const data = {
        ...
        published_at: isPublished && !form.value.published_at ? (/* @__PURE__ */ new Date()).toISOString() : form.value.published_at,
        _method: "PUT"
      };
      submitFormHelper.transform(() => data).post(`/admin/articles/${props.article.id}`, {
        onSuccess: () => {
      ...
      _push(ssrRenderComponent(_sfc_main$2, _attrs, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            ...
            _push2(`<div${_scopeId}><h1 class="text-3xl font-bold tracking-tight"${_scopeId}>Edit Artikel</h1><p class="text-muted-foreground"${_scopeId}> Perbarui konten artikel </p></div></div><div class="flex gap-2"${_scopeId}>`);
            _push2(ssrRenderComponent(unref(_sfc_main$4), null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(ssrRenderComponent(unref(_sfc_main$5), { "as-child": "" }, {
                    default: withCtx((_3, _push4, _parent4, _scopeId3) => {
                      if (_push4) {
                        _push4(ssrRenderComponent(unref(_sfc_main$3), {
                          variant: "destructive",
                          disabled: processing.value || isDeleting.value
                        }, {
              ...
              _push2(ssrRenderComponent(unref(_sfc_main$3), {
                ...
                default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                  if (_push3) {
                    ...
                    _push3(` Jadikan Draft `);
                  } else {
                    return [
                      createVNode(unref(Save), { class: "mr-2 h-4 w-4" }),
                      createTextVNode(" Jadikan Draft ")
                    ];
                  }
                }),
                _: 1
            ...
            _push2(ssrRenderComponent(unref(_sfc_main$d), null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  ...
                  _push3(ssrRenderComponent(unref(_sfc_main$h), { class: "space-y-4" }, {
                    default: withCtx((_3, _push4, _parent4, _scopeId3) => {
                      if (_push4) {
                        _push4(`<div class="space-y-2"${_scopeId3}>`);
                        _push4(ssrRenderComponent(unref(_sfc_main$i), { for: "title" }, {
                          default: withCtx((_4, _push5, _parent5, _scopeId4) => {
                            if (_push5) {
                        ...
                        _push4(ssrRenderComponent(unref(_sfc_main$i), { for: "slug" }, {
                          default: withCtx((_4, _push5, _parent5, _scopeId4) => {
                            if (_push5) {
                              _push5(`Slug (URL)`);
                            } else {
                        ...
                        return [
                          createVNode("div", { class: "space-y-2" }, [
                            createVNode(unref(_sfc_main$i), { for: "title" }, {
                              default: withCtx(() => [
                                createTextVNode("Judul Artikel")
                              ]),
                              _: 1
                          ...
                          createVNode("div", { class: "space-y-2" }, [
                            createVNode(unref(_sfc_main$i), { for: "slug" }, {
                              default: withCtx(() => [
                                createTextVNode("Slug (URL)")
                              ]),
                              _: 1
                  ...
                  return [
                    ...
                    createVNode(unref(_sfc_main$h), { class: "space-y-4" }, {
                      default: withCtx(() => [
                        createVNode("div", { class: "space-y-2" }, [
                          createVNode(unref(_sfc_main$i), { for: "title" }, {
                            default: withCtx(() => [
                ...
                if (_push3) {
                  ...
                  _push3(ssrRenderComponent(unref(_sfc_main$h), { class: "space-y-4" }, {
                    default: withCtx((_3, _push4, _parent4, _scopeId3) => {
                      if (_push4) {
                        _push4(`<div class="space-y-2"${_scopeId3}>`);
                        _push4(ssrRenderComponent(unref(_sfc_main$i), { for: "seo_title" }, {
                          default: withCtx((_4, _push5, _parent5, _scopeId4) => {
                            if (_push5) {
                              _push5(`Judul SEO`);
                            } else {
                        ...
                        _push4(ssrRenderComponent(unref(_sfc_main$i), { for: "seo_description" }, {
                          default: withCtx((_4, _push5, _parent5, _scopeId4) => {
                            if (_push5) {
                        ...
                        return [
                          createVNode("div", { class: "space-y-2" }, [
                            createVNode(unref(_sfc_main$i), { for: "seo_title" }, {
                              default: withCtx(() => [
                                createTextVNode("Judul SEO")
                              ]),
                              _: 1
                          ...
                          createVNode("div", { class: "space-y-2" }, [
                            createVNode(unref(_sfc_main$i), { for: "seo_description" }, {
                              default: withCtx(() => [
                                createTextVNode("Deskripsi SEO")
                              ]),
                              _: 1
                  ...
                  _push3(ssrRenderComponent(unref(_sfc_main$h), { class: "space-y-4" }, {
                    default: withCtx((_3, _push4, _parent4, _scopeId3) => {
                      if (_push4) {
                        ...
                        if (form.value.is_published) {
                          _push4(`<div class="space-y-2"${_scopeId3}>`);
                          _push4(ssrRenderComponent(unref(_sfc_main$i), { for: "published_at" }, {
                            default: withCtx((_4, _push5, _parent5, _scopeId4) => {
                              if (_push5) {
                        ...
                        return [
                          ...
                          form.value.is_published ? (openBlock(), createBlock("div", {
                            ...
                            createVNode(unref(_sfc_main$i), { for: "published_at" }, {
                              default: withCtx(() => [
                                createTextVNode("Tanggal Terbit")
                              ]),
                              _: 1
                ...
                createVNode("div", { class: "flex items-center justify-between" }, [
                  createVNode("div", { class: "flex items-center gap-4" }, [
                    ...
                    createVNode("div", null, [
                      createVNode("h1", { class: "text-3xl font-bold tracking-tight" }, "Edit Artikel"),
                      createVNode("p", { class: "text-muted-foreground" }, " Perbarui konten artikel ")
                    ])
                  ]),
                  createVNode("div", { class: "flex gap-2" }, [
                    ...
                    form.value.is_published ? (openBlock(), createBlock(unref(_sfc_main$3), {
                      key: 0,
                      variant: "outline",
                      disabled: processing.value,
                      onClick: ($event) => submitForm(false)
