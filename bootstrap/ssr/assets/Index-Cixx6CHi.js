...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    const applyFilters = () => {
      router.get("/admin/zenner/incentive-rules", {
    ...
    const confirmDelete = () => {
      ...
      useForm({}).delete(`/admin/zenner/incentive-rules/${itemToDelete.value}`, {
        preserveScroll: true,
        onSuccess: () => {
    ...
    const goToPage = (page) => {
      router.get("/admin/zenner/incentive-rules", { page, search: search.value || void 0, status: status.value !== "all" ? status.value : void 0, type: typeFilter.value !== "all" ? typeFilter.value : void 0, per_page: perPage.value }, { preserveState: true, preserveScroll: true });
    };
    return (_ctx, _push, _parent, _attrs) => {
      _push(ssrRenderComponent(_sfc_main$1, _attrs, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<div class="container mx-auto py-6 space-y-6"${_scopeId}><div class="flex items-center justify-between"${_scopeId}><div${_scopeId}><h1 class="text-3xl font-bold tracking-tight"${_scopeId}>Skema Insentif</h1><p class="text-muted-foreground"${_scopeId}>Kelola rule insentif program Zenner Club</p></div>`);
            _push2(ssrRenderComponent(unref(_sfc_main$2), { "as-child": "" }, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(ssrRenderComponent(unref(Link), { href: "/admin/zenner/incentive-rules/create" }, {
                  ...
                  return [
                    createVNode(unref(Link), { href: "/admin/zenner/incentive-rules/create" }, {
                      default: withCtx(() => [
                        createVNode(unref(Plus), { class: "mr-2 h-4 w-4" }),
                        createTextVNode("Tambah Rule")
                      ]),
                              ...
                              _push5(ssrRenderComponent(unref(_sfc_main$9), null, {
                                default: withCtx((_5, _push6, _parent6, _scopeId5) => {
                                  if (_push6) {
                                    ...
                                    _push6(ssrRenderComponent(unref(_sfc_main$a), { value: "bonus" }, {
                                      default: withCtx((_6, _push7, _parent7, _scopeId6) => {
                                        if (_push7) {
                                          _push7(`Bonus`);
                                        } else {
                                    ...
                                    _push6(ssrRenderComponent(unref(_sfc_main$a), { value: "reward" }, {
                                      default: withCtx((_6, _push7, _parent7, _scopeId6) => {
                                        if (_push7) {
                                          _push7(`Reward`);
                                        } else {
                                    ...
                                    _push6(ssrRenderComponent(unref(_sfc_main$a), { value: "commission" }, {
                                      default: withCtx((_6, _push7, _parent7, _scopeId6) => {
                                        if (_push7) {
                                          _push7(`Komisi`);
                                        } else {
                                    ...
                                    return [
                                      ...
                                      createVNode(unref(_sfc_main$a), { value: "bonus" }, {
                                        default: withCtx(() => [
                                          createTextVNode("Bonus")
                                        ]),
                                        _: 1
                                      }),
                                      createVNode(unref(_sfc_main$a), { value: "reward" }, {
                                        default: withCtx(() => [
                                          createTextVNode("Reward")
                                        ]),
                                        _: 1
                                      }),
                                      createVNode(unref(_sfc_main$a), { value: "commission" }, {
                                        default: withCtx(() => [
                                          createTextVNode("Komisi")
                                        ]),
                                        _: 1
                                                      ...
                                                      default: withCtx((_8, _push9, _parent9, _scopeId8) => {
                                                        if (_push9) {
                                                          _push9(ssrRenderComponent(unref(Link), {
                                                            href: `/admin/zenner/incentive-rules/${item.id}/edit`
                                                          }, {
                          ...
                          default: withCtx((_4, _push5, _parent5, _scopeId4) => {
                            if (_push5) {
                              _push5(ssrRenderComponent(unref(_sfc_main$m), null, {
                                default: withCtx((_5, _push6, _parent6, _scopeId5) => {
                                  if (_push6) {
                                    _push6(`Hapus Rule Insentif?`);
                                  } else {
                                    return [
                                      createTextVNode("Hapus Rule Insentif?")
                                    ];
                                  }
                                }),
                                _: 1
              ...
              createVNode("div", { class: "container mx-auto py-6 space-y-6" }, [
                createVNode("div", { class: "flex items-center justify-between" }, [
                  createVNode("div", null, [
                    createVNode("h1", { class: "text-3xl font-bold tracking-tight" }, "Skema Insentif"),
                    createVNode("p", { class: "text-muted-foreground" }, "Kelola rule insentif program Zenner Club")
                  ]),
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("resources/js/pages/Admin/Zenner/IncentiveRule/Index.vue");
