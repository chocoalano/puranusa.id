...
import { M as index, _ as _sfc_main$8, N as destroy, O as release, P as massRelease } from "./AppLayout-D11fLPDM.js";
...
import { MoreHorizontal, Wallet, Trash2, Plus, DollarSign, Receipt, Search, CheckCircle, XCircle, ArrowUpDown } from "lucide-vue-next";
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    const breadcrumbItems = [
      { title: "Bonus Cashback", href: index.url() }
    ];
    ...
    const columns = [
      ...
      },
      {
        ...
        header: () => "Order ID",
        cell: ({ row }) => h("div", { class: "font-mono text-sm" }, row.original.order_id || "-")
      },
      {
        accessorKey: "amount",
      ...
      },
      {
        accessorKey: "status",
        header: () => "Status",
        cell: ({ row }) => h(_sfc_main$s, { variant: row.original.status === 1 ? "default" : "secondary", class: "gap-1" }, () => [
    ...
    return (_ctx, _push, _parent, _attrs) => {
                  ...
                  _push3(ssrRenderComponent(unref(_sfc_main$4), { align: "end" }, {
                    default: withCtx((_2, _push4, _parent4, _scopeId3) => {
                      if (_push4) {
                        ...
                        if (bonus.status === 0 && (unref(isSuperAdmin) || unref(isAdmin))) {
                          _push4(`<!--[-->`);
                        ...
                        return [
                          ...
                          bonus.status === 0 && (unref(isSuperAdmin) || unref(isAdmin)) ? (openBlock(), createBlock(Fragment, { key: 0 }, [
                          ...
                          unref(isSuperAdmin) || unref(isAdmin) ? (openBlock(), createBlock(Fragment, { key: 1 }, [
                            createVNode(unref(_sfc_main$6)),
      ...
      _push(ssrRenderComponent(_sfc_main$8, { breadcrumbs: breadcrumbItems }, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(ssrRenderComponent(unref(Head), { title: "Bonus Cashback" }, null, _parent2, _scopeId));
            _push2(`<div class="flex h-full flex-1 flex-col gap-6 p-6"${_scopeId}><div class="flex items-center justify-between"${_scopeId}><div${_scopeId}><h1 class="text-3xl font-bold tracking-tight"${_scopeId}>Bonus Cashback</h1><p class="text-muted-foreground"${_scopeId}>Kelola bonus cashback member</p></div>`);
            if (unref(isSuperAdmin) || unref(isAdmin)) {
              _push2(ssrRenderComponent(unref(_sfc_main$3), {
                onClick: ($event) => unref(router).visit("/bonus/cashback/create")
              }, {
              ...
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  ...
                  _push3(ssrRenderComponent(unref(_sfc_main$c), null, {
                    default: withCtx((_3, _push4, _parent4, _scopeId3) => {
                      if (_push4) {
                        _push4(`<div class="text-2xl font-bold"${_scopeId3}>${ssrInterpolate(formatCurrency(__props.statistics.total_pending))}</div><p class="text-xs text-muted-foreground"${_scopeId3}>${ssrInterpolate(__props.statistics.count_pending)} transaksi</p>`);
                      } else {
                        return [
                          createVNode("div", { class: "text-2xl font-bold" }, toDisplayString(formatCurrency(__props.statistics.total_pending)), 1),
                          createVNode("p", { class: "text-xs text-muted-foreground" }, toDisplayString(__props.statistics.count_pending) + " transaksi", 1)
                        ];
                      }
                    }),
                    _: 1
              ...
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  ...
                  _push3(ssrRenderComponent(unref(_sfc_main$c), null, {
                    default: withCtx((_3, _push4, _parent4, _scopeId3) => {
                      if (_push4) {
                        _push4(`<div class="text-2xl font-bold text-green-600"${_scopeId3}>${ssrInterpolate(formatCurrency(__props.statistics.total_released))}</div><p class="text-xs text-muted-foreground"${_scopeId3}>${ssrInterpolate(__props.statistics.count_released)} transaksi</p>`);
                      } else {
                        return [
                          createVNode("div", { class: "text-2xl font-bold text-green-600" }, toDisplayString(formatCurrency(__props.statistics.total_released)), 1),
                          createVNode("p", { class: "text-xs text-muted-foreground" }, toDisplayString(__props.statistics.count_released) + " transaksi", 1)
                        ];
                      }
                    }),
                    _: 1
            ...
            _push2(`</div>`);
            if (selectedPendingBonuses.value.length && (unref(isSuperAdmin) || unref(isAdmin))) {
              _push2(ssrRenderComponent(unref(_sfc_main$3), {
                variant: "outline",
            ...
            _push2(ssrRenderComponent(_sfc_main$q, {
              ...
              title: "Release Bonus",
              description: `Apakah Anda yakin ingin merilis bonus sebesar ${releaseDialog.value.bonus ? formatCurrency(releaseDialog.value.bonus.amount) : ""} ke member?`,
            ...
            return [
              createVNode(unref(Head), { title: "Bonus Cashback" }),
              createVNode("div", { class: "flex h-full flex-1 flex-col gap-6 p-6" }, [
                createVNode("div", { class: "flex items-center justify-between" }, [
                  createVNode("div", null, [
                    createVNode("h1", { class: "text-3xl font-bold tracking-tight" }, "Bonus Cashback"),
                    createVNode("p", { class: "text-muted-foreground" }, "Kelola bonus cashback member")
                  ]),
                ...
                createVNode("div", { class: "flex flex-col gap-4 md:flex-row md:items-center md:justify-between" }, [
                  ...
                  selectedPendingBonuses.value.length && (unref(isSuperAdmin) || unref(isAdmin)) ? (openBlock(), createBlock(unref(_sfc_main$3), {
                    key: 0,
                    variant: "outline",
                    onClick: openMassReleaseDialog
                  }, {
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("resources/js/pages/bonus/cashback/Index.vue");
