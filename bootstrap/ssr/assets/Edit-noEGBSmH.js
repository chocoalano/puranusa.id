import { defineComponent, computed, ref, unref, withCtx, createVNode, createTextVNode, toDisplayString, useSSRContext } from "vue";
              ...
              createVNode("div", { class: "rounded-xl p-4 space-y-6 py-6" }, [
                ...
                createVNode("div", { class: "max-w-4xl" }, [
                  createVNode(_sfc_main$3, {
                    ...
                    _: 1
                  }, 8, ["form-data", "onUpdate:formData", "errors", "processing", "existing-image"])
                ])
              ])
            ];
          }
