  ...
  setup(__props) {
    ...
    const columns = [
      ...
      },
      {
        ...
        cell: ({ row }) => {
          ...
          return h(
            _sfc_main$g,
            { variant: getPositionVariant(position) },
    ...
    const handleFilterUpdate = (index, value) => {
      ...
      if (index === 0) {
        ...
        router.get(
          "/admin/networks/binary",
          { search: searchQuery.value, position: val === "all" ? void 0 : val },
          { preserveState: true, preserveScroll: true }
        );
      }
    };
    const goToPage = (page) => {
      router.get(
        "/admin/networks/binary",
        { page, search: searchQuery.value, position: selectedPosition.value === "all" ? void 0 : selectedPosition.value },
        { preserveState: true, preserveScroll: true }
      );
    };
    return (_ctx, _push, _parent, _attrs) => {
      _push(ssrRenderComponent(_sfc_main$1, mergeProps({ title: "Jaringan Binary" }, _attrs), {
                    ...
                    default: withCtx((_3, _push4, _parent4, _scopeId3) => {
                      if (_push4) {
                        ...
                        _push4(ssrRenderComponent(unref(_sfc_main$6), null, {
                          default: withCtx((_4, _push5, _parent5, _scopeId4) => {
                            if (_push5) {
                              _push5(` Monitoring member dalam struktur jaringan binary (kiri - kanan) `);
                            } else {
                              return [
                                createTextVNode(" Monitoring member dalam struktur jaringan binary (kiri - kanan) ")
                              ];
                            }
                          }),
                          _: 1
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("resources/js/pages/Admin/Networks/Binary.vue");
