...
import { _ as _sfc_main$1 } from "./AppLayout-CzI69RVm.js";
import { Head, Link, router } from "@inertiajs/vue3";
import { useVueTable, getSortedRowModel, getCoreRowModel, FlexRender } from "@tanstack/vue-table";
import { Infinity, Plus, CheckCircle, XCircle, Search, ChevronsLeft, ChevronLeft, ChevronRight, ChevronsRight, ChevronUp, ChevronDown, ChevronsUpDown, Edit, Trash2 } from "lucide-vue-next";
    ...
    return (_ctx, _push, _parent, _attrs) => {
      _push(ssrRenderComponent(_sfc_main$1, mergeProps({ breadcrumbs: breadcrumbItems }, _attrs), {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(ssrRenderComponent(unref(Head), { title: "Lifetime Cash Rewards" }, null, _parent2, _scopeId));
            ...
            _push2(` Lifetime Cash Rewards </h1><p class="text-muted-foreground mt-1"${_scopeId}> Kelola reward permanen (tanpa periode waktu) </p></div>`);
            _push2(ssrRenderComponent(unref(Link), { href: "/admin/settings/lifetime-cash-rewards/create" }, {
              ...
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                      ...
                      if (_push4) {
                        _push4(ssrRenderComponent(unref(_sfc_main$5), { class: "text-sm font-medium" }, {
                          default: withCtx((_4, _push5, _parent5, _scopeId4) => {
                            if (_push5) {
                              _push5(`Total Rewards`);
                            } else {
                              return [
                                createTextVNode("Total Rewards")
                              ];
                            }
                          }),
                          _: 1
                        }, _parent4, _scopeId3));
                        _push4(ssrRenderComponent(unref(Infinity), { class: "h-4 w-4 text-blue-500" }, null, _parent4, _scopeId3));
                      } else {
                        return [
                          ...
                          createVNode(unref(Infinity), { class: "h-4 w-4 text-blue-500" })
                        ];
                      }
                    }),
                    _: 1
                  ...
                  _push3(ssrRenderComponent(unref(_sfc_main$6), null, {
                    default: withCtx((_3, _push4, _parent4, _scopeId3) => {
                      if (_push4) {
                        _push4(`<div class="text-2xl font-bold text-blue-600"${_scopeId3}>${ssrInterpolate(__props.statistics.total)}</div>`);
                      } else {
                        return [
                          createVNode("div", { class: "text-2xl font-bold text-blue-600" }, toDisplayString(__props.statistics.total), 1)
                        ];
                      }
                    }),
                    _: 1
                  ...
                  _push3(ssrRenderComponent(unref(_sfc_main$4), { class: "flex flex-row items-center justify-between space-y-0 pb-2" }, {
                    default: withCtx((_3, _push4, _parent4, _scopeId3) => {
                      if (_push4) {
                        ...
                        _push4(ssrRenderComponent(unref(CheckCircle), { class: "h-4 w-4 text-green-500" }, null, _parent4, _scopeId3));
                      } else {
                        return [
                          createVNode(unref(_sfc_main$5), { class: "text-sm font-medium" }, {
                            default: withCtx(() => [
                          ...
                          createVNode(unref(CheckCircle), { class: "h-4 w-4 text-green-500" })
                        ];
                      }
                    }),
                    _: 1
            ...
            return [
              createVNode(unref(Head), { title: "Lifetime Cash Rewards" }),
              createVNode("div", { class: "flex h-full flex-1 flex-col gap-6 p-6" }, [
                createVNode("div", { class: "flex items-center justify-between" }, [
                  createVNode("div", null, [
                    ...
                    createVNode("p", { class: "text-muted-foreground mt-1" }, " Kelola reward permanen (tanpa periode waktu) ")
                  ]),
                  createVNode(unref(Link), { href: "/admin/settings/lifetime-cash-rewards/create" }, {
                    default: withCtx(() => [
                      createVNode(unref(_sfc_main$2), null, {
                        default: withCtx(() => [
                          createVNode(unref(Plus), { class: "h-4 w-4 mr-2" }),
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("resources/js/pages/Admin/Rewards/Lifetime/Index.vue");
