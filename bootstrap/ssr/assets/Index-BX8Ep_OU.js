import { defineComponent, ref, computed, unref, withCtx, createTextVNode, toDisplayString, createVNode, createBlock, openBlock, useSSRContext, watch, resolveDynamicComponent, Fragment, renderList, createCommentVNode, withModifiers, mergeProps, onMounted, resolveComponent } from "vue";
...
import { _ as _sfc_main$W, a as _sfc_main$X, b as _sfc_main$Y, c as _sfc_main$Z } from "./TabsTrigger-Bvg0QZyC.js";
import { _ as _sfc_main$_ } from "./Ecommerce-CLSuyfUf.js";
import { router, useForm, Link, usePage, Head } from "@inertiajs/vue3";
import { CheckCircle, AlertCircle, Check, Copy, Share2, MapPin, Plus, Pencil, Trash2, Home, Building2, Trophy, Calendar, User, Mail, Phone, Loader2, Package, Truck, CreditCard, CheckCircle2, Star, RefreshCw, PackageCheck, ArrowDownLeft, ArrowUpRight, Wallet, Lock, Eye, EyeOff, ShieldCheck, Clock, UserPlus, GitBranch, Users, TrendingUp, Handshake, DollarSign, Percent, ShoppingCart, Gift, Network } from "lucide-vue-next";
...
import { _ as _sfc_main$y, a as _sfc_main$z, b as _sfc_main$A, c as _sfc_main$B, d as _sfc_main$C, e as _sfc_main$M } from "./DialogTrigger-DV-5YM1v.js";
...
import { _ as _sfc_main$T, a as _sfc_main$U, b as _sfc_main$V } from "./index-D3PKcwoM.js";
import "reka-ui";
import "@vueuse/core";
              ...
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  ...
                  if (!currentItem.value || __props.orderItems.length === 0) {
                    _push3(ssrRenderComponent(unref(_sfc_main$T), { variant: "default" }, {
                      default: withCtx((_3, _push4, _parent4, _scopeId3) => {
                        if (_push4) {
                    ...
                    if (alertMessage.value?.type === "error") {
                      _push3(ssrRenderComponent(unref(_sfc_main$T), { variant: "destructive" }, {
                        default: withCtx((_3, _push4, _parent4, _scopeId3) => {
                          if (_push4) {
                            _push4(ssrRenderComponent(unref(AlertCircle), { class: "h-4 w-4" }, null, _parent4, _scopeId3));
                            _push4(ssrRenderComponent(unref(_sfc_main$U), null, {
                  ...
                  return [
                    ...
                    createVNode("div", { class: "space-y-6 py-4" }, [
                      !currentItem.value || __props.orderItems.length === 0 ? (openBlock(), createBlock(unref(_sfc_main$T), {
                        key: 0,
                        variant: "default"
                      }, {
                        default: withCtx(() => [
                        ...
                        alertMessage.value?.type === "success" ? (openBlock(), createBlock(unref(_sfc_main$T), {
                          key: 0,
                          variant: "default"
                        }, {
                          default: withCtx(() => [
                        ...
                        alertMessage.value?.type === "error" ? (openBlock(), createBlock(unref(_sfc_main$T), {
                          key: 1,
                          variant: "destructive"
                        }, {
                          default: withCtx(() => [
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(ssrRenderComponent(_sfc_main$e, {
        balance: __props.customer.ewallet_saldo,
      ...
      if (walletView.value === "wallet-withdrawal") {
        _push(ssrRenderComponent(_sfc_main$c, {
          "max-amount": __props.customer.ewallet_saldo,
          onCancel: ($event) => walletView.value = "wallet"
        }, null, _parent));
      } else {
        _push(`<!---->`);
              ...
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(ssrRenderComponent(unref(_sfc_main$W), {
                    ...
                    default: withCtx((_3, _push4, _parent4, _scopeId3) => {
                      if (_push4) {
                        _push4(ssrRenderComponent(unref(_sfc_main$X), { class: "grid w-full grid-cols-3" }, {
                          default: withCtx((_4, _push5, _parent5, _scopeId4) => {
                            if (_push5) {
                              _push5(ssrRenderComponent(unref(_sfc_main$Y), { value: "active" }, {
                                default: withCtx((_5, _push6, _parent6, _scopeId5) => {
                                  if (_push6) {
                              ...
                              _push5(ssrRenderComponent(unref(_sfc_main$Y), { value: "passive" }, {
                                default: withCtx((_5, _push6, _parent6, _scopeId5) => {
                                  if (_push6) {
                              ...
                              _push5(ssrRenderComponent(unref(_sfc_main$Y), { value: "prospect" }, {
                                default: withCtx((_5, _push6, _parent6, _scopeId5) => {
                                  if (_push6) {
                              ...
                              return [
                                createVNode(unref(_sfc_main$Y), { value: "active" }, {
                                  default: withCtx(() => [
                                    createVNode(unref(CheckCircle), { class: "w-4 h-4 mr-2" }),
                                    createTextVNode(" Aktif (" + toDisplayString(__props.activeMembers.length) + ") ", 1)
                                  ]),
                                ...
                                createVNode(unref(_sfc_main$Y), { value: "passive" }, {
                                  default: withCtx(() => [
                                    createVNode(unref(Clock), { class: "w-4 h-4 mr-2" }),
                                    createTextVNode(" Pasif (" + toDisplayString(__props.passiveMembers.length) + ") ", 1)
                                  ]),
                                ...
                                createVNode(unref(_sfc_main$Y), { value: "prospect" }, {
                                  default: withCtx(() => [
                                    createVNode(unref(UserPlus), { class: "w-4 h-4 mr-2" }),
                                    createTextVNode(" Prospek (" + toDisplayString(__props.prospectMembers.length) + ") ", 1)
                                  ]),
                        ...
                        return [
                          createVNode(unref(_sfc_main$X), { class: "grid w-full grid-cols-3" }, {
                            default: withCtx(() => [
                              createVNode(unref(_sfc_main$Y), { value: "active" }, {
                                default: withCtx(() => [
                                  createVNode(unref(CheckCircle), { class: "w-4 h-4 mr-2" }),
                    ...
                    default: withCtx((_3, _push4, _parent4, _scopeId3) => {
                      if (_push4) {
                        ...
                        _push4(ssrRenderComponent(unref(_sfc_main$u), {
                          ...
                          disabled: !selectedPosition.value || isPlacing.value
                        }, {
                          default: withCtx((_4, _push5, _parent5, _scopeId4) => {
                            if (_push5) {
                              _push5(`${ssrInterpolate(isPlacing.value ? "Memproses..." : "Tempatkan")}`);
                            } else {
                              return [
                                createTextVNode(toDisplayString(isPlacing.value ? "Memproses..." : "Tempatkan"), 1)
                              ];
                            }
                          }),
                          _: 1
...
const _sfc_main$4 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props, { emit: __emit }) {
    const props = __props;
    const getNodeColor = (level, status) => {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      const _component_TreeNodeComponent = resolveComponent("TreeNodeComponent", true);
      _push(`<div${ssrRenderAttrs(_attrs)}><div class="flex justify-center mb-6">`);
      if (__props.node.name) {
        _push(`<div class="${ssrRenderClass([
          "relative rounded-lg border-2 shadow-lg transition-all hover:shadow-xl",
          __props.isRoot ? "px-6 py-4" : "px-3 py-2",
          getNodeColor(__props.node.level, __props.node.status)
        ])}"><div class="${ssrRenderClass(["flex items-center gap-2", __props.isRoot && "gap-3"])}"><div class="${ssrRenderClass([
          "flex items-center justify-center rounded-full text-primary-foreground",
          __props.isRoot ? "h-12 w-12 bg-primary" : "h-8 w-8 bg-blue-100 dark:bg-blue-900"
        ])}">`);
        _push(ssrRenderComponent(unref(User), {
          class: __props.isRoot ? "h-6 w-6" : "h-4 w-4 text-blue-600 dark:text-blue-400"
        }, null, _parent));
        _push(`</div><div class="flex-1 min-w-0"><div class="${ssrRenderClass(["font-medium truncate", __props.isRoot ? "font-semibold" : "text-xs"])}">${ssrInterpolate(__props.node.name)}</div><div class="${ssrRenderClass(["text-muted-foreground truncate", __props.isRoot ? "text-xs" : "text-[10px]"])}">${ssrInterpolate(__props.node.email)}</div><div class="flex items-center gap-1 mt-1">`);
        if (__props.node.position === "left") {
          _push(ssrRenderComponent(unref(_sfc_main$t), {
            variant: "secondary",
            class: __props.isRoot ? "text-xs" : "text-[10px]"
          }, {
            default: withCtx((_, _push2, _parent2, _scopeId) => {
              if (_push2) {
                _push2(` Kiri `);
        ...
        } else if (__props.node.position === "right") {
          _push(ssrRenderComponent(unref(_sfc_main$t), {
            variant: "secondary",
            class: __props.isRoot ? "text-xs" : "text-[10px]"
          }, {
        ...
        _push(ssrRenderComponent(unref(_sfc_main$t), {
          ...
          default: withCtx((_, _push2, _parent2, _scopeId) => {
            if (_push2) {
              _push2(` L${ssrInterpolate(__props.node.level)}`);
            } else {
              return [
                createTextVNode(" L" + toDisplayString(__props.node.level), 1)
              ];
            }
          }),
          _: 1
      ...
      } else if (__props.node.member_id > 0) {
        _push(`<div class="${ssrRenderClass([
        ...
        _push(ssrRenderComponent(unref(UserPlus), {
          class: [
            ...
            __props.isRoot ? "w-6 h-6" : "w-4 h-4"
          ]
        }, null, _parent));
        _push(`<div class="${ssrRenderClass(["text-muted-foreground group-hover:text-primary", __props.isRoot ? "text-sm" : "text-[10px]"])}">${ssrInterpolate(__props.isRoot ? "Tempatkan Member" : "Tambah")}</div></div></div>`);
      } else {
        _push(`<div class="${ssrRenderClass([
          "rounded-lg border-2 border-dashed bg-muted/30",
          __props.isRoot ? "px-6 py-4" : "px-3 py-2"
        ])}"><div class="${ssrRenderClass(["text-center text-muted-foreground", __props.isRoot ? "text-sm" : "text-[10px]"])}"> - </div></div>`);
      }
      _push(`</div>`);
      if (__props.node.name && shouldShowChildren) {
        _push(`<div class="${ssrRenderClass(["flex justify-center gap-4 mb-4", __props.isRoot && "gap-16 mb-6"])}"><div class="${ssrRenderClass(__props.isRoot ? "w-64" : "w-36")}">`);
        if (__props.node.left) {
          _push(ssrRenderComponent(_component_TreeNodeComponent, {
            node: __props.node.left,
            "is-root": false,
            "max-level": __props.maxLevel,
            onOpenPlacement: (memberId, position) => _ctx.$emit("open-placement", memberId, position)
          }, null, _parent));
        } else {
          _push(`<div class="${ssrRenderClass([
          ...
          _push(`<div class="${ssrRenderClass(["text-muted-foreground group-hover:text-primary", __props.isRoot ? "text-sm" : "text-[10px]"])}"> Tambah </div></div></div></div>`);
        }
        _push(`</div><div class="${ssrRenderClass(__props.isRoot ? "w-64" : "w-36")}">`);
...
_sfc_main$4.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("resources/js/components/profile/TreeNodeComponent.vue");
...
const _sfc_main$3 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    const selectedMember = ref(null);
    const isPlacing = ref(false);
    const buildCompleteTree = (node, parentId, position, currentLevel) => {
      ...
      if (node) {
        ...
        return {
          ...node,
          left: shouldShowChildren ? buildCompleteTree(node.left || null, node.member_id, "left", currentLevel + 1) : void 0,
          right: shouldShowChildren ? buildCompleteTree(node.right || null, node.member_id, "right", currentLevel + 1) : void 0
        };
      }
      return null;
    };
    ...
    return (_ctx, _push, _parent, _attrs) => {
      _push(`<!--[--><div class="space-y-6"><div class="grid gap-4 md:grid-cols-3">`);
      _push(ssrRenderComponent(unref(_sfc_main$o), null, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(ssrRenderComponent(unref(_sfc_main$v), { class: "flex flex-row items-center justify-between space-y-0 pb-2" }, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(ssrRenderComponent(unref(_sfc_main$w), { class: "text-sm font-medium" }, {
                    default: withCtx((_3, _push4, _parent4, _scopeId3) => {
                      if (_push4) {
                  ...
                  return [
                    createVNode(unref(_sfc_main$w), { class: "text-sm font-medium" }, {
                      default: withCtx(() => [
                        createTextVNode("Total Jaringan")
                      ]),
                      _: 1
            ...
            _push2(ssrRenderComponent(unref(_sfc_main$p), null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<div class="text-2xl font-bold"${_scopeId2}>${ssrInterpolate(__props.totalDownlines)}</div><p class="text-xs text-muted-foreground"${_scopeId2}>Member aktif di jaringan Anda</p>`);
                } else {
                  return [
                    createVNode("div", { class: "text-2xl font-bold" }, toDisplayString(__props.totalDownlines), 1),
                    createVNode("p", { class: "text-xs text-muted-foreground" }, "Member aktif di jaringan Anda")
                  ];
                }
              }),
              _: 1
            ...
            return [
              createVNode(unref(_sfc_main$v), { class: "flex flex-row items-center justify-between space-y-0 pb-2" }, {
                default: withCtx(() => [
                  createVNode(unref(_sfc_main$w), { class: "text-sm font-medium" }, {
                    default: withCtx(() => [
                      createTextVNode("Total Jaringan")
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(ssrRenderComponent(unref(_sfc_main$v), { class: "flex flex-row items-center justify-between space-y-0 pb-2" }, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  ...
                  _push3(ssrRenderComponent(unref(TrendingUp), { class: "h-4 w-4 text-blue-600" }, null, _parent3, _scopeId2));
                } else {
                  return [
                    createVNode(unref(_sfc_main$w), { class: "text-sm font-medium" }, {
                      default: withCtx(() => [
                    ...
                    createVNode(unref(TrendingUp), { class: "h-4 w-4 text-blue-600" })
                  ];
                }
              }),
              _: 1
            ...
            _push2(ssrRenderComponent(unref(_sfc_main$p), null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<div class="text-2xl font-bold text-blue-600"${_scopeId2}>${ssrInterpolate(__props.totalLeft)}</div><p class="text-xs text-muted-foreground"${_scopeId2}>Member di posisi kiri</p>`);
                } else {
                  return [
                    createVNode("div", { class: "text-2xl font-bold text-blue-600" }, toDisplayString(__props.totalLeft), 1),
                    createVNode("p", { class: "text-xs text-muted-foreground" }, "Member di posisi kiri")
                  ];
                }
              }),
              _: 1
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(ssrRenderComponent(unref(_sfc_main$v), { class: "flex flex-row items-center justify-between space-y-0 pb-2" }, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  ...
                  _push3(ssrRenderComponent(unref(TrendingUp), { class: "h-4 w-4 text-green-600" }, null, _parent3, _scopeId2));
                } else {
                  return [
                    createVNode(unref(_sfc_main$w), { class: "text-sm font-medium" }, {
                      default: withCtx(() => [
                    ...
                    createVNode(unref(TrendingUp), { class: "h-4 w-4 text-green-600" })
                  ];
                }
              }),
              _: 1
            ...
            _push2(ssrRenderComponent(unref(_sfc_main$p), null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<div class="text-2xl font-bold text-green-600"${_scopeId2}>${ssrInterpolate(__props.totalRight)}</div><p class="text-xs text-muted-foreground"${_scopeId2}>Member di posisi kanan</p>`);
                } else {
                  return [
                    createVNode("div", { class: "text-2xl font-bold text-green-600" }, toDisplayString(__props.totalRight), 1),
                    createVNode("p", { class: "text-xs text-muted-foreground" }, "Member di posisi kanan")
                  ];
                }
              }),
              _: 1
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
              ...
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  ...
                  _push3(ssrRenderComponent(unref(_sfc_main$N), null, {
                    default: withCtx((_3, _push4, _parent4, _scopeId3) => {
                      if (_push4) {
                        _push4(` Visualisasi jaringan MLM binary tree Anda (maksimal ${ssrInterpolate(maxVisibleLevels)} level) `);
                      } else {
                        return [
                          createTextVNode(" Visualisasi jaringan MLM binary tree Anda (maksimal " + toDisplayString(maxVisibleLevels) + " level) ")
                        ];
                      }
                    }),
                    _: 1
            ...
            _push2(ssrRenderComponent(unref(_sfc_main$p), null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<div class="overflow-x-auto pb-4"${_scopeId2}><div class="min-w-max"${_scopeId2}>`);
                  _push3(ssrRenderComponent(_sfc_main$4, {
                    node: completeTree.value,
                    "is-root": true,
                    "max-level": maxVisibleLevels,
                    onOpenPlacement: openPlacementDialog
                  }, null, _parent3, _scopeId2));
                  _push3(`<div class="mt-6 p-4 rounded-lg bg-muted/50 text-center"${_scopeId2}><p class="text-sm text-muted-foreground"${_scopeId2}> 💡 Tree menampilkan maksimal ${ssrInterpolate(maxVisibleLevels)} level untuk performa optimal </p></div></div></div>`);
                } else {
                  return [
                    createVNode("div", { class: "overflow-x-auto pb-4" }, [
                      createVNode("div", { class: "min-w-max" }, [
                        ...
                        createVNode("div", { class: "mt-6 p-4 rounded-lg bg-muted/50 text-center" }, [
                          createVNode("p", { class: "text-sm text-muted-foreground" }, " 💡 Tree menampilkan maksimal " + toDisplayString(maxVisibleLevels) + " level untuk performa optimal ")
                        ])
                      ])
                    ])
                  ];
      ...
      _push(ssrRenderComponent(unref(_sfc_main$y), {
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(ssrRenderComponent(unref(_sfc_main$z), { class: "sm:max-w-2xl max-h-[80vh] overflow-hidden flex flex-col" }, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(ssrRenderComponent(unref(_sfc_main$A), null, {
                    default: withCtx((_3, _push4, _parent4, _scopeId3) => {
                  ...
                  _push3(`<div class="flex-1 overflow-y-auto py-4"${_scopeId2}>`);
                  if (__props.passiveMembers.length === 0) {
                    _push3(`<div class="text-center py-12 text-muted-foreground"${_scopeId2}>`);
                    _push3(ssrRenderComponent(unref(UserPlus), { class: "w-12 h-12 mx-auto mb-4 opacity-20" }, null, _parent3, _scopeId2));
                    _push3(`<p${_scopeId2}>Tidak ada member pasif</p><p class="text-sm mt-2"${_scopeId2}>Semua member sudah ditempatkan di binary tree</p></div>`);
                  } else {
                    _push3(`<div class="space-y-2"${_scopeId2}><!--[-->`);
                    ssrRenderList(__props.passiveMembers, (member) => {
                      ...
                      ])}"${_scopeId2}><div class="flex items-start justify-between"${_scopeId2}><div class="flex-1"${_scopeId2}><div class="flex items-center gap-2 mb-1"${_scopeId2}><h4 class="font-semibold"${_scopeId2}>${ssrInterpolate(member.name)}</h4>`);
                      if (member.has_purchase) {
                        _push3(ssrRenderComponent(unref(_sfc_main$t), {
                          ...
                          default: withCtx((_3, _push4, _parent4, _scopeId3) => {
                            if (_push4) {
                              _push4(` Ada Pembelian `);
                            } else {
                              return [
                                createTextVNode(" Ada Pembelian ")
                              ];
                            }
                          }),
                          _: 2
                      ...
                      _push3(`</div><div class="space-y-0.5 text-sm text-muted-foreground"${_scopeId2}><p${_scopeId2}>${ssrInterpolate(member.email)}</p>`);
                      if (member.phone) {
                        _push3(`<p${_scopeId2}>${ssrInterpolate(member.phone)}</p>`);
                      } else {
                        _push3(`<!---->`);
                      }
                      _push3(`<p class="text-xs"${_scopeId2}>Bergabung: ${ssrInterpolate(formatDate(member.joined_at))}</p></div></div>`);
                      if (selectedMember.value?.id === member.id) {
                        _push3(`<div class="ml-3"${_scopeId2}><div class="flex h-6 w-6 items-center justify-center rounded-full bg-primary text-primary-foreground"${_scopeId2}><svg class="w-4 h-4" fill="none" viewBox="0 0 24 24" stroke="currentColor"${_scopeId2}><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 13l4 4L19 7"${_scopeId2}></path></svg></div></div>`);
                      } else {
                        _push3(`<!---->`);
                      }
                      _push3(`</div></button>`);
                    ...
                    default: withCtx((_3, _push4, _parent4, _scopeId3) => {
                      if (_push4) {
                        ...
                        _push4(ssrRenderComponent(unref(_sfc_main$u), {
                          ...
                          disabled: !selectedMember.value || isPlacing.value
                        }, {
                          default: withCtx((_4, _push5, _parent5, _scopeId4) => {
                            if (_push5) {
                              _push5(`${ssrInterpolate(isPlacing.value ? "Memproses..." : "Tempatkan Member")}`);
                            } else {
                              return [
                                createTextVNode(toDisplayString(isPlacing.value ? "Memproses..." : "Tempatkan Member"), 1)
                              ];
                            }
                          }),
                          _: 1
                  ...
                  return [
                    ...
                    createVNode("div", { class: "flex-1 overflow-y-auto py-4" }, [
                      __props.passiveMembers.length === 0 ? (openBlock(), createBlock("div", {
                        key: 0,
                        class: "text-center py-12 text-muted-foreground"
                      }, [
                        createVNode(unref(UserPlus), { class: "w-12 h-12 mx-auto mb-4 opacity-20" }),
                        createVNode("p", null, "Tidak ada member pasif"),
                        createVNode("p", { class: "text-sm mt-2" }, "Semua member sudah ditempatkan di binary tree")
                      ])) : (openBlock(), createBlock("div", {
                        key: 1,
                        class: "space-y-2"
                      }, [
                        (openBlock(true), createBlock(Fragment, null, renderList(__props.passiveMembers, (member) => {
                          return openBlock(), createBlock("button", {
                            ...
                            createVNode("div", { class: "flex items-start justify-between" }, [
                              createVNode("div", { class: "flex-1" }, [
                                createVNode("div", { class: "flex items-center gap-2 mb-1" }, [
                                  createVNode("h4", { class: "font-semibold" }, toDisplayString(member.name), 1),
                                ...
                                createVNode("div", { class: "space-y-0.5 text-sm text-muted-foreground" }, [
                                  createVNode("p", null, toDisplayString(member.email), 1),
                                  member.phone ? (openBlock(), createBlock("p", { key: 0 }, toDisplayString(member.phone), 1)) : createCommentVNode("", true),
                                  createVNode("p", { class: "text-xs" }, "Bergabung: " + toDisplayString(formatDate(member.joined_at)), 1)
                                ])
                              ...
                              selectedMember.value?.id === member.id ? (openBlock(), createBlock("div", {
                                ...
                                createVNode("div", { class: "flex h-6 w-6 items-center justify-center rounded-full bg-primary text-primary-foreground" }, [
            ...
            return [
              createVNode(unref(_sfc_main$z), { class: "sm:max-w-2xl max-h-[80vh] overflow-hidden flex flex-col" }, {
                default: withCtx(() => [
                  createVNode(unref(_sfc_main$A), null, {
                    default: withCtx(() => [
                      createVNode(unref(_sfc_main$B), null, {
                  ...
                  _push3(ssrRenderComponent(unref(_sfc_main$W), {
                    ...
                    default: withCtx((_3, _push4, _parent4, _scopeId3) => {
                      if (_push4) {
                        ...
                        _push4(ssrRenderComponent(unref(_sfc_main$X), { class: "flex w-max sm:grid sm:w-full sm:grid-cols-7 gap-0.5 sm:gap-1 h-7 sm:h-auto bg-muted/30" }, {
                          default: withCtx((_4, _push5, _parent5, _scopeId4) => {
                            if (_push5) {
                            ...
                            if (_push5) {
                              if (__props.bonusSponsors.length === 0) {
                                ...
                                ssrRenderList(__props.bonusSponsors, (bonus) => {
                                  ...
                                  _push5(`<span class="block sm:inline sm:ml-1"${_scopeId4}>${ssrInterpolate(formatDate(bonus.created_at))}</span></p></div><div class="text-left sm:text-right flex-shrink-0"${_scopeId4}><div class="text-xs sm:text-base md:text-lg font-bold text-green-600"${_scopeId4}>${ssrInterpolate(formatCurrency(bonus.amount))}</div></div></div>`);
                                });
                                _push5(`<!--]--></div>`);
                              }
                            } else {
                            ...
                            if (_push5) {
                              if (__props.bonusMatchings.length === 0) {
                                ...
                                ssrRenderList(__props.bonusMatchings, (bonus) => {
                                  ...
                                  _push5(`<span class="block sm:inline sm:ml-2"${_scopeId4}>${ssrInterpolate(formatDate(bonus.created_at))}</span></p></div><div class="text-left sm:text-right flex-shrink-0"${_scopeId4}><div class="text-xs sm:text-base md:text-lg font-bold text-green-600"${_scopeId4}>${ssrInterpolate(formatCurrency(bonus.amount))}</div></div></div>`);
                                });
                                _push5(`<!--]--></div>`);
                              }
                            } else {
                        ...
                        return [
                          createVNode("div", {
                            ...
                            createVNode(unref(_sfc_main$X), { class: "flex w-max sm:grid sm:w-full sm:grid-cols-7 gap-0.5 sm:gap-1 h-7 sm:h-auto bg-muted/30" }, {
                              default: withCtx(() => [
                                createVNode(unref(_sfc_main$Y), {
                                  value: "sponsor",
                                  class: "text-[12px] sm:text-xs md:text-sm whitespace-nowrap px-1.5 sm:px-3 md:px-4 py-1 sm:py-2 h-6 sm:h-auto"
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      _push(ssrRenderComponent(_sfc_main$_, _attrs, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            ...
            _push2(ssrRenderComponent(unref(_sfc_main$W), {
              ...
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  ...
                  _push3(ssrRenderComponent(unref(_sfc_main$X), { class: "inline-flex h-auto w-max bg-transparent gap-1 sm:gap-1.5 p-0" }, {
                    default: withCtx((_3, _push4, _parent4, _scopeId3) => {
                      if (_push4) {
                        ...
                        return [
                          ...
                          isActiveMember.value ? (openBlock(), createBlock(unref(_sfc_main$Y), {
                            key: 0,
                            value: "network",
                            class: "flex-shrink-0 flex flex-col items-center justify-center gap-0.5 py-1 px-1.5 sm:py-1.5 sm:px-2 w-[38px] sm:w-[55px] md:w-[70px] data-[state=active]:bg-background data-[state=active]:shadow-sm rounded-md transition-all"
                          }, {
                  ...
                  return [
                    createVNode("div", { class: "border-b bg-muted/30" }, [
                      createVNode("div", { class: "overflow-x-auto text-center overflow-y-hidden px-1.5 py-1.5 sm:px-2 sm:py-2 [&::-webkit-scrollbar]:hidden [-ms-overflow-style:none] [scrollbar-width:none]" }, [
                        createVNode(unref(_sfc_main$X), { class: "inline-flex h-auto w-max bg-transparent gap-1 sm:gap-1.5 p-0" }, {
                          default: withCtx(() => [
                            createVNode(unref(_sfc_main$Y), {
                              value: "profile",
                              class: "flex-shrink-0 flex flex-col items-center justify-center gap-0.5 py-1 px-1.5 sm:py-1.5 sm:px-2 w-[38px] sm:w-[55px] md:w-[70px] data-[state=active]:bg-background data-[state=active]:shadow-sm rounded-md transition-all"
                    ...
                    createVNode("div", { class: "p-3 sm:p-4 md:p-6" }, [
                      ...
                      isActiveMember.value ? (openBlock(), createBlock(unref(_sfc_main$Z), {
                        key: 0,
                        value: "network",
                        class: "mt-0"
                      }, {
