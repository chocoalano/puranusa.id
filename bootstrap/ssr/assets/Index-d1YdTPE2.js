...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      _push(ssrRenderComponent(_sfc_main$1, mergeProps({ title: "Testimonials" }, _attrs), {
                ...
                if (_push3) {
                  _push3(ssrRenderComponent(unref(_sfc_main$3), null, {
                    default: withCtx((_3, _push4, _parent4, _scopeId3) => {
                      if (_push4) {
                        _push4(`<div class="flex items-center justify-between"${_scopeId3}><h2 class="text-xl font-semibold"${_scopeId3}>Testimonials</h2>`);
                        _push4(ssrRenderComponent(unref(_sfc_main$4), {
                          onClick: ($event) => unref(router).get("/admin/zenner/testimonials/create")
                        }, {
                        ...
                        return [
                          createVNode("div", { class: "flex items-center justify-between" }, [
                            createVNode("h2", { class: "text-xl font-semibold" }, "Testimonials"),
                                        ...
                                        default: withCtx((_6, _push7, _parent7, _scopeId6) => {
                                          if (_push7) {
                                            _push7(ssrRenderComponent(unref(_sfc_main$h), null, {
                                              default: withCtx((_7, _push8, _parent8, _scopeId7) => {
                                                if (_push8) {
                                                  _push8(`${ssrInterpolate(item.customer_name)}`);
                                                } else {
                                                  return [
                                                    createTextVNode(toDisplayString(item.customer_name), 1)
                                                  ];
                                                }
                                              }),
                                              _: 2
                                            ...
                                            _push7(ssrRenderComponent(unref(_sfc_main$h), null, {
                                              default: withCtx((_7, _push8, _parent8, _scopeId7) => {
                                                if (_push8) {
                                                  _push8(`${ssrInterpolate(item.product_name)}`);
                                                } else {
                                                  return [
                                                    createTextVNode(toDisplayString(item.product_name), 1)
                                                  ];
                                                }
                                              }),
                                              _: 2
                                            }, _parent7, _scopeId6));
                                            _push7(ssrRenderComponent(unref(_sfc_main$h), { class: "text-yellow-500" }, {
                                              default: withCtx((_7, _push8, _parent8, _scopeId7) => {
                                                if (_push8) {
                                                  _push8(`${ssrInterpolate(renderStars(item.rating))}`);
                                                } else {
                                                  return [
                                                    createTextVNode(toDisplayString(renderStars(item.rating)), 1)
                                                  ];
                                                }
                                              }),
                                              _: 2
                                              ...
                                              default: withCtx((_7, _push8, _parent8, _scopeId7) => {
                                                if (_push8) {
                                                  ...
                                                  _push8(ssrRenderComponent(unref(_sfc_main$4), {
                                                    size: "sm",
                                                    variant: "outline",
                                                    onClick: ($event) => unref(router).get(`/admin/zenner/testimonials/${item.id}/edit`)
                                                  }, {
                                                    default: withCtx((_8, _push9, _parent9, _scopeId8) => {
                                                      if (_push9) {
                                            ...
                                            return [
                                              ...
                                              createVNode(unref(_sfc_main$h), { class: "text-yellow-500" }, {
                                                default: withCtx(() => [
                                                  createTextVNode(toDisplayString(renderStars(item.rating)), 1)
                                                ]),
                                                _: 2
                        ...
                        if (__props.items.last_page > 1) {
                          ...
                          ssrRenderList(__props.items.links, (link) => {
                            _push4(ssrRenderComponent(unref(_sfc_main$4), {
                              ...
                              default: withCtx((_4, _push5, _parent5, _scopeId4) => {
                                if (_push5) {
                                  _push5(`${ssrInterpolate(formatPaginationLabel(link.label))}`);
                                } else {
                                  return [
                          ...
                          default: withCtx((_4, _push5, _parent5, _scopeId4) => {
                            if (_push5) {
                              _push5(ssrRenderComponent(unref(_sfc_main$m), null, {
                                default: withCtx((_5, _push6, _parent6, _scopeId5) => {
                                  if (_push6) {
                                    _push6(`Hapus Testimonial`);
                                  } else {
                                    return [
                                      createTextVNode("Hapus Testimonial")
                                    ];
                                  }
                                }),
                                _: 1
                              ...
                              _push5(ssrRenderComponent(unref(_sfc_main$n), null, {
                                default: withCtx((_5, _push6, _parent6, _scopeId5) => {
                                  if (_push6) {
                                    _push6(` Apakah Anda yakin ingin menghapus testimonial dari &quot;${ssrInterpolate(deleteTarget.value?.customer_name)}&quot;? Tindakan ini tidak dapat dibatalkan. `);
                                  } else {
                                    return [
                                      createTextVNode(' Apakah Anda yakin ingin menghapus testimonial dari "' + toDisplayString(deleteTarget.value?.customer_name) + '"? Tindakan ini tidak dapat dibatalkan. ', 1)
                                    ];
                                  }
                                }),
                                _: 1
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("resources/js/pages/Admin/Zenner/Testimonial/Index.vue");
