...
import { _ as _sfc_main$1, i as index, e as edit, r as releaseBonuses, t as topUp, g as deduct, d as destroy } from "./AppLayout-CDfd8drY.js";
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    const handleReleaseBonuses = () => {
      router.post(releaseBonuses.url(props.customer.id), {}, {
        preserveScroll: true,
        onSuccess: () => {
