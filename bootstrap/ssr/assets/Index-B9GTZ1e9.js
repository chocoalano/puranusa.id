import { defineComponent, ref, withCtx, unref, createVNode, createTextVNode, toDisplayString, createBlock, openBlock, Fragment, renderList, withKeys, createCommentVNode, useSSRContext } from "vue";
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    const courseId = ref(props.filters.course_id?.toString() || "all");
    const perPage = ref(props.filters.per_page);
    const itemToDelete = ref(null);
    const isDeleting = ref(false);
    const applyFilters = () => {
      router.get("/admin/zenner/lessons", {
        search: search.value || void 0,
        status: status.value !== "all" ? status.value : void 0,
        course_id: courseId.value !== "all" ? courseId.value : void 0,
    ...
    const confirmDelete = () => {
      ...
      useForm({}).delete(`/admin/zenner/lessons/${itemToDelete.value}`, {
        preserveScroll: true,
        onSuccess: () => {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      _push(ssrRenderComponent(_sfc_main$1, _attrs, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<div class="container mx-auto py-6 space-y-6"${_scopeId}><div class="flex items-center justify-between"${_scopeId}><div${_scopeId}><h1 class="text-3xl font-bold tracking-tight"${_scopeId}>Lessons</h1><p class="text-muted-foreground"${_scopeId}>Kelola lesson Zenner Academy</p></div>`);
            _push2(ssrRenderComponent(unref(_sfc_main$2), { "as-child": "" }, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(ssrRenderComponent(unref(Link), { href: "/admin/zenner/lessons/create" }, {
                    default: withCtx((_3, _push4, _parent4, _scopeId3) => {
                      if (_push4) {
                        _push4(ssrRenderComponent(unref(Plus), { class: "mr-2 h-4 w-4" }, null, _parent4, _scopeId3));
                        _push4(`Tambah Lesson`);
                      } else {
                        return [
                          createVNode(unref(Plus), { class: "mr-2 h-4 w-4" }),
                          createTextVNode("Tambah Lesson")
                        ];
                      }
                    }),
                    _: 1
                  ...
                  return [
                    createVNode(unref(Link), { href: "/admin/zenner/lessons/create" }, {
                      default: withCtx(() => [
                        createVNode(unref(Plus), { class: "mr-2 h-4 w-4" }),
                        createTextVNode("Tambah Lesson")
                      ]),
                    ...
                    default: withCtx((_3, _push4, _parent4, _scopeId3) => {
                      if (_push4) {
                        ...
                        _push4(ssrRenderComponent(unref(_sfc_main$6), {
                          modelValue: courseId.value,
                          "onUpdate:modelValue": [($event) => courseId.value = $event, applyFilters]
                        }, {
                            ...
                            if (_push5) {
                              _push5(ssrRenderComponent(unref(_sfc_main$7), { class: "w-[180px]" }, {
                                default: withCtx((_5, _push6, _parent6, _scopeId5) => {
                                  if (_push6) {
                                    _push6(ssrRenderComponent(unref(_sfc_main$8), { placeholder: "Course" }, null, _parent6, _scopeId5));
                                  } else {
                                    return [
                                      createVNode(unref(_sfc_main$8), { placeholder: "Course" })
                                    ];
                                  }
                                }),
                                _: 1
                                          ...
                                          default: withCtx((_6, _push7, _parent7, _scopeId6) => {
                                            if (_push7) {
                                              ...
                                              _push7(ssrRenderComponent(unref(_sfc_main$h), null, {
                                                default: withCtx((_7, _push8, _parent8, _scopeId7) => {
                                                  if (_push8) {
                                                    _push8(`${ssrInterpolate(item.course?.title || "-")}`);
                                                  } else {
                                                    return [
                                                      createTextVNode(toDisplayString(item.course?.title || "-"), 1)
                                                    ];
                                                  }
                                                }),
                                                _: 2
                                                      ...
                                                      default: withCtx((_8, _push9, _parent9, _scopeId8) => {
                                                        if (_push9) {
                                                          _push9(ssrRenderComponent(unref(Link), {
                                                            href: `/admin/zenner/lessons/${item.id}/edit`
                                                          }, {
              ...
              createVNode("div", { class: "container mx-auto py-6 space-y-6" }, [
                createVNode("div", { class: "flex items-center justify-between" }, [
                  createVNode("div", null, [
                    createVNode("h1", { class: "text-3xl font-bold tracking-tight" }, "Lessons"),
                    createVNode("p", { class: "text-muted-foreground" }, "Kelola lesson Zenner Academy")
                  ]),
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("resources/js/pages/Admin/Zenner/Lesson/Index.vue");
