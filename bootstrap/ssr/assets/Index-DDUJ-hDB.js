...
import { i as index, c as create, d as destroy, r as release, m as massRelease, a as show } from "./BonusController-Bk73fRdx.js";
...
import { Plus, Receipt, DollarSign, Wallet, Search, Settings2, ChevronDown, ArrowUpDown, CheckCircle, XCircle, Eye, Trash2 } from "lucide-vue-next";
      ...
      },
      {
        ...
        cell: ({ row }) => {
          return h("div", { class: "text-right" }, [
            h("div", { class: "font-medium" }, formatCurrency(row.original.amount)),
            h(
              "div",
              { class: "text-xs text-muted-foreground" },
              `Tax: ${formatCurrency(row.original.tax_amount)}`
            ),
            h(
              "div",
              { class: "text-xs text-green-600" },
              `Netto: ${formatCurrency(row.original.tax_netto)}`
            )
          ]);
        }
      },
    ...
    return (_ctx, _push, _parent, _attrs) => {
      _push(ssrRenderComponent(_sfc_main$1, mergeProps({ breadcrumbs: breadcrumbItems }, _attrs), {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(ssrRenderComponent(unref(Head), { title: "Bonus Regular" }, null, _parent2, _scopeId));
            _push2(`<div class="rounded-xl p-4 space-y-6 py-6"${_scopeId}><div class="flex items-center justify-between"${_scopeId}><div${_scopeId}><h1 class="text-3xl font-bold tracking-tight"${_scopeId}>Bonus Regular</h1><p class="text-muted-foreground"${_scopeId}>Kelola bonus reguler member</p></div>`);
            ...
            _push2(ssrRenderComponent(_sfc_main$o, {
              ...
              title: "Release Bonus?",
              description: `Bonus sebesar ${releaseDialog.value.bonus ? formatCurrency(releaseDialog.value.bonus.tax_netto) : ""} akan ditransfer ke ewallet member. Lanjutkan?`,
            ...
            _push2(ssrRenderComponent(_sfc_main$o, {
              ...
              description: `Total ${formatCurrency(selectedPendingBonuses.value.reduce((sum, b) => sum + b.tax_netto, 0))} akan ditransfer ke ewallet member. Lanjutkan?`,
            ...
            return [
              createVNode(unref(Head), { title: "Bonus Regular" }),
              createVNode("div", { class: "rounded-xl p-4 space-y-6 py-6" }, [
                createVNode("div", { class: "flex items-center justify-between" }, [
                  createVNode("div", null, [
                    createVNode("h1", { class: "text-3xl font-bold tracking-tight" }, "Bonus Regular"),
                    createVNode("p", { class: "text-muted-foreground" }, "Kelola bonus reguler member")
                  ]),
                  createVNode(unref(_sfc_main$2), {
                    onClick: ($event) => unref(router).visit(unref(create).url())
                  }, {
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("resources/js/pages/bonus/regular/Index.vue");
