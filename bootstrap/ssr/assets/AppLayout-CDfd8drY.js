...
import { PanelLeft, ChevronRight, Settings, LogOut, ChevronsUpDown, LayoutGrid, Users, Users2Icon, Package, FolderTree, FileEdit, FileText, ShoppingCart, Heart, Star, BadgePercent, CreditCard, Truck, ArrowLeftRight, Wallet, WalletCards, Wallet2Icon, WalletIcon, TrendingUp, Wallet2, Grid3x3, MapPin, BookOpen } from "lucide-vue-next";
...
show$9.url = (args, options) => {
  ...
  return show$9.definition.url.replace("{customerBonus}", parsedArgs.customerBonus.toString()).replace(/\/+$/, "") + queryParams(options);
};
...
edit$b.url = (args, options) => {
  ...
  return edit$b.definition.url.replace("{customerBonus}", parsedArgs.customerBonus.toString()).replace(/\/+$/, "") + queryParams(options);
};
...
update$e.url = (args, options) => {
  ...
  return update$e.definition.url.replace("{customerBonus}", parsedArgs.customerBonus.toString()).replace(/\/+$/, "") + queryParams(options);
};
...
destroy$d.url = (args, options) => {
  ...
  return destroy$d.definition.url.replace("{customerBonus}", parsedArgs.customerBonus.toString()).replace(/\/+$/, "") + queryParams(options);
};
...
release$3.url = (args, options) => {
  ...
  return release$3.definition.url.replace("{customerBonus}", parsedArgs.customerBonus.toString()).replace(/\/+$/, "") + queryParams(options);
};
...
show$8.url = (args, options) => {
  ...
  return show$8.definition.url.replace("{customerBonusMatching}", parsedArgs.customerBonusMatching.toString()).replace(/\/+$/, "") + queryParams(options);
};
...
edit$a.url = (args, options) => {
  ...
  return edit$a.definition.url.replace("{customerBonusMatching}", parsedArgs.customerBonusMatching.toString()).replace(/\/+$/, "") + queryParams(options);
};
...
update$d.url = (args, options) => {
  ...
  return update$d.definition.url.replace("{customerBonusMatching}", parsedArgs.customerBonusMatching.toString()).replace(/\/+$/, "") + queryParams(options);
};
...
destroy$c.url = (args, options) => {
  ...
  return destroy$c.definition.url.replace("{customerBonusMatching}", parsedArgs.customerBonusMatching.toString()).replace(/\/+$/, "") + queryParams(options);
};
...
release$2.url = (args, options) => {
  ...
  return release$2.definition.url.replace("{customerBonusMatching}", parsedArgs.customerBonusMatching.toString()).replace(/\/+$/, "") + queryParams(options);
};
...
show$7.url = (args, options) => {
  ...
  return show$7.definition.url.replace("{customerBonusPairing}", parsedArgs.customerBonusPairing.toString()).replace(/\/+$/, "") + queryParams(options);
};
...
edit$9.url = (args, options) => {
  ...
  return edit$9.definition.url.replace("{customerBonusPairing}", parsedArgs.customerBonusPairing.toString()).replace(/\/+$/, "") + queryParams(options);
};
...
update$c.url = (args, options) => {
  ...
  return update$c.definition.url.replace("{customerBonusPairing}", parsedArgs.customerBonusPairing.toString()).replace(/\/+$/, "") + queryParams(options);
};
...
destroy$b.url = (args, options) => {
  ...
  return destroy$b.definition.url.replace("{customerBonusPairing}", parsedArgs.customerBonusPairing.toString()).replace(/\/+$/, "") + queryParams(options);
};
...
release$1.url = (args, options) => {
  ...
  return release$1.definition.url.replace("{customerBonusPairing}", parsedArgs.customerBonusPairing.toString()).replace(/\/+$/, "") + queryParams(options);
};
...
show$6.url = (args, options) => {
  ...
  return show$6.definition.url.replace("{customerBonusSponsor}", parsedArgs.customerBonusSponsor.toString()).replace(/\/+$/, "") + queryParams(options);
};
...
edit$8.url = (args, options) => {
  ...
  return edit$8.definition.url.replace("{customerBonusSponsor}", parsedArgs.customerBonusSponsor.toString()).replace(/\/+$/, "") + queryParams(options);
};
...
update$b.url = (args, options) => {
  ...
  return update$b.definition.url.replace("{customerBonusSponsor}", parsedArgs.customerBonusSponsor.toString()).replace(/\/+$/, "") + queryParams(options);
};
...
destroy$a.url = (args, options) => {
  ...
  return destroy$a.definition.url.replace("{customerBonusSponsor}", parsedArgs.customerBonusSponsor.toString()).replace(/\/+$/, "") + queryParams(options);
};
...
release.url = (args, options) => {
  ...
  return release.definition.url.replace("{customerBonusSponsor}", parsedArgs.customerBonusSponsor.toString()).replace(/\/+$/, "") + queryParams(options);
};
