import { defineComponent, ref, watch, unref, withCtx, createVNode, createTextVNode, createBlock, createCommentVNode, openBlock, toDisplayString, withModifiers, useSSRContext } from "vue";
...
import { _ as _sfc_main$h } from "./Textarea-pcFPh_uS.js";
...
import { _ as _sfc_main$a } from "./PageBuilder-CivrpB3x.js";
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      _push(`<!--[-->`);
      _push(ssrRenderComponent(unref(Head), { title: "Tambah Halaman" }, null, _parent));
      _push(ssrRenderComponent(_sfc_main$1, null, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            ...
            _push2(`<div${_scopeId}><h1 class="text-3xl font-bold tracking-tight"${_scopeId}>Tambah Halaman Baru</h1><p class="text-muted-foreground mt-1"${_scopeId}> Buat halaman statis baru untuk website Anda </p></div></div>`);
            _push2(ssrRenderComponent(unref(_sfc_main$2), {
              ...
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  ...
                  _push3(` Simpan Halaman `);
                } else {
                  return [
                    createVNode(unref(Save), { class: "h-4 w-4 mr-2" }),
                    createTextVNode(" Simpan Halaman ")
                  ];
                }
              }),
              _: 1
                  ...
                  _push3(ssrRenderComponent(unref(_sfc_main$7), { class: "space-y-4" }, {
                    default: withCtx((_3, _push4, _parent4, _scopeId3) => {
                      if (_push4) {
                        ...
                        _push4(`<p class="text-xs text-muted-foreground"${_scopeId3}> URL: /page/<span class="font-medium"${_scopeId3}>${ssrInterpolate(form.value.slug || "slug")}</span></p>`);
                        ...
                        return [
                          ...
                          createVNode("div", { class: "space-y-2" }, [
                            ...
                            createVNode("p", { class: "text-xs text-muted-foreground" }, [
                              ...
                              createVNode("span", { class: "font-medium" }, toDisplayString(form.value.slug || "slug"), 1)
                            ]),
                    ...
                    default: withCtx((_3, _push4, _parent4, _scopeId3) => {
                      if (_push4) {
                        ...
                        _push4(ssrRenderComponent(_sfc_main$g, {
                          ...
                          "onUpdate:checked": ($event) => form.value.is_published = $event
                        }, null, _parent4, _scopeId3));
                        _push4(`</div>`);
                      } else {
                        return [
                ...
                createVNode("div", { class: "flex items-center justify-between" }, [
                  createVNode("div", { class: "flex items-center gap-4" }, [
                    ...
                    createVNode("div", null, [
                      createVNode("h1", { class: "text-3xl font-bold tracking-tight" }, "Tambah Halaman Baru"),
                      createVNode("p", { class: "text-muted-foreground mt-1" }, " Buat halaman statis baru untuk website Anda ")
                    ])
                  ]),
                  createVNode(unref(_sfc_main$2), {
                    onClick: submitForm,
